...
public class ProjectileUtils {
    ...
    public static boolean isProjectileClipped(final Entity sender, final Entity receiver, final Position from,
        ...
        val fromSize = sender != null ? sender.getSize() : 1;
        val toSize = receiver != null ? receiver.getSize() : 1;
    ...
    private static boolean _isProjectileClipped(final Entity sender, final Entity receiver, final Position from,
        ...
        val sourceLp = from.getPosition();
        val targetLp = to.getPosition();
        val fromPlane = sourceLp.getPlane();
        val toPlane = targetLp.getPlane();
        ...
        if (Utils.collides(sourceLp.getX(), sourceLp.getY(), fromSize, targetLp.getX(), targetLp.getY(), toSize))
            return false;
