...
public enum Ladder {
	...
	APE_ATOLL_LADDER_DOWN1(new LadderObject(4777, new Location(2713, 2766, 2)), new Location(2712, 2766, 0)),
	APE_ATOLL_LADDER_DOWN2(new LadderObject(4777, new Location(2729, 2766, 2)), new Location(2730, 2766, 0)),
	APE_ATOLL_LADDER_UP1(new LadderObject(4775, new Location(2713, 2766, 0)), new Location(2712, 2766, 2)),
	APE_ATOLL_LADDER_UP2(new LadderObject(4774, new Location(2729, 2766, 0)), new Location(2730, 2766, 2)),

	FALADOR_UPSTAIRS_LADDER(new LadderObject(24082, new Location(3050, 3355, 1)), new Location(3050, 3354, 2)),
	FALADOR_DOWNSTAIRS_LADDER(new LadderObject(24084, new Location(3050, 3355, 3)), new Location(3050, 3356, 1)),
	...
	LARRANS_LADDER_UP(new LadderObject(272, new Location(3018, 3956, 0)), new Location(3018, 3956, 1)),
	LARRANS_LADDER_DOWN(new LadderObject(273, new Location(3018, 3917, 1)), new Location(3018, 3917, 0)),
	...
	BRIMHAVEN_AGILITY_DOWN(new LadderObject(3617, new Location(2809, 3194, 0)), new Location(2805, 9589, 3)),
	BRIMHAVEN_AGILITY_UP(new LadderObject(3618, new Location(2805, 9590, 3)), new Location(2809, 3193, 0)),

	BRIMHAVEN_AGILITY_ROPE_UP_1(new LadderObject(3610, new Location(2805, 9591, 0)), new Location(2805, 9591, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_2(new LadderObject(3610, new Location(2794, 9591, 0)), new Location(2794, 9591, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_3(new LadderObject(3610, new Location(2783, 9591, 0)), new Location(2783, 9591, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_4(new LadderObject(3610, new Location(2772, 9591, 0)), new Location(2772, 9591, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_5(new LadderObject(3610, new Location(2761, 9591, 0)), new Location(2761, 9591, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_6(new LadderObject(3610, new Location(2806, 9579, 0)), new Location(2806, 9579, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_7(new LadderObject(3610, new Location(2795, 9579, 0)), new Location(2795, 9579, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_8(new LadderObject(3610, new Location(2783, 9580, 0)), new Location(2783, 9580, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_9(new LadderObject(3610, new Location(2771, 9579, 0)), new Location(2771, 9579, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_10(new LadderObject(3610, new Location(2760, 9579, 0)), new Location(2760, 9579, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_11(new LadderObject(3610, new Location(2806, 9568, 0)), new Location(2806, 9568, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_12(new LadderObject(3610, new Location(2795, 9568, 0)), new Location(2795, 9568, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_13(new LadderObject(3610, new Location(2784, 9568, 0)), new Location(2784, 9568, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_14(new LadderObject(3610, new Location(2771, 9568, 0)), new Location(2771, 9568, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_15(new LadderObject(3610, new Location(2760, 9568, 0)), new Location(2760, 9568, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_16(new LadderObject(3610, new Location(2806, 9557, 0)), new Location(2806, 9557, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_17(new LadderObject(3610, new Location(2795, 9557, 0)), new Location(2795, 9557, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_18(new LadderObject(3610, new Location(2783, 9556, 0)), new Location(2783, 9556, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_19(new LadderObject(3610, new Location(2771, 9557, 0)), new Location(2771, 9557, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_20(new LadderObject(3610, new Location(2760, 9557, 0)), new Location(2760, 9557, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_21(new LadderObject(3610, new Location(2805, 9545, 0)), new Location(2805, 9545, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_22(new LadderObject(3610, new Location(2794, 9545, 0)), new Location(2794, 9545, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_23(new LadderObject(3610, new Location(2783, 9545, 0)), new Location(2783, 9545, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_24(new LadderObject(3610, new Location(2772, 9545, 0)), new Location(2771, 9568, 3)),
	BRIMHAVEN_AGILITY_ROPE_UP_25(new LadderObject(3610, new Location(2761, 9545, 0)), new Location(2761, 9545, 3)),
	...
	ABANDONED_MINE_FLOOR1_LADDER1_DOWN(new LadderObject(4965, new Location(3413, 9633, 0)), new Location(2773, 4578, 0)),
	ABANDONED_MINE_FLOOR2_LADDER1_UP(new LadderObject(4966, new Location(2773, 4577, 0)), new Location(3413, 9634, 0)),

	ABANDONED_MINE_FLOOR2_LADDER2_DOWN(new LadderObject(4969, new Location(2797, 4599, 0)), new Location(2733, 4534, 0)),
	ABANDONED_MINE_FLOOR3_LADDER2_UP(new LadderObject(4970, new Location(2733, 4535, 0)), new Location(2797, 4598, 0)),

	ABANDONED_MINE_FLOOR3_LADDER1_DOWN(new LadderObject(4967, new Location(2732, 4529, 0)), new Location(2797, 4529, 0)),
	ABANDONED_MINE_FLOOR4_LADDER1_UP(new LadderObject(4966, new Location(2796, 4529, 0)), new Location(2733, 4529, 0)),

	ABANDONED_MINE_FLOOR3_LADDER3_DOWN(new LadderObject(4967, new Location(2710, 4540, 0)), new Location(2775, 4540, 0)),
	ABANDONED_MINE_FLOOR4_LADDER3_UP(new LadderObject(4968, new Location(2774, 4540, 0)), new Location(2711, 4540, 0)),

	ABANDONED_MINE_FLOOR3_LADDER4_DOWN(new LadderObject(4967, new Location(2696, 4497, 0)), new Location(2761, 4497, 0)),
	ABANDONED_MINE_FLOOR4_LADDER4_UP(new LadderObject(4968, new Location(2760, 4497, 0)), new Location(2697, 4497, 0)),

	ABANDONED_MINE_FLOOR3_LADDER5_DOWN(new LadderObject(4967, new Location(2725, 4486, 0)), new Location(2790, 4486, 0)),
	ABANDONED_MINE_FLOOR4_LADDER5_UP(new LadderObject(4968, new Location(2789, 4486, 0)), new Location(2725, 4487, 0)),

	ABANDONED_MINE_FLOOR1_LADDER2_DOWN(new LadderObject(4965, new Location(3422, 9625, 0)), new Location(2783, 4569, 0)),
	ABANDONED_MINE_FLOOR2_LADDER2_UP(new LadderObject(4966, new Location(2782, 4569, 0)), new Location(3422, 9624, 0)),

	ABANDONED_MINE_FLOOR2_LADDER3_DOWN(new LadderObject(4969, new Location(2798, 4567, 0)), new Location(2735, 4503, 0)),
	ABANDONED_MINE_FLOOR3_LADDER3_UP(new LadderObject(4970, new Location(2734, 4503, 0)), new Location(2797, 4567, 0)),

	WHITE_WOLF_MOUNTAIN_LADDER1_DOWN(new LadderObject(17385, new Location(2845, 9916, 0)), new Location(2845, 3517, 0)),
	WHITE_WOLF_MOUNTAIN_LADDER1_UP(new LadderObject(16680, new Location(2845, 3516, 0)), new Location(2845, 9917, 0)),

	WHITE_WOLF_MOUNTAIN_LADDER2_DOWN(new LadderObject(17385, new Location(2848, 9919, 0)), new Location(2848, 3520, 0)),
	WHITE_WOLF_MOUNTAIN_LADDER2_UP(new LadderObject(16680, new Location(2848, 3519, 0)), new Location(2847, 9919, 0)),

	WHITE_WOLF_MOUNTAIN_LADDER3_DOWN(new LadderObject(17385, new Location(2848, 9913, 0)), new Location(2848, 3514, 0)),
	WHITE_WOLF_MOUNTAIN_LADDER3_UP(new LadderObject(16680, new Location(2848, 3513, 0)), new Location(2848, 9914, 0)),

	WHITE_WOLF_MOUNTAIN_LADDER4_DOWN(new LadderObject(17385, new Location(2824, 9907, 0)), new Location(2825, 3507, 0)),
	WHITE_WOLF_MOUNTAIN_LADDER4_UP(new LadderObject(16680, new Location(2824, 3507, 0)), new Location(2825, 9907, 0)),

	WHITE_WOLF_MOUNTAIN_LADDER5_DOWN(new LadderObject(17385, new Location(2823, 9913, 0)), new Location(2823, 3514, 0)),
	WHITE_WOLF_MOUNTAIN_LADDER5_UP(new LadderObject(16680, new Location(2823, 3513, 0)), new Location(2823, 9914, 0)),

	WHITE_WOLF_MOUNTAIN_LADDER6_DOWN(new LadderObject(17385, new Location(2827, 9910, 0)), new Location(2827, 3511, 0)),
	WHITE_WOLF_MOUNTAIN_LADDER6_UP(new LadderObject(16680, new Location(2827, 3510, 0)), new Location(2827, 9911, 0)),

	WHITE_WOLF_MOUNTAIN_LADDER7_DOWN(new LadderObject(17385, new Location(2823, 9930, 0)), new Location(2823, 3529, 0)),

	WHITE_WOLF_MOUNTAIN_LADDER8_DOWN(new LadderObject(17385, new Location(2857, 9917, 0)), new Location(2858, 3517, 0)),
	WHITE_WOLF_MOUNTAIN_LADDER8_UP(new LadderObject(16680, new Location(2857, 3517, 0)), new Location(2858, 9917, 0)),

	WHITE_WOLF_MOUNTAIN_LADDER9_DOWN(new LadderObject(17385, new Location(2859, 9919, 0)), new Location(2860, 3519, 0)),
	WHITE_WOLF_MOUNTAIN_LADDER9_UP(new LadderObject(16680, new Location(2859, 3519, 0)), new Location(2860, 9919, 0)),

	WHITE_WOLF_MOUNTAIN_LADDER10_DOWN(new LadderObject(17385, new Location(2845, 9925, 0)), new Location(2845, 3524, 0)),

	WHITE_WOLF_MOUNTAIN_LADDER11_DOWN(new LadderObject(17385, new Location(2837, 9927, 0)), new Location(2837, 3527, 0)),
