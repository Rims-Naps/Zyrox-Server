...
public enum CombatSpell implements EntitySpell {
    ...
    CONFUSE(NORMAL, 0, 13, new Animation(1163),
            ...
            new DebuffEffect(Skills.ATTACK, 5, 1)) {
        @Override
    ...
    WEAKEN(NORMAL, 0, 21, new Animation(1164),
            ...
            new DebuffEffect(Skills.STRENGTH, 5, 1)) {
        @Override
        public boolean canCast(final Player player, final Entity target) {
            final float percentage = 0.05F;
            if (target instanceof Player) {
	...
	CURSE(NORMAL, 0, 29, new Animation(1165),
            ...
            new DebuffEffect(Skills.DEFENCE, 5, 1)) {
        @Override
        public boolean canCast(final Player player, final Entity target) {
            final float percentage = 0.05F;
            if (target instanceof Player) {
    ...
    VULNERABILITY(NORMAL, 0, 76, new Animation(718),
            ...
            new DebuffEffect(Skills.DEFENCE, 10, 1)) {
        @Override
        public boolean canCast(final Player player, final Entity target) {
    ...
    ENFEEBLE(NORMAL, 0, 83, new Animation(728),
            ...
            new DebuffEffect(Skills.STRENGTH, 10, 1)) {
        @Override
        public boolean canCast(final Player player, final Entity target) {
            final float percentage = 0.1F;
            if (target instanceof Player) {
    ...
    STUN(NORMAL, 0, 90, new Animation(729),
            ...
            new DebuffEffect(Skills.ATTACK, 10, 1)) {
        @Override
        public boolean canCast(final Player player, final Entity target) {
            final float percentage = 0.1F;
            if (target instanceof Player) {
	...
	ICE_BURST(ANCIENT, 22, 40, ANCIENT_MULTI_CAST,
            ...
            new Projectile(366, 43, 0, 51, 23, 35, 64, 5),
            new BindEffect(16)),
	...
	ICE_BARRAGE(ANCIENT, 30, 52, new Animation(1979),
            ...
            new Projectile(368, 43, 0, 21, 23, 35, 64, 5),
            new BindEffect(32)),
    ...
    SANGUINESTI_STAFF(null, 24, 0, new Animation(1167),
            ...
            new SoundEffect(178, 0, 0), new SoundEffect(1460, 10, -1),
            new Projectile(1539, 23, 15, 51, 23, 25, 64, 5),
            new SanguinestiEffect()) {
        @Override
        public boolean canCast(final Player player, final Entity target) {
            if (target instanceof Player && WildernessArea.isWithinWilderness(target.getX(), target.getY())) {
    ...
    DAWNBRINGER_STAFF(null, 35, 0, new Animation(1167),
    ...
    ;
	@Getter private final int maxHit;
	@Getter private final Spellbook spellbook;
	@Getter private final double experience;
	@Getter private final Animation animation;
	@Getter private final Graphics castGfx, hitGfx;
	@Getter private final Projectile projectile;
	@Getter private final SpellEffect effect;
	@Getter private final Item[] staves;
	@Getter private final SoundEffect castSound;
	@Getter private final SoundEffect hitSound;
