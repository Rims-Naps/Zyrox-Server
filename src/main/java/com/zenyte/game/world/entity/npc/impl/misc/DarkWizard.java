...
public class DarkWizard extends NPC implements Spawnable, CombatScript {
    ...
    public int attack(final Entity target) {
        ...
        val spellType = Utils.random(5);
        val spell = spellType <= 4 ? (combat == 7 ?
                    CombatSpell.WATER_STRIKE : CombatSpell.EARTH_STRIKE) : (combat == 7 ? CombatSpell.CONFUSE : CombatSpell.WEAKEN);
