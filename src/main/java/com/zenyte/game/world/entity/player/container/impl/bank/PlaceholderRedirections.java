...
public class PlaceholderRedirections {
    ...
    public static final ImmutableMap<Integer, Integer> builder = ImmutableMap.<Integer, Integer>builder()
            ...
            .put(CRYSTAL_HALBERD_110_I,NEW_CRYSTAL_HALBERD_FULL_I).put(CRYSTAL_HALBERD_210_I,NEW_CRYSTAL_HALBERD_FULL_I).put(CRYSTAL_HALBERD_310_I,NEW_CRYSTAL_HALBERD_FULL_I).put(CRYSTAL_HALBERD_410_I,NEW_CRYSTAL_HALBERD_FULL_I).put(CRYSTAL_HALBERD_510_I,NEW_CRYSTAL_HALBERD_FULL_I).put(CRYSTAL_HALBERD_610_I,NEW_CRYSTAL_HALBERD_FULL_I).put(CRYSTAL_HALBERD_710_I,NEW_CRYSTAL_HALBERD_FULL_I).put(CRYSTAL_HALBERD_810_I,NEW_CRYSTAL_HALBERD_FULL_I).put(CRYSTAL_HALBERD_910_I,NEW_CRYSTAL_HALBERD_FULL_I).put(CRYSTAL_HALBERD_FULL_I,NEW_CRYSTAL_HALBERD_FULL_I)
            .put(CRYSTAL_HALBERD_110,NEW_CRYSTAL_HALBERD_FULL).put(CRYSTAL_HALBERD_210,NEW_CRYSTAL_HALBERD_FULL).put(CRYSTAL_HALBERD_310,NEW_CRYSTAL_HALBERD_FULL).put(CRYSTAL_HALBERD_410,NEW_CRYSTAL_HALBERD_FULL).put(CRYSTAL_HALBERD_510,NEW_CRYSTAL_HALBERD_FULL).put(CRYSTAL_HALBERD_610,NEW_CRYSTAL_HALBERD_FULL).put(CRYSTAL_HALBERD_710,NEW_CRYSTAL_HALBERD_FULL).put(CRYSTAL_HALBERD_810,NEW_CRYSTAL_HALBERD_FULL).put(CRYSTAL_HALBERD_910,NEW_CRYSTAL_HALBERD_FULL).put(CRYSTAL_HALBERD_FULL,NEW_CRYSTAL_HALBERD_FULL)
            .put(CRYSTAL_SHIELD_110_I,NEW_CRYSTAL_SHIELD_I).put(CRYSTAL_SHIELD_210_I,NEW_CRYSTAL_SHIELD_I).put(CRYSTAL_SHIELD_310_I,NEW_CRYSTAL_SHIELD_I).put(CRYSTAL_SHIELD_410_I,NEW_CRYSTAL_SHIELD_I).put(CRYSTAL_SHIELD_510_I,NEW_CRYSTAL_SHIELD_I).put(CRYSTAL_SHIELD_610_I,NEW_CRYSTAL_SHIELD_I).put(CRYSTAL_SHIELD_710_I,NEW_CRYSTAL_SHIELD_I).put(CRYSTAL_SHIELD_810_I,NEW_CRYSTAL_SHIELD_I).put(CRYSTAL_SHIELD_910_I,NEW_CRYSTAL_SHIELD_I).put(CRYSTAL_SHIELD_FULL_I,NEW_CRYSTAL_SHIELD_I)
            .put(CRYSTAL_SHIELD_110,NEW_CRYSTAL_SHIELD).put(CRYSTAL_SHIELD_210,NEW_CRYSTAL_SHIELD).put(CRYSTAL_SHIELD_310,NEW_CRYSTAL_SHIELD).put(CRYSTAL_SHIELD_410,NEW_CRYSTAL_SHIELD).put(CRYSTAL_SHIELD_510,NEW_CRYSTAL_SHIELD).put(CRYSTAL_SHIELD_610,NEW_CRYSTAL_SHIELD).put(CRYSTAL_SHIELD_710,NEW_CRYSTAL_SHIELD).put(CRYSTAL_SHIELD_810,NEW_CRYSTAL_SHIELD).put(CRYSTAL_SHIELD_910,NEW_CRYSTAL_SHIELD).put(CRYSTAL_SHIELD_FULL,NEW_CRYSTAL_SHIELD)
            .put(CRYSTAL_BOW_110_I,NEW_CRYSTAL_BOW_I).put(CRYSTAL_BOW_210_I,NEW_CRYSTAL_BOW_I).put(CRYSTAL_BOW_310_I,NEW_CRYSTAL_BOW_I).put(CRYSTAL_BOW_410_I,NEW_CRYSTAL_BOW_I).put(CRYSTAL_BOW_510_I,NEW_CRYSTAL_BOW_I).put(CRYSTAL_BOW_610_I,NEW_CRYSTAL_BOW_I).put(CRYSTAL_BOW_710_I,NEW_CRYSTAL_BOW_I).put(CRYSTAL_BOW_810_I,NEW_CRYSTAL_BOW_I).put(CRYSTAL_BOW_910_I,NEW_CRYSTAL_BOW_I).put(CRYSTAL_BOW_FULL_I,NEW_CRYSTAL_BOW_I)
            .put(CRYSTAL_BOW_110,NEW_CRYSTAL_BOW).put(CRYSTAL_BOW_210,NEW_CRYSTAL_BOW).put(CRYSTAL_BOW_310,NEW_CRYSTAL_BOW).put(CRYSTAL_BOW_410,NEW_CRYSTAL_BOW).put(CRYSTAL_BOW_510,NEW_CRYSTAL_BOW).put(CRYSTAL_BOW_610,NEW_CRYSTAL_BOW).put(CRYSTAL_BOW_710,NEW_CRYSTAL_BOW).put(CRYSTAL_BOW_810,NEW_CRYSTAL_BOW).put(CRYSTAL_BOW_910,NEW_CRYSTAL_BOW).put(CRYSTAL_BOW_FULL,NEW_CRYSTAL_BOW)
            ...
            .put(TOXIC_STAFF_UNCHARGED, TOXIC_STAFF_OF_THE_DEAD)
            ...
            .put(DRAGONFIRE_SHIELD, DRAGONFIRE_SHIELD_11284)
            .put(ANCIENT_WYVERN_SHIELD, ANCIENT_WYVERN_SHIELD_21634)
            .put(DRAGONFIRE_WARD, DRAGONFIRE_WARD_22003)

            .put(AMULET_OF_BLOOD_FURY_25,AMULET_OF_BLOOD_FURY_FULL)
            .put(AMULET_OF_BLOOD_FURY_50,AMULET_OF_BLOOD_FURY_FULL)
            .put(AMULET_OF_BLOOD_FURY_75,AMULET_OF_BLOOD_FURY_FULL)
            .put(AMULET_OF_BLOOD_FURY_100,AMULET_OF_BLOOD_FURY_FULL)

            .put(KALPHITE_PRINCESS_12654,KALPHITE_PRINCESS)
            .put(BABY_CHINCHOMPA_13324,BABY_CHINCHOMPA)
            .put(BABY_CHINCHOMPA_13325,BABY_CHINCHOMPA)
            .put(BABY_CHINCHOMPA_13326,BABY_CHINCHOMPA)
