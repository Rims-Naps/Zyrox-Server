...
public class Gorak extends NPC implements Spawnable, CombatScript {
    ...
    static {
        ...
        drainableSkills.rem(Skills.HITPOINTS);
    }
    ...
    public int attack(Entity target) {
        animate();
        val hit = new Hit(this, getRandomMaxHit(this, combatDefinitions.getMaxHit(), AttackType.CRUSH, target), HitType.REGULAR);
        ...
        if (hit.getDamage() > 0) {
            val skill = drainableSkills.getInt(Utils.random(drainableSkills.size() - 1));
