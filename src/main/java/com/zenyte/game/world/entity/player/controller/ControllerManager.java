...
public final class ControllerManager {
	...
	@Getter private transient Controller controller;
	@Expose @Getter @Setter private String lastController;
	@Expose @Getter @Setter private Object[] arguments;
	
	public final void initalize(final ControllerManager manager) {
