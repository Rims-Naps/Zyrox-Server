...
public enum SkillingChallenge implements DailyChallenge {
    ...
    COMPLETE_LAPS_ARDOUGNE_COURSE("Complete laps of the Ardougne Rooftop course", ELITE, 20, Skills.AGILITY, new ExperienceReward(Skills.AGILITY, 8000)),
    ...
    COMPLETE_KONAR_ASSIGNMENTS("Complete Assignments from Konar", ELITE, 2, Skills.SLAYER, new ExperienceReward(Skills.SLAYER, 8000)),
    COMPLETE_ELLEN_ASSIGNMENTS("Complete Assignments from Ellen", ELITE, 2, Skills.SLAYER, new ExperienceReward(Skills.SLAYER, 8000)),
    ...
    LOOT_REDWOOD_BIRDHOUSE("Loot Redwood Birdhouses", ELITE, 4, Skills.HUNTER, new ExperienceReward(Skills.HUNTER, 5000)),
    ...
    CHOP_CRYSTAL_TREES("Chop Crystal Trees", ELITE, 50, Skills.WOODCUTTING, new ExperienceReward(Skills.WOODCUTTING, 6000)),
