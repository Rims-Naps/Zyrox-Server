...
public class AncientWyvern extends Wyvern {
    ...
    private static final Projectile rangedProjectile =
            new Projectile(500, 94, 35, 50, 0, 8, 0, 5);
    ...
    public int attack(Entity target) {
        ...
        if (style == 0) {
            ...
            delayHit(this, World.sendProjectile(this, target, rangedProjectile), target,
                    new Hit(this, getRandomMaxHit(this, 10, RANGED, target), HitType.DEFAULT));
        } else {
            setAnimation(meleeAnim);
            delayHit(this, 0, target,
                    new Hit(this, getRandomMaxHit(this, 16, MELEE, target), HitType.MELEE));
        }
