...
public enum AmmunitionDefinitions {
    ...
    IRON_ARROW(new int[] { 884, 2532, 885, 5617, 5623 }, true, new Graphics(18, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(9, 40, 36, 41, 21, 5, 11, 5), 23357, 841, 843, 849, 853, 857, 861, 12788, 10280, 10282, 10284, 839, 845, 847, 851, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768
            , 20997),

    STEEL_ARROW(new int[] { 886, 2534, 887, 5618, 5624 }, true, new Graphics(20, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(11, 40, 36, 41, 21, 5, 11, 5), 843, 849, 853, 857, 861, 12788, 10280, 10282, 10284, 845, 847, 851, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, 20997),

    MITHRIL_ARROW(new int[] { 888, 2536, 889, 5619, 5625 }, true, new Graphics(21, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(12, 40, 36, 41, 21, 5, 11, 5), 849, 853, 857, 861, 12788, 10280, 10282, 10284, 847, 851, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, 20997),

    ADAMANT_ARROW(new int[] { 890, 2538, 891, 5620, 5626 }, true, new Graphics(22, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(13, 40, 36, 41, 21, 5, 11, 5), 853, 857, 861, 12788, 10282, 10284, 851, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, 20997),

    BROAD_ARROW(new int[]{4160}, true, new Graphics(23, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(1384, 40, 36, 41, 21, 5, 11, 5), 861, 859, 12788, 20997),

    RUNE_ARROW(new int[] { 892, 2540, 893, 5621, 5627 }, true, new Graphics(24, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(15, 40, 36, 41, 21, 5, 11, 5), 857, 861, 12788, 10282, 10284, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, 20997),

    AMETHYST_ARROW(new int[] { 21326, 21328, 21332, 21334, 21336 }, true, new Graphics(1385, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(1384, 40, 36, 41, 21, 5, 11, 5), 861, 12788, 10284, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, 20997),

    DRAGON_ARROW(new int[] { 11212, 11217, 11227, 11228, 11229 }, true, new Graphics(1116, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(1120, 40, 36, 41, 21, 5, 11, 5), 12424, 11235, 12765, 12766, 12767, 12768, 20997),
    ...
    LIT_STEEL_ARROW(2535, true, new Graphics(26, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(17, 40, 36, 41, 21, 5, 11, 5), 843, 849, 853, 857, 861, 12788, 10280, 10282, 10284, 845, 847, 851, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, 20997),

    LIT_MITHRIL_ARROW(2537, true, new Graphics(26, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(17, 40, 36, 41, 21, 5, 11, 5), 849, 853, 857, 861, 12788, 10280, 10282, 10284, 847, 851, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, 20997),

    LIT_ADAMANT_ARROW(2539, true, new Graphics(26, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(17, 40, 36, 41, 21, 5, 11, 5), 853, 857, 861, 12788, 10282, 10284, 851, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, 20997),

    LIT_RUNE_ARROW(2541, true, new Graphics(26, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(17, 40, 36, 41, 21, 5, 11, 5), 857, 861, 12788, 10282, 10284, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, 20997),

    LIT_AMETHYST_ARROW(21330, true, new Graphics(26, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(17, 40, 36, 41, 21, 5, 11, 5), 861, 12788, 10284, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, 20997),

    LIT_DRAGON_ARROW(11222, true, new Graphics(1116, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(1121, 40, 36, 41, 21, 5, 11, 5), 12424, 11235, 12765, 12766, 12767, 12768, 20997),
    ...
    BRONZE_BOLT(new int[] { 877, 879 }, true, new SoundEffect(2695, 0, 0),
            new Projectile(27, 38, 36, 41, 7, 5, 11, 5), 767, 837, 9174, 9176, 9177, 9179, 9181, 9183, 9185, 11165, 11167, 11785, 21012, 21902, 32197, 32199),

    BLURITE_BOLT(new int[] { 9139, 9335 }, true, new SoundEffect(2695, 0, 0),
            new Projectile(27, 38, 36, 41, 7, 5, 11, 5), 9176, 9177, 9179, 9181, 9183, 9185, 11785, 21012, 21902, 32197, 32199),

    SILVER_BOLT(9145, true, new SoundEffect(2695, 0, 0),
            new Projectile(27, 38, 36, 41, 7, 5, 11, 5), 9177, 9179, 9181, 9183, 9185, 11785, 21012, 21902, 32197, 32199),

    IRON_BOLT(new int[] { 9140, 880 }, true, new SoundEffect(2695, 0, 0),
            new Projectile(27, 38, 36, 41, 7, 5, 11, 5), 9177, 9179, 9181, 9183, 9185, 11785, 21012, 21902, 32197, 32199),

    STEEL_BOLT(new int[] { 9141, 9336 }, true, new SoundEffect(2695, 0, 0),
            new Projectile(27, 38, 36, 41, 7, 5, 11, 5), 9179, 9181, 9183, 9185, 11785, 21012, 21902, 32197, 32199),

    MITHRIL_BOLT(new int[] { 9142, 9337, 9338 }, true, new SoundEffect(2695, 0, 0),
            new Projectile(27, 38, 36, 41, 7, 5, 11, 5), 9181, 9183, 9185, 11785, 21012, 21902, 32197, 32199),

    ADAMANT_BOLT(new int[] { 9143, 9339, 9340 }, true, new SoundEffect(2695, 0, 0),
            new Projectile(27, 38, 36, 41, 7, 5, 11, 5), 9183, 9185, 11785, 21012, 21902, 32197, 32199),

    RUNITE_BOLT(new int[] { 9144, 9341, 9342 }, true, new SoundEffect(2695, 0, 0),
            new Projectile(27, 38, 36, 41, 7, 5, 11, 5), 9185, 11785, 21012, 21902, 32197, 32199),
    ...
    DRAGON_BOLT(new int[] { 21905, 21924, 21926, 21928, 21955, 21957, 21959, 21961, 21963, 21965, 21967, 21969, 21971, 21973 }, true, new SoundEffect(2695, 0, 0),
            new Projectile(27, 38, 36, 41, 7, 5, 11, 5), 11785, 21012, 21902, 32197, 32199),
    ...
    AMETHYST_DART(new int[]{31036}, true, new Graphics(237, 0, 96), new SoundEffect(2696, 0, 0),
            new Projectile(231, 40, 36, 32, 21, 0, 11, 5)),
    ...
    BLOWPIPE_AMETHYST_DART(31036, true, null, new SoundEffect(2696, 0, 0),
            new Projectile(1122, 35, 36, 32, 21, 0, 105, 5)),
    ...
    CONCENTRATED_BRONZE_JAVELIN(new int[] { 825, 831, 5642, 5648 }, false, new SoundEffect(2536, 0, 0),
            new Projectile(200, 38, 36, 49, 1, -18, 120, 5), 19478, 19481),

    CONCENTRATED_IRON_JAVELIN(new int[] { 826, 832, 5643, 5649 }, false, new SoundEffect(2536, 0, 0),
            new Projectile(201, 38, 36, 49, 1, -18, 120, 5), 19478, 19481),

    CONCENTRATED_STEEL_JAVELIN(new int[] { 827, 833, 5644, 5650 }, false, new SoundEffect(2536, 0, 0),
            new Projectile(202, 38, 36, 49, 1, -18, 120, 5), 19478, 19481),

    CONCENTRATED_MITHRIL_JAVELIN(new int[] { 828, 834, 5645, 5651 }, false, new SoundEffect(2536, 0, 0),
            new Projectile(203, 38, 36, 49, 1, -18, 120, 5), 19478, 19481),

    CONCENTRATED_ADAMANT_JAVELIN(new int[] { 829, 835, 5646, 5652 }, false, new SoundEffect(2536, 0, 0),
            new Projectile(204, 38, 36, 49, 1, -18, 120, 5), 19478, 19481),

    CONCENTRATED_RUNE_JAVELIN(new int[] { 830, 836, 5647, 5653 }, false, new SoundEffect(2536, 0, 0),
            new Projectile(205, 38, 36, 49, 1, -18, 120, 5), 19478, 19481),

    CONCENTRATED_AMETHYST_JAVELIN(new int[] { 21318, 21320, 21322, 21324 }, false, new SoundEffect(2536, 0, 0),
            new Projectile(1386, 38, 36, 49, 1, -18, 120, 5), 19478, 19481),

    CONCENTRATED_DRAGON_JAVELIN(new int[] { 19484, 19486, 19488, 19490 }, false, new SoundEffect(2536, 0, 0),
            new Projectile(1301, 38, 36, 49, 1, -18, 120, 5), 19478, 19481),




    CRYSTAL_ARROW(new int[] { 4212, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221, 4222, 4223, 11748, 11749, 11750, 11751, 11752, 11753, 11754, 11755, 11756, 11757, 11758, }, false, new Graphics(250, 0, 96), new SoundEffect(1352, 0, 0),
            new Projectile(249, 40, 36, 41, 21, 5, 11, 5), 4212, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221, 4222, 4223, 11748, 11749, 11750, 11751, 11752, 11753, 11754, 11755, 11756, 11757, 11758),

    CRAWS_BOW_ARROW(new int[] { 22547, 22550, 30596, 32158, 32160, 32162, 32164, 32166, 32168, 32170, 32172, 32174 }, false, new Graphics(1611, 0, 96), new SoundEffect(1352, 0, 0),
            new Projectile(1574, 40, 36, 41, 21, 5, 11, 5), 22547, 22550, 30596, 32158, 32160, 32162, 32164, 32166, 32168, 32170, 32172, 32174),
	...
	@Getter private final Graphics drawbackGfx;
	@Getter private final SoundEffect soundEffect;
	@Getter private final Projectile projectile;
	@Getter private final int[] bows;
	@Getter private final boolean retrievable;
	@Getter private final boolean weapon;

	public static final AmmunitionDefinitions getDefinitions(final int id) {
		return definitions.get(id);
	}
	
	public static final AmmunitionDefinitions getBlowpipeDefinitions(final int id) {
		return blowpipeDefinitions.get(id);
	}
	
	public static final AmmunitionDefinitions getConcentratedDefinitions(final int id) {
