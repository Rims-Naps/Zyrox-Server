    ...
    public int attack(final Entity target) {
        switch (getCombatDefinitions().getAttackStyle()) {
            ...
            case RANGED:
                ...
                delayHit(this, World.sendProjectile(this, target, rangedProjectile), target,
                        new Hit(this, getRandomMaxHit(this, getCombatDefinitions().getMaxHit(), RANGED, target), HitType.RANGED).onLand(h -> World.sendSoundEffect(new Location(target.getLocation()), impactSound)));
                break;
            default:
        ...
        val currentStyle = combatDefinitions.getAttackStyle();
        val styles = new ObjectArrayList<AttackType>(Arrays.asList(ATTACK_STYLES));
