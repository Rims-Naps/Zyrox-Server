...
public class TutorialIslandArea extends Area implements TeleportPlugin, RandomEventRestrictionPlugin {
    ...
    public static final RSPolygon polygon = new RSPolygon(new int[][] { { 3103, 3140 }, { 3104, 3142 }, { 3086, 3154 }, { 3055, 3135 }, { 3040, 3101 },
            { 3052, 3074 }, { 3042, 3055 }, { 3049, 3048 }, { 3073, 3040 }, { 3110, 3040 }, { 3132, 3044 }, { 3137, 3051 },
            { 3136, 3068 }, { 3166, 3070 }, { 3171, 3102 }, { 3164, 3117 }, { 3164, 3129 }, { 3136, 3138 }, { 3132, 3144 } });
	...
	public void enter(final Player player) {
		val npc = World.getNPC(9005, 12336);
		if (npc != null) {
