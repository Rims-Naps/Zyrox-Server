...
public enum Greegree {
	KARAMJAN_MONKEY_GREEGREE(4031, 1469),
	SMALL_NINJA_MONKEY_GREEGREE(4024, 1462),
	MEDIUM_NINJA_MONKEY_GREEGREE(4025, 1463),
	SMALL_ZOMBIE_MONKEY_GREEGREE(4029, 1467),
	LARGE_ZOMBIE_MONKEY_GREEGREE(4030, 1468),
	GORILLA_GREEGREE(4026, 1464),
	BEARDED_GORILLA_GREEGREE(4027, 1465),
	ANCIENT_GORILLA_GREEGREE(4028, 1466),
	KRUK_MONKEY_GREEGREE(19525, 5257);
	...
	@Getter private final int itemId, npcId;
