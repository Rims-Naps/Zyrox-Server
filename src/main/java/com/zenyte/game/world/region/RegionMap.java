...
public class RegionMap {
    ...
    RegionMap(final int regionId) {
        hash = ((regionId & 0xff) * 64) | ((regionId >> 8) * 64) << 14;
        masks = new int[4][64][64];
    }

    public static final boolean checkWalkStep(final int plane, final int x, final int y, final int xOffset,
                                              final int yOffset, final int size, final boolean checkCollidingNPCs,
                                              final boolean checkCollidingPlayers) {
        int collisionFlag = 0;
        ...
        if (size == 1) {
            ...
            if (xOffset == -1 && yOffset == -1) {
                return (mask & (Flags.BLOCK_NORTH_EAST)) == 0 
                        && (World.getMask(plane, x - 1, y) & (Flags.BLOCK_EAST)) == 0 
                        && (World.getMask(plane, x, y - 1) & (Flags.BLOCK_NORTH)) == 0;
            }
            if (xOffset == 1 && yOffset == -1) {
                return (mask & (Flags.BLOCK_NORTH_WEST)) == 0 
                        && (World.getMask(plane, x + 1, y) & (Flags.BLOCK_WEST)) == 0 
                        && (World.getMask(plane, x, y - 1) & (Flags.BLOCK_NORTH)) == 0;
            }
            if (xOffset == -1 && yOffset == 1) {
                return (mask & (Flags.BLOCK_SOUTH_EAST)) == 0 
                        && (World.getMask(plane, x - 1, y) & (Flags.BLOCK_EAST)) == 0 
                        && (World.getMask(plane, x, y + 1) & (Flags.BLOCK_SOUTH)) == 0;
            }
            if (xOffset == 1 && yOffset == 1) {
                return (mask & (Flags.BLOCK_SOUTH_WEST)) == 0 
                        && (World.getMask(plane, x + 1, y) & (Flags.BLOCK_WEST)) == 0 
                        && (World.getMask(plane, x, y + 1) & (Flags.BLOCK_SOUTH)) == 0;
            }
        } else if (size == 2) {
            if (xOffset == -1 && yOffset == 0) {
                return (World.getMask(plane, x - 1, y) & (Flags.BLOCK_NORTH_EAST | collisionFlag)) == 0
                        && (World.getMask(plane, x - 1, y + 1) & (Flags.BLOCK_SOUTH_EAST | collisionFlag)) == 0;
            }
            if (xOffset == 1 && yOffset == 0) {
                return (World.getMask(plane, x + 2, y) & (Flags.BLOCK_NORTH_WEST | collisionFlag)) == 0
                        && (World.getMask(plane, x + 2, y + 1) & (Flags.BLOCK_SOUTH_WEST | collisionFlag)) == 0;
            }
            if (xOffset == 0 && yOffset == -1) {
                return (World.getMask(plane, x, y - 1) & (Flags.BLOCK_NORTH_EAST | collisionFlag)) == 0
                        && (World.getMask(plane, x + 1, y - 1) & (Flags.BLOCK_NORTH_WEST | collisionFlag)) == 0;
            }
            if (xOffset == 0 && yOffset == 1) {
                return (World.getMask(plane, x, y + 2) & (Flags.BLOCK_SOUTH_EAST | collisionFlag)) == 0
                        && (World.getMask(plane, x + 1, y + 2) & (Flags.BLOCK_SOUTH_WEST | collisionFlag)) == 0;
            }
            if (xOffset == -1 && yOffset == -1) {
                return (World.getMask(plane, x - 1, y) & (Flags.BLOCK_NORTH_EAST | Flags.BLOCK_SOUTH_EAST | collisionFlag)) == 0
                        && (World.getMask(plane, x - 1, y - 1) & (Flags.BLOCK_NORTH_EAST | collisionFlag)) == 0
                        && (World.getMask(plane, x, y - 1) & (Flags.BLOCK_NORTH_WEST | Flags.BLOCK_NORTH_EAST | collisionFlag)) == 0;
            }
            if (xOffset == 1 && yOffset == -1) {
                return (World.getMask(plane, x + 1, y - 1) & (Flags.BLOCK_NORTH_WEST | Flags.BLOCK_NORTH_EAST | collisionFlag)) == 0
                        && (World.getMask(plane, x + 2, y - 1) & (Flags.BLOCK_NORTH_WEST | collisionFlag)) == 0
                        && (World.getMask(plane, x + 2, y) & (Flags.BLOCK_NORTH_WEST | Flags.BLOCK_SOUTH_WEST | collisionFlag)) == 0;
            }
            if (xOffset == -1 && yOffset == 1) {
                return (World.getMask(plane, x - 1, y + 1) & (Flags.BLOCK_NORTH_EAST | Flags.BLOCK_SOUTH_EAST | collisionFlag)) == 0
                        && (World.getMask(plane, x - 1, y + 2) & (Flags.BLOCK_SOUTH_EAST | collisionFlag)) == 0
                        && (World.getMask(plane, x, y + 2) & (Flags.BLOCK_SOUTH_EAST | Flags.BLOCK_SOUTH_WEST | collisionFlag)) == 0;
            }
            if (xOffset == 1 && yOffset == 1) {
                return (World.getMask(plane, x + 1, y + 2) & (Flags.BLOCK_SOUTH_EAST | Flags.BLOCK_SOUTH_WEST | collisionFlag)) == 0
                        && (World.getMask(plane, x + 2, y + 2) & (Flags.BLOCK_SOUTH_WEST | collisionFlag)) == 0
                        && (World.getMask(plane, x + 1, y + 1) & (Flags.BLOCK_NORTH_WEST | Flags.BLOCK_SOUTH_WEST | collisionFlag)) == 0;
            }
        } else {
            if (xOffset == -1 && yOffset == 0) {
                if ((World.getMask(plane, x - 1, y) & (Flags.BLOCK_NORTH_EAST | collisionFlag)) != 0
                        || (World.getMask(plane, x - 1, -1 + (y + size)) & (Flags.BLOCK_SOUTH_EAST | collisionFlag)) != 0) {
                    return false;
                }
                ...
                if ((World.getMask(plane, x + size, y) & (Flags.BLOCK_NORTH_WEST | collisionFlag)) != 0
                        || (World.getMask(plane, x + size, y - (-size + 1)) & (Flags.BLOCK_SOUTH_WEST | collisionFlag)) != 0) {
                    return false;
                }
                for (int sizeOffset = 1; sizeOffset < size - 1; sizeOffset++) {
                ...
                if ((World.getMask(plane, x, y - 1) & (Flags.BLOCK_NORTH_EAST | collisionFlag)) != 0
                        || (World.getMask(plane, x + size - 1, y - 1) & (Flags.BLOCK_NORTH_WEST | collisionFlag)) != 0) {
                    return false;
                }
                for (int sizeOffset = 1; sizeOffset < size - 1; sizeOffset++) {
                ...
                if ((World.getMask(plane, x, y + size) & (Flags.BLOCK_SOUTH_EAST | collisionFlag)) != 0
                        || (World.getMask(plane, x + (size - 1), y + size) & (Flags.BLOCK_SOUTH_WEST | collisionFlag)) != 0) {
                    return false;
                }
                for (int sizeOffset = 1; sizeOffset < size - 1; sizeOffset++) {
                ...
                for (int sizeOffset = 1; sizeOffset < size; sizeOffset++) {
                    if ((World.getMask(plane, x - 1, y + (-1 + sizeOffset)) & (Flags.BLOCK_NORTH_EAST | Flags.BLOCK_SOUTH_EAST | collisionFlag)) != 0
                            || (World.getMask(plane, sizeOffset - 1 + x, y - 1) & (Flags.BLOCK_NORTH_WEST | Flags.BLOCK_NORTH_EAST | collisionFlag)) != 0) {
                        return false;
                    }
                }
            } else if (xOffset == 1 && yOffset == -1) {
                ...
                for (int sizeOffset = 1; sizeOffset < size; sizeOffset++) {
                    if ((World.getMask(plane, x + size, sizeOffset + (-1 + y)) & (Flags.BLOCK_NORTH_WEST | Flags.BLOCK_SOUTH_WEST | collisionFlag)) != 0
                            || (World.getMask(plane, x + sizeOffset, y - 1) & (Flags.BLOCK_NORTH_WEST | Flags.BLOCK_NORTH_EAST | collisionFlag)) != 0) {
                        return false;
                    }
                }
            } else if (xOffset == -1 && yOffset == 1) {
                ...
                for (int sizeOffset = 1; sizeOffset < size; sizeOffset++) {
                    if ((World.getMask(plane, x - 1, y + sizeOffset) & (Flags.BLOCK_NORTH_EAST | Flags.BLOCK_SOUTH_EAST | collisionFlag)) != 0
                            || (World.getMask(plane, -1 + (x + sizeOffset), y + size) & (Flags.BLOCK_SOUTH_EAST | Flags.BLOCK_SOUTH_WEST | collisionFlag)) != 0) {
                        return false;
                    }
                }
            } else if (xOffset == 1 && yOffset == 1) {
                ...
                for (int sizeOffset = 1; sizeOffset < size; sizeOffset++) {
                    if ((World.getMask(plane, x + sizeOffset, y + size) & (Flags.BLOCK_SOUTH_EAST | Flags.BLOCK_SOUTH_WEST | collisionFlag)) != 0
                            || (World.getMask(plane, x + size, y + sizeOffset) & (Flags.BLOCK_NORTH_WEST | Flags.BLOCK_SOUTH_WEST | collisionFlag)) != 0) {
                        return false;
                    }
                }
            }
    ...
    public void setFloor(int plane, int var1, int var2, boolean add) {
        this.setFlag(plane, var1, var2, Flags.FLOOR_DECORATION, add);
    }
    ...
    synchronized void setFlag(int plane, int localX, int localY, int mask, boolean add) {
        if (localX >= 64 || localY >= 64 || localX < 0 || localY < 0) {
            val x = getRegionX() + localX;
            val y = getRegionY() + localY;
            val regionId = ((x >> 6) << 8) + (y >> 6);
            val regionX = (regionId >> 8) << 6;
            val regionY = (regionId & 0xff) << 6;
