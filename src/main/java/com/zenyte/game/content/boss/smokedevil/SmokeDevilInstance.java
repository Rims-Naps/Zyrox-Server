...
public class SmokeDevilInstance extends DynamicArea implements DeathPlugin, CannonRestrictionPlugin, EntityAttackPlugin, LootBroadcastPlugin {
    ...
    private static final Location[] smokeDevilSpawnTiles = new Location[] {
            new ImmutableLocation(2371, 9453, 0), new ImmutableLocation(2370, 9443, 0),
            new ImmutableLocation(2362, 9444, 0), new ImmutableLocation(2361, 9456, 0),
            new ImmutableLocation(2355, 9454, 0), new ImmutableLocation(2355, 9447, 0)
    };
    ...
    public void constructed() {
        for (val tile : smokeDevilSpawnTiles) {
    ...
    public boolean attack(Player player, Entity entity) {
        if (entity instanceof NPC) {
            val name = ((NPC) entity).getDefinitions().getName();
