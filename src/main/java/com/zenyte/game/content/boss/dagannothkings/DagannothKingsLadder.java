    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        switch (option) {
            ...
            case "Slayer":
                ...
                if (assignment == null || (assignment.getTask() != RegularTask.DAGANNOTH && assignment.getTask() != BossTask.DAGANNOTH_KINGS && assignment.getTask() != RegularTask.DAGANNOTH_KINGS)) {
            ...
            case "Peek":
                ...
                WorldTasksManager.schedule(() -> {
                    ...
                    val slayerPlayerCount = GlobalAreaManager.get("Dagannoth Kings Slayer-Only Lair").getPlayers().size();
            ...
            case "Private":
                ...
                val arrow = new HintArrow(1917, 4362, (byte) 100, HintArrowPosition.CENTER);
