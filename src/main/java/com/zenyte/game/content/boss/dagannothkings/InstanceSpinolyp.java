...
public class InstanceSpinolyp extends NPC implements CombatScript {
    ...
    protected final boolean canMove(final int fromX, final int fromY, final int direction) {
        ...
        return (World.getMask(getPlane(), x, y) & 0xFFFF) == 0 && !polygon.contains(x, y);
    }
    ...
    public int attack(final Entity target) {
        ...
        if (ranged) {
            ...
            delayHit(this, World.sendProjectile(this, target, attackProjectile), target, new Hit(this, getRandomMaxHit(this, combatDefinitions.getMaxHit(), RANGED, target),
