...
public enum StorableTreasure implements StorageUnitElement {
    ...
    GOLD_TRIMMED_STUDDED_LEATHER(ItemId.STUDDED_BODY_G_10680, new StorableSetPiece(ItemId.STUDDED_BODY_G, ItemId.STUDDED_CHAPS_G)),
    FUR_TRIMMED_STUDDED_LEATHER(ItemId.STUDDED_BODY_T_10681, new StorableSetPiece(ItemId.STUDDED_BODY_T, ItemId.STUDDED_CHAPS_T)),
    BLUE_WIZARD_GOLD(ItemId.WIZARD_ROBE_G, new StorableSetPiece(ItemId.BLUE_WIZARD_HAT_G, ItemId.BLUE_WIZARD_ROBE_G, ItemId.BLUE_SKIRT_G)),
    BLUE_WIZARD_TRIM(ItemId.WIZARD_ROBE_T, new StorableSetPiece(ItemId.BLUE_WIZARD_HAT_T, ItemId.BLUE_WIZARD_ROBE_T, ItemId.BLUE_SKIRT_T)),
    BLACK_WIZARD_GOLD(ItemId.BLACK_WIZARD_HAT_G, new StorableSetPiece(ItemId.BLACK_WIZARD_HAT_G, ItemId.BLACK_WIZARD_ROBE_G, ItemId.BLACK_SKIRT_G)),
    BLACK_WIZARD_TRIM(ItemId.BLACK_WIZARD_HAT_T, new StorableSetPiece(ItemId.BLACK_WIZARD_HAT_T, ItemId.BLACK_WIZARD_ROBE_T, ItemId.BLACK_SKIRT_T)),
    TRIMMED_BLACK_ARMOUR(ItemId.BLACK_PLATEBODY_T_10690, new StorableSetPiece(ItemId.BLACK_FULL_HELM_T, ItemId.BLACK_PLATEBODY_T, ItemId.BLACK_PLATELEGS_T, ItemId.BLACK_PLATESKIRT_T, ItemId.BLACK_KITESHIELD_T)),
    GOLD_TRIMMED_BLACK_ARMOUR(ItemId.BLACK_PLATEBODY_G_10691, new StorableSetPiece(ItemId.BLACK_FULL_HELM_G, ItemId.BLACK_PLATEBODY_G, ItemId.BLACK_PLATELEGS_G, ItemId.BLACK_PLATESKIRT_G, ItemId.BLACK_KITESHIELD_G)),
    ...
    ELEGANT_CLOTHES_RED(ItemId.RED_ELEGANT_SHIRT_10750, new StorableSetPiece(ItemId.RED_ELEGANT_SHIRT, ItemId.RED_ELEGANT_BLOUSE, ItemId.RED_ELEGANT_LEGS, ItemId.RED_ELEGANT_SKIRT)),
    ELEGANT_CLOTHES_GREEN(ItemId.GREEN_ELEGANT_SHIRT_10754, new StorableSetPiece(ItemId.GREEN_ELEGANT_SHIRT, ItemId.GREEN_ELEGANT_BLOUSE, ItemId.GREEN_ELEGANT_LEGS, ItemId.GREEN_ELEGANT_SKIRT)),
    ELEGANT_CLOTHES_BLUE(ItemId.BLUE_ELEGANT_SHIRT_10752, new StorableSetPiece(ItemId.BLUE_ELEGANT_SHIRT, ItemId.BLUE_ELEGANT_BLOUSE, ItemId.BLUE_ELEGANT_LEGS, ItemId.BLUE_ELEGANT_SKIRT)),
    ELEGANT_CLOTHES_BLACK(ItemId.BLACK_ELEGANT_SHIRT_10748, new StorableSetPiece(ItemId.BLACK_ELEGANT_SHIRT, ItemId.WHITE_ELEGANT_BLOUSE, ItemId.BLACK_ELEGANT_LEGS, ItemId.WHITE_ELEGANT_SKIRT)),
    ELEGANT_CLOTHES_PURPLE(ItemId.PURPLE_ELEGANT_SHIRT_10756, new StorableSetPiece(ItemId.PURPLE_ELEGANT_SHIRT, ItemId.PURPLE_ELEGANT_BLOUSE, ItemId.PURPLE_ELEGANT_LEGS, ItemId.PURPLE_ELEGANT_SKIRT)),
    ELEGANT_CLOTHES_PINK(ItemId.PINK_ELEGANT_SHIRT, new StorableSetPiece(ItemId.PINK_ELEGANT_SHIRT, ItemId.PINK_ELEGANT_BLOUSE, ItemId.PINK_ELEGANT_LEGS, ItemId.PINK_ELEGANT_SKIRT)),
    ELEGANT_CLOTHES_GOLD(ItemId.GOLD_ELEGANT_SHIRT, new StorableSetPiece(ItemId.GOLD_ELEGANT_SHIRT, ItemId.GOLD_ELEGANT_BLOUSE, ItemId.GOLD_ELEGANT_LEGS, ItemId.GOLD_ELEGANT_SKIRT)),
    BERET_MASK(ItemId.BERET_MASK, new StorableSetPiece(ItemId.BERET_MASK_11282)),
    BRONZE_ARMOUR_TRIM(ItemId.BRONZE_PLATEBODY_T, new StorableSetPiece(ItemId.BRONZE_FULL_HELM_T, ItemId.BRONZE_PLATEBODY_T, ItemId.BRONZE_PLATELEGS_T, ItemId.BRONZE_PLATESKIRT_T, ItemId.BRONZE_KITESHIELD_T)),
    BRONZE_ARMOUR_GOLD(ItemId.BRONZE_PLATEBODY_G, new StorableSetPiece(ItemId.BRONZE_FULL_HELM_G, ItemId.BRONZE_PLATEBODY_G, ItemId.BRONZE_PLATELEGS_G, ItemId.BRONZE_PLATESKIRT_G, ItemId.BRONZE_KITESHIELD_G)),
    IRON_ARMOUR_TRIM(ItemId.IRON_PLATEBODY_T, new StorableSetPiece(ItemId.IRON_FULL_HELM_T, ItemId.IRON_PLATEBODY_T, ItemId.IRON_PLATELEGS_T, ItemId.IRON_PLATESKIRT_T, ItemId.IRON_KITESHIELD_T)),
    IRON_ARMOUR_GOLD(ItemId.IRON_PLATEBODY_G, new StorableSetPiece(ItemId.IRON_FULL_HELM_G, ItemId.IRON_PLATEBODY_G, ItemId.IRON_PLATELEGS_G, ItemId.IRON_PLATESKIRT_G, ItemId.IRON_KITESHIELD_G)),
    STEEL_ARMOUR_TRIM(ItemId.STEEL_PLATEBODY_T, new StorableSetPiece(ItemId.STEEL_FULL_HELM_T, ItemId.STEEL_PLATEBODY_T, ItemId.STEEL_PLATELEGS_T, ItemId.STEEL_PLATESKIRT_T, ItemId.STEEL_KITESHIELD_T)),
    STEEL_ARMOUR_GOLD(ItemId.STEEL_PLATEBODY_G, new StorableSetPiece(ItemId.STEEL_FULL_HELM_G, ItemId.STEEL_PLATEBODY_G, ItemId.STEEL_PLATELEGS_G, ItemId.STEEL_PLATESKIRT_G, ItemId.STEEL_KITESHIELD_G)),
    ...
    MONK_ROBES_GOLD(ItemId.MONKS_ROBE_TOP_G, new StorableSetPiece(ItemId.MONKS_ROBE_TOP_G, ItemId.MONKS_ROBE_G)),
    ...
    GREEN_DRAGONHIDE_GOLD(ItemId.DHIDE_BODY_G, new StorableSetPiece(ItemId.GREEN_DHIDE_BODY_G, ItemId.GREEN_DHIDE_CHAPS_G)),
    GREEN_DRAGONHIDE_TRIM(ItemId.DHIDE_BODY_T, new StorableSetPiece(ItemId.GREEN_DHIDE_BODY_T, ItemId.GREEN_DHIDE_CHAPS_T)),
    RANGER_BOOTS(ItemId.RANGER_BOOTS_10696, new StorableSetPiece(ItemId.RANGER_BOOTS)),
    TRIMMED_ADAMANTITE_ARMOUR(ItemId.ADAMANT_PLATEBODY_T_10697, new StorableSetPiece(ItemId.ADAMANT_FULL_HELM_T, ItemId.ADAMANT_PLATEBODY_T, ItemId.ADAMANT_PLATELEGS_T, ItemId.ADAMANT_PLATESKIRT_T, ItemId.ADAMANT_KITESHIELD_T)),
    GOLD_TRIMMED_ADAMANTITE_ARMOUR(ItemId.ADAMANT_PLATEBODY_G_10698, new StorableSetPiece(ItemId.ADAMANT_FULL_HELM_G, ItemId.ADAMANT_PLATEBODY_G, ItemId.ADAMANT_PLATELEGS_G, ItemId.ADAMANT_PLATESKIRT_G, ItemId.ADAMANT_KITESHIELD_G)),
    ...
    MITHRIL_ARMOUR_GOLD(ItemId.MITHRIL_PLATEBODY_G, new StorableSetPiece(ItemId.MITHRIL_FULL_HELM_G, ItemId.MITHRIL_PLATEBODY_G, ItemId.MITHRIL_PLATELEGS_G, ItemId.MITHRIL_PLATESKIRT_G, ItemId.MITHRIL_KITESHIELD_G)),
    MITHRIL_ARMOUR_TRIM(ItemId.MITHRIL_PLATEBODY_T, new StorableSetPiece(ItemId.MITHRIL_FULL_HELM_T, ItemId.MITHRIL_PLATEBODY_T, ItemId.MITHRIL_PLATELEGS_T, ItemId.MITHRIL_PLATESKIRT_T, ItemId.MITHRIL_KITESHIELD_T)),
    ...
    ARMADYL_VESTMENTS(ItemId.ARMADYL_ROBE_TOP, new StorableSetPiece(ItemId.ARMADYL_MITRE, ItemId.ARMADYL_ROBE_TOP, ItemId.ARMADYL_ROBE_LEGS, ItemId.ARMADYL_CLOAK, ItemId.ARMADYL_CROZIER, ItemId.ARMADYL_STOLE)),
    ANCIENT_VESTMENTS(ItemId.ANCIENT_ROBE_TOP, new StorableSetPiece(ItemId.ANCIENT_MITRE, ItemId.ANCIENT_ROBE_TOP, ItemId.ANCIENT_ROBE_LEGS, ItemId.ANCIENT_CLOAK, ItemId.ANCIENT_CROZIER, ItemId.ANCIENT_STOLE)),
    BANDOS_VESTMENTS(ItemId.BANDOS_ROBE_TOP, new StorableSetPiece(ItemId.BANDOS_MITRE, ItemId.BANDOS_ROBE_TOP, ItemId.BANDOS_ROBE_LEGS, ItemId.BANDOS_CLOAK, ItemId.BANDOS_CROZIER, ItemId.BANDOS_STOLE)),
    ...
    RUNE_HERALDIC_KITESHIELD5(ItemId.RUNE_SHIELD_H5_10679, new StorableSetPiece(ItemId.RUNE_SHIELD_H5)),
    BLUE_DRAGONHIDE_GOLD(ItemId.DHIDE_BODY_G_10684, new StorableSetPiece(ItemId.BLUE_DHIDE_BODY_G, ItemId.BLUE_DHIDE_CHAPS_G)),
    BLUE_DRAGONHIDE_TRIM(ItemId.DHIDE_BODY_T_10685, new StorableSetPiece(ItemId.BLUE_DHIDE_BODY_T, ItemId.BLUE_DHIDE_CHAPS_T)),
    ENCHANTED_ROBES(ItemId.ENCHANTED_TOP_10688, new StorableSetPiece(ItemId.ENCHANTED_HAT, ItemId.ENCHANTED_TOP, ItemId.ENCHANTED_ROBE)),
    ROBIN_HOOD_HAT(ItemId.ROBIN_HOOD_HAT_10796, new StorableSetPiece(ItemId.ROBIN_HOOD_HAT)),
    GOLD_TRIMMED_RUNE_ARMOUR(ItemId.RUNE_PLATEBODY_G_10798, new StorableSetPiece(ItemId.RUNE_FULL_HELM_G, ItemId.RUNE_PLATEBODY_G, ItemId.RUNE_PLATELEGS_G, ItemId.RUNE_PLATESKIRT_G, ItemId.RUNE_KITESHIELD_G)),
    TRIMMED_RUNE_ARMOUR(ItemId.RUNE_PLATEBODY_T_10800, new StorableSetPiece(ItemId.RUNE_FULL_HELM_T, ItemId.RUNE_PLATEBODY_T, ItemId.RUNE_PLATELEGS_T, ItemId.RUNE_PLATESKIRT_T, ItemId.RUNE_KITESHIELD_T)),
    ...
    ZAMORAK_RUNE_ARMOUR(ItemId.ZAMORAK_PLATEBODY_10776, new StorableSetPiece(ItemId.ZAMORAK_FULL_HELM, ItemId.ZAMORAK_PLATEBODY, ItemId.ZAMORAK_PLATELEGS, ItemId.ZAMORAK_PLATESKIRT, ItemId.ZAMORAK_KITESHIELD)),
    SARADOMIN_RUNE_ARMOUR(ItemId.SARADOMIN_PLATE, new StorableSetPiece(ItemId.SARADOMIN_FULL_HELM, ItemId.SARADOMIN_PLATEBODY, ItemId.SARADOMIN_PLATELEGS, ItemId.SARADOMIN_PLATESKIRT, ItemId.SARADOMIN_KITESHIELD)),
    GUTHIX_RUNE_ARMOUR(ItemId.GUTHIX_PLATEBODY_10780, new StorableSetPiece(ItemId.GUTHIX_FULL_HELM, ItemId.GUTHIX_PLATEBODY, ItemId.GUTHIX_PLATELEGS, ItemId.GUTHIX_PLATESKIRT, ItemId.GUTHIX_KITESHIELD)),
    GOLD_PLATED_RUNE_ARMOUR(ItemId.GILDED_PLATEBODY_10782, new StorableSetPiece(ItemId.GILDED_FULL_HELM, ItemId.GILDED_PLATEBODY, ItemId.GILDED_PLATELEGS, ItemId.GILDED_PLATESKIRT, ItemId.GILDED_KITESHIELD)),
    ...
    SARADOMIN_VESTMENTS(ItemId.SARADOMIN_ROBE_TOP_10784, new StorableSetPiece(ItemId.SARADOMIN_MITRE, ItemId.SARADOMIN_ROBE_TOP, ItemId.SARADOMIN_ROBE_LEGS, ItemId.SARADOMIN_CLOAK, ItemId.SARADOMIN_CROZIER, ItemId.SARADOMIN_STOLE)),
    GUTHIX_VESTMENTS(ItemId.GUTHIX_ROBE_TOP_10788, new StorableSetPiece(ItemId.GUTHIX_MITRE, ItemId.GUTHIX_ROBE_TOP, ItemId.GUTHIX_ROBE_LEGS, ItemId.GUTHIX_CLOAK, ItemId.GUTHIX_CROZIER, ItemId.GUTHIX_STOLE)),
    ZAMORAK_VESTMENTS(ItemId.ZAMORAK_ROBE_TOP_10786, new StorableSetPiece(ItemId.ZAMORAK_MITRE, ItemId.ZAMORAK_ROBE_TOP, ItemId.ZAMORAK_ROBE_LEGS, ItemId.ZAMORAK_CLOAK, ItemId.ZAMORAK_CROZIER, ItemId.ZAMORAK_STOLE)),
    SARADOMIN_BLESSED_DRAGONHIDE(ItemId.SARADOMIN_DHIDE_10792, new StorableSetPiece(ItemId.SARADOMIN_COIF, ItemId.SARADOMIN_DHIDE, ItemId.SARADOMIN_CHAPS, ItemId.SARADOMIN_BRACERS)),
    GUTHIX_BLESSED_DRAGONHIDE(ItemId.GUTHIX_DRAGONHIDE, new StorableSetPiece(ItemId.GUTHIX_COIF, ItemId.GUTHIX_DHIDE, ItemId.GUTHIX_CHAPS, ItemId.GUTHIX_BRACERS)),
    ZAMORAK_BLESSED_DRAGONHIDE(ItemId.ZAMORAK_DHIDE_10790, new StorableSetPiece(ItemId.ZAMORAK_COIF, ItemId.ZAMORAK_DHIDE, ItemId.ZAMORAK_CHAPS, ItemId.ZAMORAK_BRACERS)),
    CAVALIER_MASK(ItemId.CAVALIER_MASK, new StorableSetPiece(ItemId.CAVALIER_MASK_11280)),
    RED_DRAGONHIDE_GOLD(ItemId.RED_DHIDE_BODY_G, new StorableSetPiece(ItemId.RED_DHIDE_BODY_G, ItemId.RED_DHIDE_CHAPS_G)),
    RED_DRAGONHIDE_TRIM(ItemId.RED_DHIDE_BODY_T, new StorableSetPiece(ItemId.RED_DHIDE_BODY_T, ItemId.RED_DHIDE_CHAPS_T)),
    ...
    ARMADYL_RUNE_ARMOUR(ItemId.ARMADYL_PLATEBODY, new StorableSetPiece(ItemId.ARMADYL_FULL_HELM, ItemId.ARMADYL_PLATEBODY, ItemId.ARMADYL_PLATELEGS, ItemId.ARMADYL_PLATESKIRT, ItemId.ARMADYL_KITESHIELD)),
    BANDOS_RUNE_ARMOUR(ItemId.BANDOS_PLATEBODY, new StorableSetPiece(ItemId.BANDOS_FULL_HELM, ItemId.BANDOS_PLATEBODY, ItemId.BANDOS_PLATELEGS, ItemId.BANDOS_PLATESKIRT, ItemId.BANDOS_KITESHIELD)),
    ANCIENT_RUNE_ARMOUR(ItemId.ANCIENT_PLATEBODY, new StorableSetPiece(ItemId.ANCIENT_FULL_HELM, ItemId.ANCIENT_PLATEBODY, ItemId.ANCIENT_PLATELEGS, ItemId.ANCIENT_PLATESKIRT, ItemId.ANCIENT_KITESHIELD)),
    ARMADYL_BLESSED_DRAGONHIDE(ItemId.ARMADYL_DHIDE, new StorableSetPiece(ItemId.ARMADYL_COIF, ItemId.ARMADYL_DHIDE, ItemId.ARMADYL_CHAPS, ItemId.ARMADYL_BRACERS)),
    BANDOS_BLESSED_DRAGONHIDE(ItemId.BANDOS_DHIDE, new StorableSetPiece(ItemId.BANDOS_COIF, ItemId.BANDOS_DHIDE, ItemId.BANDOS_CHAPS, ItemId.BANDOS_BRACERS)),
    ANCIENT_BLESSED_DRAGONHIDE(ItemId.ANCIENT_DHIDE, new StorableSetPiece(ItemId.ANCIENT_COIF, ItemId.ANCIENT_DHIDE, ItemId.ANCIENT_CHAPS, ItemId.ANCIENT_BRACERS)),
    ...
    THIRD_AGE_RANGER_KIT(ItemId._3RD_AGE_RANGE_TOP, new StorableSetPiece(ItemId._3RD_AGE_RANGE_COIF, ItemId._3RD_AGE_RANGE_TOP, ItemId._3RD_AGE_RANGE_LEGS, ItemId._3RD_AGE_VAMBRACES)),
    THIRD_AGE_MAGE_ROBES(ItemId._3RD_AGE_ROBE_TOP, new StorableSetPiece(ItemId._3RD_AGE_MAGE_HAT, ItemId._3RD_AGE_ROBE_TOP, ItemId._3RD_AGE_ROBE, ItemId._3RD_AGE_AMULET)),
    THIRD_AGE_ARMOUR(ItemId._3RD_AGE_PLATEBODY, new StorableSetPiece(ItemId._3RD_AGE_FULL_HELMET, ItemId._3RD_AGE_PLATEBODY, ItemId._3RD_AGE_PLATELEGS, ItemId._3RD_AGE_KITESHIELD)),
    ...
    ROYAL_OUTFIT(ItemId.ROYAL_GOWN_TOP, new StorableSetPiece(ItemId.ROYAL_CROWN, ItemId.ROYAL_GOWN_TOP, ItemId.ROYAL_GOWN_BOTTOM, ItemId.ROYAL_SCEPTRE)),
    ...
    BLACK_DRAGONHIDE_GOLD(ItemId.BLACK_DHIDE_BODY_G, new StorableSetPiece(ItemId.BLACK_DHIDE_BODY_G, ItemId.BLACK_DHIDE_CHAPS_G)),
    BLACK_DRAGONHIDE_TRIM(ItemId.BLACK_DHIDE_BODY_T, new StorableSetPiece(ItemId.BLACK_DHIDE_BODY_T, ItemId.BLACK_DHIDE_CHAPS_T)),
    MUSKETEER_OUTFIT(ItemId.MUSKETEER_TABARD, new StorableSetPiece(ItemId.MUSKETEER_HAT, ItemId.MUSKETEER_TABARD, ItemId.MUSKETEER_PANTS)),
    ...
    DARK_TUXEDO_OUTFIT(ItemId.DARK_BOW_TIE, new StorableSetPiece(ItemId.DARK_TUXEDO_JACKET, ItemId.DARK_TROUSERS, ItemId.DARK_TUXEDO_CUFFS, ItemId.DARK_TUXEDO_SHOES, ItemId.DARK_BOW_TIE)),
    LIGHT_TUXEDO_OUTFIT(ItemId.LIGHT_BOW_TIE, new StorableSetPiece(ItemId.LIGHT_TUXEDO_JACKET, ItemId.LIGHT_TROUSERS, ItemId.LIGHT_TUXEDO_CUFFS, ItemId.LIGHT_TUXEDO_SHOES, ItemId.LIGHT_BOW_TIE)),
    ...
    SAMURAI_OUTFIT(ItemId.SAMURAI_SHIRT, new StorableSetPiece(ItemId.SAMURAI_KASA, ItemId.SAMURAI_SHIRT, ItemId.SAMURAI_GREAVES, ItemId.SAMURAI_GLOVES, ItemId.SAMURAI_BOOTS)),
    MUMMY_OUTFIT(ItemId.MUMMYS_HEAD, new StorableSetPiece(ItemId.MUMMYS_HEAD, ItemId.MUMMYS_BODY, ItemId.MUMMYS_LEGS, ItemId.MUMMYS_HANDS, ItemId.MUMMYS_FEET)),
    ANKOU_OUTFIT(ItemId.ANKOU_MASK, new StorableSetPiece(ItemId.ANKOU_MASK, ItemId.ANKOU_TOP, ItemId.ANKOUS_LEGGINGS, ItemId.ANKOU_GLOVES, ItemId.ANKOU_SOCKS)),
    ROBES_OF_DARKNESS(ItemId.HOOD_OF_DARKNESS, new StorableSetPiece(ItemId.HOOD_OF_DARKNESS, ItemId.ROBE_TOP_OF_DARKNESS, ItemId.ROBE_BOTTOM_OF_DARKNESS, ItemId.GLOVES_OF_DARKNESS, ItemId.BOOTS_OF_DARKNESS)),
    ...
    TEAM_CAPE_X(ItemId.TEAM_CAPE_X, new StorableSetPiece(ItemId.TEAM_CAPE_X)),
    TEAM_CAPE_I(ItemId.TEAM_CAPE_I, new StorableSetPiece(ItemId.TEAM_CAPE_I)),
    TEAM_CAPE_ZERO(ItemId.TEAM_CAPE_ZERO, new StorableSetPiece(ItemId.TEAM_CAPE_ZERO))
    ;
