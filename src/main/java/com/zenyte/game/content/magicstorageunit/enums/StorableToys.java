...
public enum StorableToys implements StorageUnitElement {
    ...
    SKELETON_OUTFIT(ItemId.SKELETON_MASK_10728, new StorableSetPiece(ItemId.SKELETON_MASK, ItemId.SKELETON_SHIRT, ItemId.SKELETON_LEGGINGS, ItemId.SKELETON_GLOVES, ItemId.SKELETON_BOOTS)),
    REINDEER_HAT(ItemId.REINDEER_HAT_10722, new StorableSetPiece(ItemId.REINDEER_HAT)),
    CHICKEN_OUTFIT(ItemId.CHICKEN_HEAD, new StorableSetPiece(ItemId.CHICKEN_HEAD_11021, ItemId.CHICKEN_WINGS_11020, ItemId.CHICKEN_LEGS_11022, ItemId.CHICKEN_FEET_11019)),
    ...
    COW_OUTFIT(ItemId.COW_MASK, new StorableSetPiece(ItemId.COW_MASK, ItemId.COW_TOP, ItemId.COW_TROUSERS, ItemId.COW_SHOES, ItemId.COW_GLOVES)),
    ...
    SANTA_OUTFIT(ItemId.SANTA_MASK, new StorableSetPiece(ItemId.SANTA_MASK, ItemId.SANTA_JACKET, ItemId.SANTA_PANTALOONS, ItemId.SANTA_GLOVES, ItemId.SANTA_BOOTS)),
    ANTISANTA_OUTFIT(ItemId.ANTISANTA_MASK, new StorableSetPiece(ItemId.ANTISANTA_MASK, ItemId.ANTISANTA_JACKET, ItemId.ANTISANTA_PANTALOONS, ItemId.ANTISANTA_GLOVES, ItemId.ANTISANTA_BOOTS)),
    ...
    GRAVEDIGGER_OUTFIT(ItemId.GRAVEDIGGER_MASK, new StorableSetPiece(ItemId.GRAVEDIGGER_MASK, ItemId.GRAVEDIGGER_TOP, ItemId.GRAVEDIGGER_LEGGINGS, ItemId.GRAVEDIGGER_BOOTS, ItemId.GRAVEDIGGER_GLOVES)),
    ...
    BANSHEE_OUTFIT(ItemId.BANSHEE_MASK, new StorableSetPiece(ItemId.BANSHEE_MASK, ItemId.BANSHEE_TOP, ItemId.BANSHEE_ROBE)),
    ...
    SNOW_IMP_COSTUME(ItemId.SNOW_IMP_COSTUME_HEAD_21847, new StorableSetPiece(ItemId.SNOW_IMP_COSTUME_HEAD_21847, ItemId.SNOW_IMP_COSTUME_BODY_21849, ItemId.SNOW_IMP_COSTUME_LEGS_21851, ItemId.SNOW_IMP_COSTUME_GLOVES_21855, ItemId.SNOW_IMP_COSTUME_FEET_21857, ItemId.SNOW_IMP_COSTUME_TAIL_21853)),
    ...
    BIRTHDAY_CAKE_3RD(32232, new StorableSetPiece(32232)),
