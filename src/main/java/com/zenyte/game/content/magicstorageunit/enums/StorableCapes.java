...
public enum StorableCapes implements StorageUnitElement {
    ...
    ATTACK_CAPE(ItemId.ATTACK_CAPE_10639, new StorableSetPiece(ItemId.ATTACK_CAPE, ItemId.ATTACK_CAPET, ItemId.ATTACK_HOOD)),
    DEFENCE_CAPE(ItemId.DEFENCE_CAPE_10641, new StorableSetPiece(ItemId.DEFENCE_CAPE, ItemId.DEFENCE_CAPET, ItemId.DEFENCE_HOOD)),
    STRENGTH_CAPE(ItemId.STRENGTH_CAPE_10640, new StorableSetPiece(ItemId.STRENGTH_CAPE, ItemId.STRENGTH_CAPET, ItemId.STRENGTH_HOOD)),
    HITPOINTS_CAPE(ItemId.HITPOINTS_CAPE_10647, new StorableSetPiece(ItemId.HITPOINTS_CAPE, ItemId.HITPOINTS_CAPET, ItemId.HITPOINTS_HOOD)),
    AGILITY_CAPE(ItemId.AGILITY_CAPE_10648, new StorableSetPiece(ItemId.AGILITY_CAPE, ItemId.AGILITY_CAPET, ItemId.AGILITY_HOOD)),
    COOKING_CAPE(ItemId.COOKING_CAPE_10658, new StorableSetPiece(ItemId.COOKING_CAPE, ItemId.COOKING_CAPET, ItemId.COOKING_HOOD)),
    CONSTRUCTION_CAPE(ItemId.CONSTRUCT_CAPE_10654, new StorableSetPiece(ItemId.CONSTRUCT_CAPE, ItemId.CONSTRUCT_CAPET, ItemId.CONSTRUCT_HOOD)),
    CRAFTING_CAPE(ItemId.CRAFTING_CAPE_10651, new StorableSetPiece(ItemId.CRAFTING_CAPE, ItemId.CRAFTING_CAPET, ItemId.CRAFTING_HOOD)),
    FARMING_CAPE(ItemId.FARMING_CAPE_10661, new StorableSetPiece(ItemId.FARMING_CAPE, ItemId.FARMING_CAPET, ItemId.FARMING_HOOD)),
    FIREMAKING_CAPE(ItemId.FIREMAKING_CAPE_10659, new StorableSetPiece(ItemId.FIREMAKING_CAPE, ItemId.FIREMAKING_CAPET, ItemId.FIREMAKING_HOOD)),
    FISHING_CAPE(ItemId.FISHING_CAPE_10657, new StorableSetPiece(ItemId.FISHING_CAPE, ItemId.FISHING_CAPET, ItemId.FISHING_HOOD)),
    FLETCHING_CAPE(ItemId.FLETCHING_CAPE_10652, new StorableSetPiece(ItemId.FLETCHING_CAPE, ItemId.FLETCHING_CAPET, ItemId.FLETCHING_HOOD)),
    HERBLORE_CAPE(ItemId.HERBLORE_CAPE_10649, new StorableSetPiece(ItemId.HERBLORE_CAPE, ItemId.HERBLORE_CAPET, ItemId.HERBLORE_HOOD)),
    MAGIC_CAPE(ItemId.MAGIC_CAPE_10644, new StorableSetPiece(ItemId.MAGIC_CAPE, ItemId.MAGIC_CAPET, ItemId.MAGIC_HOOD)),
    MINING_CAPE(ItemId.MINING_CAPE_10655, new StorableSetPiece(ItemId.MINING_CAPE, ItemId.MINING_CAPET, ItemId.MINING_HOOD)),
    PRAYER_CAPE(ItemId.PRAYER_CAPE_10643, new StorableSetPiece(ItemId.PRAYER_CAPE, ItemId.PRAYER_CAPET, ItemId.PRAYER_HOOD)),
    RANGING_CAPE(ItemId.RANGING_CAPE_10642, new StorableSetPiece(ItemId.RANGING_CAPE, ItemId.RANGING_CAPET, ItemId.RANGING_HOOD)),
    RUNECRAFT_CAPE(ItemId.RUNECRAFT_CAPE_10645, new StorableSetPiece(ItemId.RUNECRAFT_CAPE, ItemId.RUNECRAFT_CAPET, ItemId.RUNECRAFTING_HOOD)),
    SLAYER_CAPE(ItemId.SLAYER_CAPE_10653, new StorableSetPiece(ItemId.SLAYER_CAPE, ItemId.SLAYER_CAPET, ItemId.SLAYER_HOOD)),
    SMITHING_CAPE(ItemId.SMITHING_CAPE_10656, new StorableSetPiece(ItemId.SMITHING_CAPE, ItemId.SMITHING_CAPET, ItemId.SMITHING_HOOD)),
    THIEVING_CAPE(ItemId.THIEVING_CAPE_10650, new StorableSetPiece(ItemId.THIEVING_CAPE, ItemId.THIEVING_CAPET, ItemId.THIEVING_HOOD)),
    WOODCUTTING_CAPE(ItemId.WOODCUTTING_CAPE_10660, new StorableSetPiece(ItemId.WOODCUTTING_CAPE, ItemId.WOODCUT_CAPET, ItemId.WOODCUTTING_HOOD)),
    HUNTER_CAPE(ItemId.HUNTER_CAPE_10646, new StorableSetPiece(ItemId.HUNTER_CAPE, ItemId.HUNTER_CAPET, ItemId.HUNTER_HOOD)),
    QUEST_POINT_CAPE(ItemId.QUEST_POINT_CAPE_10662, new StorableSetPiece(ItemId.QUEST_POINT_CAPE, ItemId.QUEST_POINT_CAPE_T, ItemId.QUEST_POINT_HOOD)),
    ACHIEVEMENT_DIARY_CAPE(ItemId.ACHIEVEMENT_DIARY_CAPE, new StorableSetPiece(ItemId.ACHIEVEMENT_DIARY_CAPE, ItemId.ACHIEVEMENT_DIARY_CAPE_T, ItemId.ACHIEVEMENT_DIARY_HOOD)),
    MUSIC_CAPE(ItemId.MUSIC_CAPE_13224, new StorableSetPiece(ItemId.MUSIC_CAPE, ItemId.MUSIC_CAPET, ItemId.MUSIC_HOOD)),
    ...
    MAX_CAPE(ItemId.MAX_CAPE_13282, new StorableSetPiece(ItemId.MAX_CAPE_13342, ItemId.MAX_HOOD)),
