...
public class DrewCheckDialogue extends Dialogue {
    ...
    public void buildDialogue() {
        ...
        if (currentBucketsHeld <= 0 && currentBucketsOfSand <= 0) {
            ...
            val bucketOfSandAmountString = currentBucketsOfSand + " bucket" + Utils.plural(currentBucketsOfSand);
            ...
            options(TITLE,
                    new DialogueOption("Yes", () -> player.getDialogueManager().start(new DrewClaimDialogue(player, npc))),
