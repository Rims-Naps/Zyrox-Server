...
public enum BarbarianMix implements Drinkable {
    ...
    ATTACK_MIX(new int[] { 11431, 11429 }, 0, new Boost(Skills.ATTACK, 0.12F, 0)),
    STRENGTH_MIX(new int[] { 11443, 11441 }, 3, new Boost(Skills.STRENGTH, 0.1F, 3)),
    COMBAT_MIX(new int[] { 11447, 11445 }, 6, new Boost(Skills.ATTACK, 0.1F, 3), new Boost(Skills.STRENGTH, 0.1F, 3)),
    DEFENCE_MIX(new int[] { 11459, 11457 }, 6, new Boost(Skills.DEFENCE, 0.1F, 3)),
    AGILITY_MIX(new int[] { 11463, 11461 }, 6, new Boost(Skills.AGILITY, 0, 3)),
    SUPERATTACK_MIX(new int[] { 11471, 11469 }, 6, new Boost(Skills.ATTACK, 0.15F, 5)),
    FISHING_MIX(new int[] { 11479, 11477 }, 2, new Boost(Skills.FISHING, 0, 3)),
    SUPER_STR_MIX(new int[] { 11487, 11485 }, 6, new Boost(Skills.STRENGTH, 0.15F, 5)),
    MAGIC_ESSENCE_MIX(new int[] { 11491, 11489 }, 6, new Boost(Skills.MAGIC, 0, 3)),
    SUPER_DEF_MIX(new int[] { 11499, 11497 }, 6, new Boost(Skills.DEFENCE, 0.15F, 5)),
    RANGING_MIX(new int[] { 11511, 11509 }, 6, new Boost(Skills.RANGED, 0.1F, 4)),
    MAGIC_MIX(new int[] { 11515, 11513 }, 0, new Boost(Skills.MAGIC, 0, 4)) {
        @Override
        public int healedAmount(final Player player) {
            return Utils.random(3, 6);
        }
    },
    HUNTING_MIX(new int[] { 11519, 11517 }, 6, new Boost(Skills.HUNTER, 0, 3)),
    ANTIPOISON_MIX(new int[] { 11435, 11433 }, 3) {
        @Override
    ...
    RESTORE_MIX(new int[] { 11451, 11449 }, 6, Drinkable.getRestorations(0.3F, 10,
            Drinkable.getAllSkillsExcluding(Skills.HITPOINTS, Skills.AGILITY, Skills.PRAYER))),
    ENERGY_MIX(new int[] { 11455, 11453 }, 6) {
        @Override
        public void onConsumption(final Player player) {
            player.getVariables().setRunEnergy(player.getVariables().getRunEnergy() + 10);
        }
    },
    PRAYER_MIX(new int[] { 11467, 11465 }, 6, new Restoration(Skills.PRAYER, 0.25F, 7)),
    ANTIPOISON_SUPERMIX(new int[]{ 11475, 11473 }, 6) {
        @Override
        public void onConsumption(final Player player) {
            player.getToxins().cureToxin(Toxins.ToxinType.POISON);
    ...
    SUPER_RESTORE_MIX(new int[] { 11495, 11493 }, 6, Drinkable.getRestorations(0.25F, 8,
            Drinkable.getAllSkillsExcluding(Skills.HITPOINTS))),
    ANTIDOTE_PLUS_MIX(new int[] { 11503, 11501 }, 2) {
        @Override
        public void onConsumption(final Player player) {
            player.getToxins().cureToxin(Toxins.ToxinType.POISON);
    ...
    ZAMORAK_MIX(new int[] { 11523, 11521 }, 6, new Boost(Skills.ATTACK, 0.2F, 2), new Boost(Skills.STRENGTH,
    ...
    public Item getItem(final int doses) {
        if (doses < 0 || doses > ids.length)
            throw new RuntimeException("The mix " + this + " doesn't support dose " + doses + ".");
        if (doses == 0) {
            return vial;
        }
