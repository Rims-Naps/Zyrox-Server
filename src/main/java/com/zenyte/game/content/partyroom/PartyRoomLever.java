    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        player.getDialogueManager().start(new Dialogue(player) {
            ...
            public void buildDialogue() {
                options(TITLE,
                        new DialogueOption("Balloon Bonanza.", key(100)),
                        new DialogueOption("Nightly Dance.", key(200)),
                        new DialogueOption("No action."));
                ...
                if (player.getInventory().containsItem(ItemId.COINS_995, 1000)) {
                    options("Continue?",
                            new DialogueOption("Yes.", () -> {
                                ...
                                variables.pull();
                                val seconds = TimeUnit.TICKS.toSeconds(variables.getCountdown());
