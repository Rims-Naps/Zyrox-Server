...
public enum WildernessDiary implements Diary {
	...
	RESTORE_PRAYER_POINTS(EASY, true, "Restore some prayer points at the demonic ruins."),
	ENTER_KING_BLACK_DRAGON_LAIR(EASY, "Enter the King Black Dragon's lair."),//done
	...
	ENTER_WILDERNESS_GODWARS_DUNGEON(MEDIUM, "Enter the Wilderness Godwars Dungeon."),
	COMPLETE_AGILITY_COURSE_LAP(MEDIUM, "Complete a lap of the Wilderness Agility course."),//done
	...
	KILL_A_BLOODVELD(MEDIUM, p -> p.inArea(WildernessGodwarsDungeon.class), "Kill a Bloodveld in the Wilderness Godwars Dungeon."),
	SELL_MYSTERIOUS_EMBLEM(MEDIUM, true, "Sell a Mysterious Emblem to the Emblem Trader in Edgeville."),
	SMITH_GOLDEN_HELMET(MEDIUM, true, "Smith a Golden helmet in the Resource Area."),
	OPEN_THE_MUDDY_CHEST(MEDIUM, true, "Open the Muddy Chest in the lava maze."),

	CAST_GOD_SPELL(HARD, "Cast one of the 3 God spells against another player in the", "Wilderness."),//done
	...
	KILL_A_LAVA_DRAGON(HARD, false, 0x1 | 0x2, LAVA_DRAGON_ISLE::inArea, "Kill a Lava Dragon & Bury the bones on Lava Dragon Isle.") {
		@Override
	...
	KILL_CRAZY_ARCHEAOLOGIST(HARD, 0x1 | 0x2 | 0x4, "Kill the Crazy Arc. Chaos Fanatic & Scorpia.") {
		@Override
		public boolean flagging() {
			return true;
		}
	...
	KILL_CALLISTO(ELITE, 0x1 | 0x2 | 0x4, "Kill Callisto, Venenatis & Vet'ion.") {
		@Override
		public boolean flagging() {
			return true;
		}
	},//done
	TELEPORT_TO_GHORROCK(ELITE, NO_PREDICATE, "Teleport to Ghorrock."),//done
	FISH_AND_COOK_DARK_CRAB(ELITE, false, 0x1 | 0x2, WILDERNESS_RESOURCE_AREA::inArea, "Fish and Cook a Dark Crab in the Resource Area.") {
		@Override
		public boolean flagging() {
			return true;
		}
	...
	CUT_AND_BURN_MAGIC_LOGS(ELITE, false, 0x1 | 0x2, WILDERNESS_RESOURCE_AREA::inArea, "Cut and burn some magic logs in the Resource Area.") {
		@Override
		public boolean flagging() {
			return true;
		}
	...
	public DiaryChunk[] chunks() {
		return new DiaryChunk[] { new DiaryChunk(6323, 12, 4507),
                new DiaryChunk(6324, 11, 4508),
                new DiaryChunk(6325, 10, 4509),
                new DiaryChunk(6326, 7, 4510) };
	}
