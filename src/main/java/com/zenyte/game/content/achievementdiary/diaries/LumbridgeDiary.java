...
public enum LumbridgeDiary implements Diary {
	...
	CHOP_AND_BURN_LOGS(EASY, 0x1 | 0x2, "Chop and burn some oak logs in Lumbridge.") {
		@Override
	...
	CRAFT_AMULET_OF_POWER(HARD, 0x1 | 0x2 | 0x4, "Craft, string and enchant an Amulet of Power in", "Lumbridge.") {
		@Override
		public boolean flagging() {
			return true;
		}
	...
	PERFORM_QUEST_CAPE_EMOTE(ELITE, true, WISE_OLD_MAN_HOUSE::inArea, "Perform the Quest cape emote in the Wise Old Man's", "house.");//Done but disabled cus cape unobtainable.
