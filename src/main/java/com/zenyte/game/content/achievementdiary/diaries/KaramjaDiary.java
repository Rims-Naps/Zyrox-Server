...
public enum KaramjaDiary implements Diary {
	...
	USE_ROPE_SWING(EASY, true, "Use the rope swing to travel to the small island north-west", "of Karamja, where the moss giants are."),
	...
	CHECK_CALQUAT_HEALTH(ELITE, "Check the health of your Calquat tree patch.");//done
	...
	public DiaryChunk[] chunks() {
		return new DiaryChunk[] { new DiaryChunk(2423, 10, 3577), new DiaryChunk(6288, 19, 3598), new DiaryChunk(6289, 10, 3610), new DiaryChunk(6290, 5, 4567) };
	}
