...
public enum WesternProvincesDiary implements Diary {
    ...
    CHOP_AND_BURN_TEAK_LOGS(MEDIUM, false, 0x1 | 0x2, p -> p.inArea("Ape Atoll"), "Chop and burn some teak logs on Ape Atoll.") {
        @Override
    ...
    CHOP_AND_BURN_MAHOGANY_LOGS(HARD, false, 0x1 | 0x2, p -> p.inArea("Ape Atoll"), "Chop and burn some Mahogany logs on Ape Atoll.") {
        @Override
        public boolean flagging() {
            return true;
        }
    ...
    PICKPOCKET_ELF(ELITE, NO_PREDICATE, "Pickpocket an Elf.");//done
