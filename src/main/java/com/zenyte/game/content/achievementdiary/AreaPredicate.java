...
public enum AreaPredicate {
    ...
    FORSAKEN_TOWER(new RSPolygon(new int[][] { { 1366, 3840 },
            { 1363, 3812 },
            { 1397, 3808 },
            { 1401, 3838 }})),
    LOVAKENGJ_PUB(new RSPolygon(new int[][] { { 1561, 3767 },
            { 1561, 3756 },
            { 1564, 3756 },
            { 1564, 3751 },
            { 1571, 3751 },
            ...
            { 1571, 3762 },
            { 1571, 3767 }})),
    MOUNT_KARUULM_MINE(new RSPolygon(new int[][] { { 1277, 3820 },
            { 1281, 3820 },
            { 1286, 3815 },
            { 1281, 3805 },
            { 1272, 3812 }})),
    ...
    KEBOS_TERRITORY(new RSPolygon(new int[][]{
            { 1152, 4096 },
            { 1152, 3392 },
            { 1920, 3392 },
            { 1920, 4096 }
