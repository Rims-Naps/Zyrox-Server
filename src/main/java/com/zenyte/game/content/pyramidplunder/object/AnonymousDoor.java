...
public class AnonymousDoor implements ObjectAction {
    ...
    public Object[] getObjects() {
        return new Object[]{PyramidPlunderConstants.ANONYMOUS_DOOR_NORTH, PyramidPlunderConstants.ANONYMOUS_DOOR_EAST,
                PyramidPlunderConstants.ANONYMOUS_DOOR_SOUTH, PyramidPlunderConstants.ANONYMOUS_DOOR_WEST};
    }
        ...
        public int processWithDelay() {
            switch (cycle++) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    val isCorrectDoor = door.getId() == 26622 + currentDoorOffset;
                    player.sendFilteredMessage("You find a door! " + (isCorrectDoor ? "You open it successfully." :
                            "You open it."));
                    if (isCorrectDoor) {
