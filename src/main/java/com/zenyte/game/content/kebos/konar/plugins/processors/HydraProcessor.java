...
public class HydraProcessor extends DropProcessor {
    ...
    public void attach() {
        ...
        put(8609, ItemId.DRAGON_THROWNAXE, new DropProcessor.PredicatedDrop("This drop becomes 5 times more common during a slayer assignment."));
        put(8609, ItemId.DRAGON_KNIFE, new DropProcessor.PredicatedDrop("This drop becomes 5 times more common during a slayer assignment."));
        put(8609, ItemId.HYDRAS_EYE, new DropProcessor.PredicatedDrop("This drop becomes 5 times more common during a slayer assignment."));
        put(8609, ItemId.HYDRAS_FANG, new DropProcessor.PredicatedDrop("This drop becomes 5 times more common during a slayer assignment."));
        put(8609, ItemId.HYDRAS_HEART, new DropProcessor.PredicatedDrop("This drop becomes 5 times more common during a slayer assignment."));
        put(8609, ItemId.HYDRA_TAIL, new DropProcessor.PredicatedDrop("This drop becomes 5 times more common during a slayer assignment."));
    }

    @Override
    public Item drop(final NPC npc, final Player killer, final Drop drop, final Item item) {
        if (!drop.isAlways()) {
            var rate = killer.getSlayer().isCurrentAssignment(npc) ? 1500 : 7500;
            if (random(rate) == 0) {
