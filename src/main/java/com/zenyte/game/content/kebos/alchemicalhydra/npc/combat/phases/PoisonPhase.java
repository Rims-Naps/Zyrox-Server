...
public class PoisonPhase implements HydraPhaseSequence {
    ...
    public static final Map<Direction, Graphics> directionMap = ImmutableMap.<Direction, Graphics>builder()
            .put(Direction.NORTH, new Graphics(1659))
            .put(Direction.NORTH_EAST, new Graphics(1660))
            .put(Direction.EAST, new Graphics(1661))
            .put(Direction.SOUTH_EAST, new Graphics(1655))
            .put(Direction.SOUTH, new Graphics(1655))
            .put(Direction.SOUTH_WEST, new Graphics(1656))
            .put(Direction.WEST, new Graphics(1657))
            .put(Direction.NORTH_WEST, new Graphics(1658))
            .build();
    ...
    public boolean attack(final AlchemicalHydra hydra, final Player player) {
        if (attacks == 3 && !initialSpecial || attacks == 9) {
            ...
            for (val tile : tiles) {
                ...
                val graphics = directionMap.get(directionConstant);
    ...
    public int getHitpointsThreshold(final AlchemicalHydra hydra) {
        return (int) (hydra.getMaxHitpoints() * 0.75F);
    }
}
