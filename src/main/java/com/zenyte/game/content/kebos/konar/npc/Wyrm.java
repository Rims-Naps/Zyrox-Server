...
public class Wyrm extends NPC implements CombatScript, Spawnable {
    ...
    private static final int IDLE_STATE_NPC_ID = NpcId.WYRM;
    private static final int ATTACK_STATE_NPC_ID = NpcId.WYRM_8611;
    ...
    public boolean validate(int id, String name) {
        return id == NpcId.WYRM || id == NpcId.WYRM_8611;
    }
}
