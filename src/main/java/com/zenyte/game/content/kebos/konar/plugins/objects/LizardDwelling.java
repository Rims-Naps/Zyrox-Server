...
public class LizardDwelling implements ObjectAction {
    ...
    public static final Map<Integer, Location> destinationMap = ImmutableMap.<Integer, Location>builder()
            .put(34402,new Location(1292, 10058, 0))
            .put(34403, new Location(1314, 10064, 0))
            .put(34404, new Location(1330, 10070, 0))
            .put(34405, new Location(1312, 10086, 0))
            .put(34422, new Location(1292, 3676, 0))
            .build();

    @Override
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        val strangeHole = object.getId() == 34422;
        player.lock();
        ...
        new FadeScreen(player, () -> {
            val destination = destinationMap.get(object.getId());
            player.unlock();
