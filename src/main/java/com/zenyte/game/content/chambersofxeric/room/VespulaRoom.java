...
public final class VespulaRoom extends RaidArea implements PlayerCombatPlugin {
     ...
     */
    private static final Location[][] luxGrubs = new Location[][]{
            new Location[]{
                    new Location(3287, 5289, 2), new Location(3285, 5294, 2), new Location(3277, 5286, 2),
                    new Location(3278, 5294, 2)
            },
            new Location[]{
                    new Location(3312, 5289, 2), new Location(3304, 5291, 2), new Location(3312, 5297, 2),
                    new Location(3304, 5297, 2)
            },
            new Location[]{
                    new Location(3344, 5294, 2), new Location(3337, 5286, 2), new Location(3337, 5294, 2),
                    new Location(3334, 5290, 2)
            }
    };
     ...
     */
    private static final Location[][] vespineSoldiers = new Location[][]{
            new Location[]{
                    new Location(3284, 5289, 2), new Location(3285, 5291, 2), new Location(3277, 5289, 2),
                    new Location(3278, 5291, 2)
            },
            new Location[]{
                    new Location(3309, 5289, 2), new Location(3307, 5291, 2), new Location(3309, 5297, 2),
                    new Location(3307, 5297, 2)
            },
            new Location[]{
                    new Location(3344, 5291, 2), new Location(3337, 5289, 2), new Location(3337, 5291, 2),
                    new Location(3337, 5290, 2)
            }
    };
     ...
     */
    private static final Location[][] boilLocations = new Location[][]{
            new Location[]{new Location(3267, 5295, 2), new Location(3267, 5296, 2)},
            new Location[]{new Location(3311, 5308, 2), new Location(3312, 5308, 2)},
            new Location[]{new Location(3356, 5296, 2), new Location(3356, 5295, 2)}
    };

    /**
     * The locations on which the septic tendrils spawn.
     */
    private static final Location[][] tendrilLocations = new Location[][]{
            new Location[]{new Location(3279, 5280, 2), new Location(3280, 5280, 2)},
            new Location[]{new Location(3311, 5280, 2), new Location(3312, 5280, 2)},
            new Location[]{new Location(3343, 5280, 2), new Location(3344, 5280, 2)}
    };

    /**
     * The tiles on which the abyssal portal spawns.
     */
    private static final Location[] portalLocations = new Location[]{
            new Location(3281, 5300, 2),
            new Location(3318, 5291, 2),
            new Location(3339, 5300, 2),
    };

    /**
     * The tiles on which Vespula spawns.
     */
    private static final Location[] vespulaLocations = new Location[]{
            new Location(3281, 5290, 2),
            new Location(3308, 5292, 2),
            new Location(3341, 5290, 2),
    };

    /**
     * The start locations of where portal's projectile attack starts from.
     */
    private static final Location[] portalProjectileStartLocations = new Location[]{
            new Location(3282, 5302, 2),
            new Location(3320, 5292, 2),
            new Location(3341, 5302, 2),
    };

    /**
     * The tiles which are damaged by the portal's projectile attack.
     */
    private static final Location[][] portalHitTiles = new Location[][]{
            new Location[]{
                    new Location(3281, 5293, 2), new Location(3282, 5293, 2)
            },
            new Location[]{
                    new Location(3311, 5293, 2), new Location(3311, 5292, 2)
            },
            new Location[]{
                    new Location(3340, 5293, 2), new Location(3341, 5293, 2)
            }
    };
    ...
    public VespulaRoom(final RaidRoom type, final Raid raid, final int rotation, final int size, final int regionX, final int regionY,
    ...
    public void loadRoom() {
        ...
        val array = portalHitTiles[index];
        for (val tile : array) {
    ...
    public void load() {
        ...
        loaded = true;
        for (int i = 0; i < 4; i++) {
            val spawnTile = getLocation(luxGrubs[index][i]).transform(-1, -1, 0);
            val soldierTile = getLocation(vespineSoldiers[index][i]).transform(-1, -1, 0);
            val grub = new LuxGrub(raid, this, spawnTile, soldierTile);
            grub.spawn();
            val faceLocation = getLocation(vespineSoldiers[index][i]);
            grub.setFaceLocation(faceLocation);
            grubs.add(grub);
        }
        for (int i = 0; i < 2; i++) {
            val object = new WorldObject(30070, 10, 0, this.getLocation(boilLocations[index][i]));
            boils.add(object);
        ...
        for (val root : originalMedivaemiaRoots) {
            val newRoot = new WorldObject(root);
            newRoot.setId(30068);
    ...
    public void spawnTendrils() {
        ...
        for (int i = 0; i < 2; i++) {
            val object = new WorldObject(30024, 10, 0, this.getLocation(tendrilLocations[index][i]));
            tendrils.add(object);
            World.spawnObject(object);
        }
    }
    ...
    public void clear() {
        ...
        WorldTasksManager.schedule(() -> {
            for (val boil : boils) {
                val burstBoil = new WorldObject(boil);
                burstBoil.setId(30071);
                World.spawnObject(burstBoil);
            }
            for (val tendril : tendrils) {
