...
public final class TektonRoom extends RaidArea implements CycleProcessPlugin, PlayerCombatPlugin {
     ...
     */
    private static final Location[] anvilTiles = new Location[]{
            new Location(3279, 5298, 1), new Location(3307, 5294, 1),
            new Location(3341, 5298, 1)
    };

    /**
     * A 2D array containing coordinates to all of the smoke pillars.
     */
    private static final Location[][] smokePillarTiles = new Location[][]{
            new Location[]{
                    new Location(3286, 5289, 1), new Location(3275, 5288, 1), new Location(3275, 5301, 1),
                    new Location(3286, 5301, 1), new Location(3287, 5296, 1)
            },
            new Location[]{
                    new Location(3318, 5288, 1), new Location(3307, 5288, 1), new Location(3308, 5301, 1),
                    new Location(3319, 5300, 1)
            },
            new Location[]{
                    new Location(3348, 5289, 1), new Location(3340, 5287, 1), new Location(3336, 5291, 1),
                    new Location(3337, 5301, 1), new Location(3349, 5300, 1)
            }
    };
     ...
     */
    private static final Location[] blockingCrystalTiles = new Location[]{
            new Location(3270, 5294, 1), new Location(3310, 5304, 1),
            new Location(3352, 5296, 1)
    };

    /**
     * A 2D array containing coordinates to where the sparks fly from.
     */
    private static final Location[][] sparkTiles = new Location[][]{
            new Location[]{
                    new Location(3273, 5288, 1), new Location(3273, 5302, 1), new Location(3280, 5305, 1),
                    new Location(3289, 5303, 1), new Location(3288, 5289, 1)
            },
            new Location[]{
                    new Location(3320, 5289, 1), new Location(3321, 5303, 1), new Location(3317, 5302, 1),
                    new Location(3303, 5295, 1), new Location(3305, 5288, 1), new Location(3305, 5301, 1)
            },
            new Location[]{
                    new Location(3350, 5289, 1), new Location(3334, 5288, 1), new Location(3335, 5302, 1),
                    new Location(3343, 5304, 1), new Location(3350, 5303, 1)
            }
    };
     ...
     */
    private static final Location[] fireTiles = new Location[]{
            new Location(3279, 5281, 1), new Location(3311, 5281, 1),
            new Location(3343, 5281, 1)
    };

    /**
     * A 2D array containing coordinates to the tiles which are safe from sparks.
     */
    private static final Location[] safeTiles = new Location[]{
            new Location(3280, 5280, 1), new Location(3312, 5280, 1),
            new Location(3344, 5280, 1)
    };
    ...
    public TektonRoom(final RaidRoom type, final Raid raid, final int rotation, final int size, final int regionX, final int regionY,
   ...
   /* @Override
        ...
        for (val p : players) {
            for (final Location t : smokePillars) {
                if (p.getLocation().withinDistance(t, 1)) {
                    ...
                    p.putBooleanAttribute("has_taken_damage_from_tekton", true);
                }
            }
        }
    }
    ...
    public void loadRoom() {
        ...
        tekton = new Tekton(raid, Direction.mainDirections[((index == 1 ? 1 : 2) + getRotation()) & 0x3], this,
                getNPCLocation(anvilTiles[index], 6));
        tekton.spawn();
