...
public final class DarkAltarRoom extends RaidArea {
    ...
    private static final Location[][] spawnLocations = new Location[][]{
            new Location[]{
                    new Location(3278, 5261, 1), new Location(3286, 5265, 1), new Location(3284, 5271, 1), new Location(3277, 5273, 1), new Location(3273, 5265, 1),
                    new Location(3278, 5270, 1)
            },
            new Location[]{
                    new Location(3315, 5262, 1), new Location(3318, 5259, 1), new Location(3309, 5258, 1), new Location(3301, 5256, 1), new Location(3306, 5264, 1),
                    new Location(3312, 5259, 1)
            },
            new Location[]{
                    new Location(3342, 5262, 1), new Location(3342, 5266, 1), new Location(3340, 5268, 1), new Location(3338, 5274, 1), new Location(3337, 5268, 1),
    ...
    private static final Location[] markOfPowerLocations = new Location[]{
            new Location(3270, 5264, 1), new Location(3309, 5272, 1), new Location(3348, 5268, 1)
    };
    /**
    ...
    public void loadRoom() {
        val tiles = new ObjectArrayList<>(Arrays.asList(spawnLocations[index]));
        val size = raid.getOriginalPlayers().size();
        val count = size < 3 ? 3 : size < 5 ? 4 : size < 8 ? 5 : 6;
        ...
        for (val t : tiles) {
            npcs.add((SkeletalMystic) new SkeletalMystic(raid, this, Utils.random(NpcId.SKELETAL_MYSTIC, NpcId.SKELETAL_MYSTIC_7606), getLocation(t)).spawn());
        }
