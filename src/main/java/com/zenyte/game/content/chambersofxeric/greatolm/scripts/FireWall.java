...
public final class FireWall implements OlmCombatScript {
	...
	private static final Projectile[] projectiles = new Projectile[] {
			new Projectile(1348, 10, 10, 0, 27, 30, 0, 0),
			new Projectile(1348, 10, 10, 0, 24, 30, 0, 0),
			new Projectile(1348, 10, 10, 0, 21, 30, 0, 0),
			new Projectile(1348, 10, 10, 0, 18, 30, 0, 0),
			new Projectile(1348, 10, 10, 0, 15, 30, 0, 0),
			new Projectile(1348, 10, 10, 0, 12, 30, 0, 0),
			new Projectile(1348, 10, 10, 0, 9, 30, 0, 0),
			new Projectile(1348, 10, 10, 0, 6, 30, 0, 0),
			new Projectile(1348, 10, 10, 0, 3, 30, 0, 0),
			new Projectile(1348, 10, 10, 0, 0, 30, 0, 0)
	};
	...
	private void checkPlayers(final int hash, final boolean north, final List<Player> everyone) {
		for (final Player player : everyone) {
			if (player.getLocation().getPositionHash() == hash) {
				...
				val tile = player.getLocation().transform(north ? Direction.NORTH : Direction.SOUTH, 1);
