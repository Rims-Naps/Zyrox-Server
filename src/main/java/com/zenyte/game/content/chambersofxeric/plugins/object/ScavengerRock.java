            ...
            if (option.equalsIgnoreCase("Mine")) {
                ...
                player.getActionManager().setAction(new Action() {
                    ...
                    public boolean start() {
                        val optionalAxe = MiningDefinitions.PickaxeDefinitions.get(player, true);
                        ...
                        if (blockingObject.getLevelRequired() > player.getSkills().getLevel(Skills.MINING)) {
                        ...
                        delay(tool.getDefinitions().getMineTime());
                        return true;
                    }

                    @Override
                    public boolean process() {
                        if (ticks++ % 4 == 0) player.setAnimation(tool.getDefinitions().getAnim());
                    ...
                    public int processWithDelay() {
                        ...
                        return tool.getDefinitions().getMineTime();
                    }
