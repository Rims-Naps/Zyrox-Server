...
public class ScavengerBlockingObstacleRemnants implements ObjectAction {
    ...
    public static final void cross(@NotNull final Player player, @NotNull final WorldObject object) {
        player.lock(3);
        val offsetX = object.getX() - player.getX();
        val offsetY = object.getY() - player.getY();
        val destination = new Location(object.getX() + offsetX, object.getY() + offsetY, object.getPlane());
    ...
    public Object[] getObjects() {
        return new Object[] {
                LargeScavengerRoom.RUBBLE, LargeScavengerRoom.STUB
        };
    }
}
