...
public final class DeathlyRoom extends RaidArea {
     ...
     */
    public static final ForceTalk[] forceChats = new ForceTalk[]{
            new ForceTalk("Intruder!"), new ForceTalk("Stop them at all costs!"),
            new ForceTalk("Protect the keystone!")
    };
    /**
     ...
     */
    private static final Location[][] mageSpawnLocations = new Location[][]{
            new Location[]{new Location(3285, 5363, 1), new Location(3287, 5363, 1)},
            new Location[]{new Location(3317, 5363, 1), new Location(3319, 5363, 1)},
            new Location[]{new Location(3340, 5365, 1), new Location(3340, 5367, 1)}
    };
    /**
     * A 2D array defining the locations of the deathly rangers who protect the keystone.
     */
    private static final Location[][] rangerSpawnLocations = new Location[][]{
            new Location[]{new Location(3284, 5370, 1), new Location(3286, 5370, 1)},
            new Location[]{new Location(3316, 5370, 1), new Location(3318, 5370, 1)},
            new Location[]{new Location(3333, 5364, 1), new Location(3333, 5366, 1)}
    };
    /**
     * A array containing the barrier objects and their locations.
     */
    private static final WorldObject[] barrierLocations = new WorldObject[]{
            new WorldObject(29749, 10, 0, 3270, 5360, 1),
            new WorldObject(29749, 10, 1, 3309, 5368, 1),
            new WorldObject(29749, 10, 2, 3355, 5360, 1)
    };
    /**
    ...
    public void loadRoom() {
        val amount = raid.getOriginalPlayers().size();
        val rangersAmount = amount >= 7 ? 4 : amount >= 4 ? 3 : 2;
        val magersAmount = amount > 9 ? 4 : amount >= 4 ? 3 : 2;
        val mages = mageSpawnLocations[index];
        val rangers = rangerSpawnLocations[index];
        ...
        val barrier = barrierLocations[index];
        World.spawnObject(this.barrier = new WorldObject(barrier.getId(), barrier.getType(), (barrier.getRotation() + getRotation()) & 0x3, getObjectLocation(barrier, 1, 2, (barrier.getRotation() + getRotation()) & 0x3)));
