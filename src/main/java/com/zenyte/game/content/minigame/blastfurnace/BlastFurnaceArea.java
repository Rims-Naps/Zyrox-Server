...
public class BlastFurnaceArea extends Area implements CannonRestrictionPlugin, LayableTrapRestrictionPlugin, CycleProcessPlugin {
    ...
    public void process() {
        ...
        for(final Player player : getPlayers()) {
            ...
            val removalAmt = player.getSkills().getLevel(Skills.SMITHING) >= 60 ? 12 : 15;
            val coffer = player.getBlastFurnace().getCoffer();
    ...
    public RSPolygon[] polygons() {
        return new RSPolygon[] {
           new RSPolygon(new int[][] { {1934, 4976}, {1959, 4976}, {1959, 4955}, {1934, 4955} }, 0)
        };
    }
