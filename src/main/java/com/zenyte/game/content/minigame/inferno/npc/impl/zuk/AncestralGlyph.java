...
public class AncestralGlyph extends InfernoNPC {
    ...
    private Location west, east;

    public AncestralGlyph(final Inferno inferno) {
        super(NpcId.ANCESTRAL_GLYPH, inferno.getLocation(spawnLocation), inferno);
                ...
                public void run() {
                    ...
                    if (!hasWalkSteps()) {
                        ...
                        if (movementLock == 0) {
                            ...
                            if (!first) {
                                val firstDir = Utils.random(1) == 0 ? west : east;
