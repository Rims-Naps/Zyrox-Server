...
import com.zenyte.game.content.minigame.pestcontrol.npc.DefilerNPC;
import com.zenyte.game.content.minigame.pestcontrol.npc.RavagerNPC;
import com.zenyte.game.content.minigame.pestcontrol.npc.ShifterNPC;
import com.zenyte.game.content.minigame.pestcontrol.npc.SpinnerNPC;
import com.zenyte.game.content.minigame.pestcontrol.npc.SplatterNPC;
import com.zenyte.game.content.minigame.pestcontrol.npc.TorcherNPC;
...
public enum PestNPCTable {
	...
	@Getter private final Class<? extends PestNPC> npcClass;
	@Getter private final int[] noviceIds, intermediateIds, veteranIds;
