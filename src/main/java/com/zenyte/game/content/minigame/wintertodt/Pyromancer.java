...
public class Pyromancer extends NPC {
    ...
    private static final String[] incapacitatedPhrases = new String[]{"Mummy!",
            "My flame burns low.",
            "We are doomed.",
            "I think I'm dying.",
            "Ugh, help me!"};
    ...
    private void randomActions() {
        ...
        val brazier = Wintertodt.Corner.getFromPyromancer(this).getBrazier();
    ...
    @Getter
    public enum State {
        HEALTHY(NpcId.PYROMANCER),
        INCAPACITATED(NpcId.INCAPACITATED_PYROMANCER);
    ...
    public static final class PotionOnPyromancer implements ItemOnNPCAction {
        ...
        public void handleItemOnNPCAction(final Player player, final Item item, final int slot, final NPC npc) {
            ...
            if (!pyromancer.isHealthy()) {
                ...
                if (!player.getBooleanAttribute("easy-combat-achievement18")) {
                    player.putBooleanAttribute("easy-combat-achievement18", true);
                    EasyTasks.sendEasyCompletion(player, 18);
                }
            } else {
                pyromancer.heal(8);
            }
