...
public class MagicalWheatObject implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        if (option.equals("Push-through")) {
            val newLocation = object.getPosition().transform(object.getX() - player.getX(), object.getY() - player.getY(), 0);
            ...
            val animation = Utils.getRandomCollectionElement(animations.int2ObjectEntrySet());
            val pushAnimation = new Animation(animation.getIntKey());
            ...
            player.setForceMovement(new ForceMovement(currentTile, 1, newLocation, pushAnimation.getDuration() / 20,
                    Utils.getFaceDirection(newLocation.getX() - currentTile.getX(), newLocation.getY() - currentTile.getY())));
        }
    }
    ...
    public Object[] getObjects() {
        return new Object[]{
                PuroPuroArea.MagicalWheatSpawn.SPAWNED_WHEAT,
                PuroPuroArea.MagicalWheatSpawn.REGULAR_WHEAT_PERP,
                PuroPuroArea.MagicalWheatSpawn.REGULAR_WHEAT,
                25017,
                25029
        };
    }
