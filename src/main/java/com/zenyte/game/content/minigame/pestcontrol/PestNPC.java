...
public abstract class PestNPC extends NPC {
	...
	public List<Entity> getPossibleTargets(final EntityType type) {
	    val knight = instance.getVoidKnight();
        if (getLocation().withinDistance(knight, aggressionDistance) && !ProjectileUtils.isProjectileClipped(null, null, this,
                knight, combatDefinitions.isMelee())) {
