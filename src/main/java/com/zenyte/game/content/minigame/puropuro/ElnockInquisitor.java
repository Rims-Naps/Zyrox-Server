...
public class ElnockInquisitor extends NPCPlugin {
    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> {
            val receivedStarterEquipment = player.getAttributeOrDefault(ELNOCK_EQUIPMENT_ATTRIBUTE, false);
            ...
            if (receivedStarterEquipment) {
                player.getDialogueManager().start(new Dialogue(player, npc) {
                    ...
                    public void buildDialogue() {
                        ...
                        val overlayEnabled = player.getAttributeOrDefault(PuroPuroImplingOverlay.PURO_PURO_OVERLAY_ATTRIBUTE, false);
                        
                        options(TITLE,
                                new DialogueOption("Can you remind me how to catch implings again?", key(10)),
                                new DialogueOption("Can I trade some jarred implings please?", key(20)),
                                new DialogueOption("Do you have some spare equipment I can use?", key(30)),
                                overlayEnabled ?
                                        new DialogueOption("Can you stop tracking how many implings I've already jarred?", key(40))
                                        :
                                        new DialogueOption("Can you help me keep track of the implings I've already jarred?", key(50))
                        );
                        ...
                        {
                            player(20, "Can I trade some jarred implings please?")
                                    .executeAction(() -> GameInterface.ELNOCKS_EXCHANGE.open(player));
                        }
                        ...
                        {
                            player(40, "Can you stop tracking how many implings I've already jarred?")
                                    .executeAction(() -> {
                        ...
                        {
                            player(50, "Can you help me keep track of the implings I've already jarred?")
                                    .executeAction(() -> {
                ...
                player.getDialogueManager().start(new Dialogue(player, npc) {
                    ...
                    public void buildDialogue() {
                        ...
                        options(TITLE,
                                new DialogueOption("Where is this place?", key(10)),
                                new DialogueOption("So what are these implings?", key(40)),
                                new DialogueOption("Can I catch these implings then?", key(60)),
                                new DialogueOption("I've heard I may find dragon equipment in Puro-Puro.", key(80))
                        );
                        ...
                        
                        {
                            ...
                            options(TITLE,
                                    new DialogueOption("Tell me more about these jars.", key(100)),
                                    new DialogueOption("Tell me more about these thieving imps.", key(120)),
                                    new DialogueOption("So what's this equipment you can give me then?", key(140)),
                                    new DialogueOption("Do you have some spare equipment I can use?", key(160))
                            );
