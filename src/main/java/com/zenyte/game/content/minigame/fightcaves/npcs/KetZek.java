...
final class KetZek extends FightCavesNPC implements CombatScript {
    ...
    public int attack(Entity target) {
        ...
        if (style == 0 && isWithinMeleeDistance(this, target)) {
            ...
            delayHit(World.sendProjectile(this, target, MAGIC_PROJ), target,
                    new Hit(this, getRandomMaxHit(this, 49, MAGIC, target), HitType.MAGIC).onLand(hit -> target.setGraphics(GFX)));
        }
