...
public enum SymbolOfLife {
    NORTH_EAST("Feather of chicken and eye of newt", DiaryReward.ARDOUGNE_CLOAK2, 3058, 4410, NpcId.NEWTROOST, ItemId.EYE_OF_NEWT, ItemId.FEATHER),
    NORTH_WEST("Horn of unicorn and hide of cow", DiaryReward.ARDOUGNE_CLOAK2, 3018, 4410, NpcId.UNICOW, ItemId.UNICORN_HORN, ItemId.COWHIDE),
    SOUTH_EAST("Red spiders' eggs and a sardine raw", DiaryReward.ARDOUGNE_CLOAK2, 3043, 4361, NpcId.SPIDINE, ItemId.RED_SPIDERS_EGGS, ItemId.RAW_SARDINE),
    SOUTH_WEST("Swordfish raw and chicken uncooked", null, 3034, 4361, NpcId.SWORDCHICK, ItemId.RAW_SWORDFISH, ItemId.RAW_CHICKEN),
    EAST("Raw meat of jubbly bird and a lobster raw", DiaryReward.ARDOUGNE_CLOAK1, 3066, 4380, NpcId.JUBSTER, ItemId.RAW_JUBBLY, ItemId.RAW_LOBSTER),
    WEST("Legs of giant frog and a cave eel uncooked", DiaryReward.ARDOUGNE_CLOAK1, 3012, 4380, NpcId.FROGEEL, ItemId.GIANT_FROG_LEGS, ItemId.RAW_CAVE_EEL);
    ...
    static {
        Utils.populateMap(SYMBOLS_OF_LIFE.asList(), NPC_MAP = new Int2ObjectOpenHashMap<>(SYMBOLS_OF_LIFE.size()), SymbolOfLife::getNpcId);
    }
    ...
    public static SymbolOfLife of(@NotNull final ImmutableLocation location) {
        for (val symbolOfLife : SYMBOLS_OF_LIFE) {
