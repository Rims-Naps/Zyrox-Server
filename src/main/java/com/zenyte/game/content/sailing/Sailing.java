...
public class Sailing {
	...
	private static final Map<Integer, Location> LOCATIONS = ImmutableMap.<Integer, Location>builder()
			.put(1, new Location(2834, 3332, 1))
			.put(2, new Location(3055, 3242, 1))
			.put(3, new Location(2853, 3235, 0))
			.put(5, new Location(2956, 3143, 1))
			.put(6, new Location(3032, 3217, 1))
			.put(7, new Location(2775, 3234, 1))
			.put(8, new Location(2683, 3268, 1))
			.put(14, new Location(2662, 2676, 1))
			.put(15, new Location(3041, 3199, 1)).build();
	
	private static final Map<Integer, Integer> DELAYS = ImmutableMap.<Integer, Integer>builder()
			.put(1, 11)
			.put(2, 11)
			.put(3, 10)
			.put(4, 10)
	...
	public static void sail(final Player player, final String departure, final String destination) {
		val value = getValue(departure, destination);
		val location = LOCATIONS.get(value);
		val delay = DELAYS.get(value);
		player.lock(delay);
	...
	public static void sailZeah(final Player player, final String destination) {
		val location = destination.equals("Port Sarim") ? PORT_SARIM_LOCATION : destination.equals("Piscarilius House") ? PISCARILIUS_LOCATION : LANDS_END_LOCATION;
