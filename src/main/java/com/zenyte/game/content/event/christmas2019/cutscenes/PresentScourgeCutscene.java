...
public class PresentScourgeCutscene extends Cutscene {
    ...
    public void build() {
        ...
        addActions(28, new CameraPositionAction(player, instance.getLocation(2475 + 1, 5404 + 1, 1), 500, 255, 100),
                new CameraLookAction(player, instance.getLocation(2465, 5396, 1), 0, 255, 100),
                new DialogueAction(new Dialogue(player) {
                    @Override
                    public void buildDialogue() {
                        ...
                        options("Select an Option",
                                new DialogueOption("Okay, sorry for disturbing you.", key(20)),
                                new DialogueOption("Not until you have seen what I have to show you!", key(10)));
        ...
        addActions(44, this::turnRight, new DialogueAction(new Dialogue(player) {
            ...
            public void buildDialogue() {
                ...
                npcWithId(ChristmasConstants.PAJAMAS_SCOURGE_NPC_ID, "You bring this spoilt little brat before me as proof of my misdeeds?" +
                        " You've only confirmed the righteousness of my actions.", Expression.HIGH_REV_MAD);
        ...
        addActions(47, new DialogueAction(new Dialogue(player) {
            @Override
            public void buildDialogue() {
                npcWithId(ChristmasConstants.PAJAMAS_SCOURGE_NPC_ID, "You're lucky that your attempts have been so feeble they've bordered on the amusing," +
                        " but I grow tired of your antics. Come back here again, 'ghost', and you shall not find me so merciful.", Expression.HIGH_REV_MAD)
                .executeAction(() -> {
        ...
        addActions(49, new CameraPositionAction(player, instance.getLocation(2471, 5400, 1), 550, 255, 100),
                new CameraLookAction(player, instance.getLocation(2471, 5403, 1), 75, 255, 100));
        ...
        addActions(55, player::unlock, new CameraResetAction(player), () -> player.getVarManager().sendBit(4606, 0), () -> closedTabs.forEach(tab -> tab.open(player)),
                () -> player.setLocation(new Location(2465, 5403, 0)), () -> player.getPacketDispatcher().sendClientScript(10700, 0), fadeScreen::unfade, this::finish);
    ...
    private final void jumpToOptions() {
        overrideActions(31, new DialogueAction(new Dialogue(player) {
            @Override
            public void buildDialogue() {
                val optionsList = new ObjectArrayList<DialogueOption>(options.size());
                for (int i = 0; i < options.size(); i++) {
                    ...
                    optionsList.add(new DialogueOption(option, () -> {
                        ...
                        imp.setInvalidAnimation(new Animation(15028));
                        turnStraight();
                        val id = option.equalsIgnoreCase("Jack Frost.") ? 15040 : option.equalsIgnoreCase("Tiny Thom.") ? 15059 : option.equalsIgnoreCase("Cook.") ? 15055 : 15043;
    ...
    private final void startSpawnSequence(final int startTime) {
        ...
        addActions(startTime + 2, new CameraPositionAction(player, instance.getLocation(2469, 5402, 1), 300, 255, 100),
                new CameraLookAction(player, instance.getLocation(2472, 5402, 1), 50, 255, 100));


        addActions(startTime + 9, new CameraPositionAction(player, instance.getLocation(2475 + 1, 5404 + 1, 1), 500, 255, 100),
                new CameraLookAction(player, instance.getLocation(2465, 5396, 1), 0, 255, 100), () -> selectedNPC.spawn());
    }
