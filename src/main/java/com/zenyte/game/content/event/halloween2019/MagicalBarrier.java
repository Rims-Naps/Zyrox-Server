...
public class MagicalBarrier implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        WorldTasksManager.scheduleOrExecute(() -> {
            val destination = object.transform((object.getRotation() & 0x1) == 0 ? Direction.EAST : Direction.NORTH, player.matches(object) ? 1 : 0);
    ...
    public Object[] getObjects() {
        return new Object[] {
                HalloweenObject.BARRIER.getRepackedObject()
        };
    }
}
