...
public class PastScourgeCutsceneP1 extends Cutscene {
    ...
    public void build() {
        ...
        addActions(0, player::lock, () -> player.getPacketDispatcher().sendClientScript(10700, 1), () -> closedTabs.forEach(tab -> player.getInterfaceHandler().closeInterface(tab)), () -> player.getInterfaceHandler().openGameTab(GameTab.FRIENDS_TAB),
        ...
        addActions(9, new CameraPositionAction(player, instance.getLocation(2471, 5407 - 3, 1), 350, 5, 0),
                new CameraLookAction(player, instance.getLocation(2471, 5390 - 3, 1), 200, 5, 0));

        addActions(13, () -> World.sendObjectAnimation(new WorldObject(46180, 10, 2, instance.getLocation(2470, 5398, 1)), new Animation(15001)),
                () -> dummy.setInvalidAnimation(new Animation(15001)));

        addActions(22, new CameraPositionAction(player, instance.getLocation(2471, 5400, 1), 550, 255, 100),
        ...
        addActions(27, new CameraPositionAction(player, instance.getLocation(2475 + 1, 5404 + 1, 1), 500, 255, 100),
        ...
        addActions(29, new DialogueAction(new Dialogue(player) {
            ...
            public void buildDialogue() {
                options("Choose an option:",
                        new DialogueOption("I'm a ghost!", key(10)),
                        new DialogueOption("I'm a human in bedsheets!", key(20)),
                        new DialogueOption("I'm a giant floating napkin!", key(30)));
                ...
                options("Choose an option:",
                        new DialogueOption("My heavy guilt.", key(90)),
                        new DialogueOption("The weight of my sins.", key(100)),
                        new DialogueOption("Nothing, they're just chains.", key(110)));
                ...
                options("Choose an option:",
                        new DialogueOption("What about ruining the Christmas feast?", key(150)),
                        new DialogueOption("What about betraying the Queen of Snow?", key(200)),
                        new DialogueOption("What about all that dark magic?", key(250)));
        ...
        addActions(30, () -> World.sendObjectAnimation(new WorldObject(46180, 10, 2, instance.getLocation(2470, 5398, 1)), new Animation(15002)),
                () -> dummy.setInvalidAnimation(new Animation(15002)));
        ...
        addActions(47, () -> {
            try {
                val instance = new LandOfSnowInstance(MapBuilder.findEmptyChunk(4, 4));
