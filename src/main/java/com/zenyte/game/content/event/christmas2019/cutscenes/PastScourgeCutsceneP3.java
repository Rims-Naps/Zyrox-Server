...
public class PastScourgeCutsceneP3 extends Cutscene {
    ...
    public void build() {
        ...
        addActions(1, new CameraPositionAction(player, instance.getLocation(2476, 5405, 1), 500, 255, 100),
        ...
        addActions(7, new DialogueAction(new Dialogue(player) {
            ...
            public void buildDialogue() {
                ...
                npcWithId(ChristmasConstants.PAJAMAS_SCOURGE_NPC_ID, "And let that teach you busybody, interfering, Christmas-loving fools to stay out of my business!", Expression.HIGH_REV_MAD)
                        .executeAction(() -> AChristmasWarble.progress(player, AChristmasWarble.ChristmasWarbleProgress.FROZEN_GUESTS));
            }
        }));
        addActions(8, new CameraPositionAction(player, instance.getLocation(2471, 5400, 1), 550, 255, 100),
        ...
        addActions(13, player::unlock, new CameraResetAction(player), () -> player.getVarManager().sendBit(4606, 0), () -> closedTabs.forEach(tab -> tab.open(player)),
                () -> player.setLocation(new Location(2465, 5403, 0)), () -> player.getPacketDispatcher().sendClientScript(10700, 0), fadeScreen::unfade,
