...
public class HalloweenChest implements ObjectAction {
    ...
    private static final Location[] options = new Location[]{
            new Location(1752, 4718, 0),
            new Location(1749, 4708, 0),
            new Location(1735, 4725, 0),
            new Location(1751, 4731, 0),
            new Location(1766, 4715, 0)
    };
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        if (option.equalsIgnoreCase("Open")) {
            ...
            val firstIndex = bitpacked & 0x1F;
            val secondIndex = (bitpacked >> 5) & 0x1F;
            val first = options[firstIndex >= options.length ? 0 : firstIndex];
            val second = options[secondIndex >= options.length ? 1 : secondIndex];
    ...
    public Object[] getObjects() {
        return new Object[]{
                HalloweenObject.CHEST.getRepackedObject()
        };
    }
}
