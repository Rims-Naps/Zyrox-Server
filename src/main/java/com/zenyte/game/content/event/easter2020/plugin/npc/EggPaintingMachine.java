...
public class EggPaintingMachine extends NPCPlugin {
        ...
        bind("Look-at", new OptionHandler() {
            ...
            public void handle(Player player, NPC npc) {
                ...
                if (progress != Stage.GATHER_IMPLINGS) {
                    player.getDialogueManager().start(new PlayerChat(player, progress.ordinal() < Stage.GATHER_IMPLINGS.ordinal() ?
                            "You look at the enormous machine and wonder why it isn't yet working."
                            : "The machine is properly working as expected!"));
                    return;
                }
                ...
                val item = new Item(EasterItem.EASTER_IMPLING_JAR.getItemId());
                player.getDialogueManager().start(new Dialogue(player) {
                    ...
                    public void buildDialogue() {
                        ...
                        player("Well, take a seat and get cracking.")
                                .executeAction(() -> {
            ...
            public void click(final Player player, final NPC npc, final NPCOption option) {
                val object = World.getObjectWithType(npc.getId() == EasterConstants.EGG_PAINTING_MACHINE_BASE_WEST ? westernPaintingMachine : easternPaintingMachine, 10);
    ...
    public int[] getNPCs() {
        return new int[]{
                EasterConstants.EGG_PAINTING_MACHINE_BASE_WEST, EasterConstants.EGG_PAINTING_MACHINE_BASE_EAST,
                EasterConstants.EGG_PAINTING_MACHINE_WEST, EasterConstants.EGG_PAINTING_MACHINE_EAST,
                15241, 15237
        };
    }
