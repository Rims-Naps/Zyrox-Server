...
public class OutsideCutscene extends Cutscene {
    ...
    public void build() {
        ...
        addActions(4, new CameraPositionAction(player, instance.getLocation(3090 - 2, 3475, 0), 350, -128, 0),
                new CameraLookAction(player, instance.getLocation(3093, 3471, 0), 200, -128, 0), () -> {
        ...
        addActions(13, player::unlock, new CameraResetAction(player), () -> player.getVarManager().sendBit(4606, 0), () -> closedTabs.forEach(tab -> tab.open(player)),
                () -> player.setLocation(new Location(3088, 3472, 0)), () -> player.getPacketDispatcher().sendClientScript(10700, 0),
                () -> player.getPacketDispatcher().sendMinimapState(MinimapState.ENABLED),
                () -> SplittingHeirs.advanceStage(player, Stage.POST_UNDRESS_CUTSCENE));
    ...
    public static final class UndressDialogue extends Dialogue {
        ...
        public void buildDialogue() {
            ...
            player("I-");
            npc("Well, I guess it's very much a carrot and stick situation: you've dealt with the sticky, now you get your carrot.", Expression.EASTER_BUNNY_VERY_HAPPY)
                    .executeAction(() -> {
            ...
            doubleItem(new Item(EasterConstants.EasterItem.EASTER_CARROT.getItemId()), new Item(EasterConstants.EasterItem.CHOCATRICE_CAPE.getItemId()),
                    "The Easter Bunny hands you a large carrot along with an easter cape.");
            npc("Here, take mine. I'm off to a nice warm island with no hint of chocolate in sight!", Expression.EASTER_BUNNY_VERY_HAPPY)
                    .executeAction(() -> {
