...
public class PresentObject implements ObjectAction {
            ...
            public void buildDialogue() {
                ...
                plain("To " + player.getName() + " and " + impName + ". Have a very merry Christmas. From your pal, Santa.").executeAction(() -> {
                    ...
                    WorldTasksManager.schedule(() -> {
                        ...
                        player.getTemporaryAttributes().put("quest completed rewards", Arrays.asList("Candy cane.", "Ghost costume.", "The Snowman Dance emote.", "The Freeze Emote",
    ...
    public Object[] getObjects() {
        return new Object[] {
                ChristmasConstants.PRESENT_OBJECT
        };
    }
}
