            ...
            player.getDialogueManager().start(new Dialogue(player, npc) {
                ...
                public void buildDialogue() {
    ...
    
                    {
                        ...
                        npc(impName, "Scourges is a dark wizard. When Nick tried to stop 'im, Scourges bound him in chains with a snap o' his digits.", Expression.HIGH_REV_NORMAL)
                                .executeAction(() -> {
                                            if (!AChristmasWarble.progressedAtLeast(player, AChristmasWarble.ChristmasWarbleProgress.SPOKEN_TO_PERSONAL_IMP)) {
                        ...
                        options(TITLE,
                                new DialogueOption("Count me in!", key(COUNT_ME_IN)),
                                new DialogueOption("Sorry, I don't have time right now.", this::finish));
