...
public class RabbitHoleObject implements ObjectAction {
    ...
    private void transformToHuman(final Player player, final Runnable then) {
        val anim = new Animation(EasterConstants.BUNNY_TO_HUMAN_ANIM);
    ...
    private void transformToBunny(final Player player, final Runnable then) {
        val anim = new Animation(EasterConstants.HUMAN_TO_BUNNY_ANIM);
        player.lock(anim.getDuration() / 600);
    ...
    public Object[] getObjects() {
        return new Object[]{
                EasterConstants.WARREN_ENTRANCE,
                EasterConstants.WARREN_EXIT,
                EasterConstants.EASTER_FACTORY_ENTRANCE,
                EasterConstants.EASTER_FACTORY_EXIT
        };
    }
