...
public enum EasyClueNPC implements ClueNPC {
    SCREAMING_BANSHEE(12.8),
    HAM_MEMBER("H.A.M. Member", 50),
    HAM_GUARD("H.A.M. Guard", 55),
    GOBLIN_GUARD(50),
    SWAMP_CRAB(96),
    MINOTAUR(101, npc -> npc.getCombatLevel() == 12 || npc.getCombatLevel() == 27),
    AFFLICTED(128),
    AL_KHARID_WARRIOR("Al-kharid warrior", 128),
    AMMONITE_CRAB(128),
    ANJA(128),
    BANSHEE(128),
    BARBARIAN(128),
    ...
    RUSTY(128),
    SAND_CRAB(128),
    SKELETON(128, npc -> npc.getCombatLevel() >= 21 && npc.getCombatLevel() <= 85 && !(npc.getCombatLevel() == 45 || npc.getCombatLevel() == 72 || npc.getCombatLevel() == 77 || npc.getCombatLevel() == 87)),
    THIEF(128),
    THUG(128),
    WEREWOLF(128),
    WOMAN(128),
