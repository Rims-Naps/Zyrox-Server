...
public enum BeginnerClueNPC implements ClueNPC {
    ...
    BRYOPHYTA(1),
    OBOR(1),
    GUNTHOR_THE_BRAVE(30),
    DARK_WIZARD(35, npc -> npc.getCombatLevel() >= 20),
    ICE_GIANT(40, npc -> npc.getCombatLevel() == 53),
    MOSS_GIANT(45),
    CYCLOPS(50, npc -> npc.getCombatLevel() == 56),
    DARK_WIZARD_(50, npc -> npc.getCombatLevel() < 20),
    HILL_GIANT(50),
    BARBARIAN(55, npc -> npc.getCombatLevel() >= 15),
    MINOTAUR(60),
    GIANT_FROG(64),
    GOBLIN(64, npc -> npc.getCombatLevel() >= 15),
    HOBGOBLIN(70),
    BARBARIAN_(75, npc -> npc.getCombatLevel() < 15),
    GOBLIN_(80, npc -> npc.getCombatLevel() < 15),
    MUGGER(80),
    AFFLICTED(90),
    AL_KHARID_WARRIOR("Al-kharid warrior", 90),
    ANJA(90),
    BEAR_CUB(90),
    BLACK_BEAR(90),
    BREOCA(90),
    ...
    PIT_SCORPION(100),
    POISON_SCORPION(100),
    SCORPIAS_OFFSPRING("Scorpia's offspring", 100),
    SCORPION(100),
    SKELETAL_MINER(100),
    SKELETON(100),
    COW(128),
    COW_CALF(128),
    DEADLY_RED_SPIDER(128),
    DUNGEON_RAT(128),
    GIANT_RAT(128),
    GIANT_SPIDER(128),
    ICE_SPIDER(128),
