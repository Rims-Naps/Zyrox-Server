...
public enum Anagram implements Clue {
    ...
    Anagram(final String anagram, final ClueLevel level, final ChallengeScroll challenge, final PuzzleType puzzleType, final int... npcIds) {
        ...
        this.npcIds = npcIds;
        clueChallenge = challenge != null ?
                        new TalkChallengeRequest(challenge, npcIds) :
                        boxId == null ?
                        new TalkRequest(npcIds) :
                        boxId.equals(PUZZLE_BOX) ?
                         new PuzzleRequest(npcIds) :
                         new LightBoxRequest(npcIds);
    }
