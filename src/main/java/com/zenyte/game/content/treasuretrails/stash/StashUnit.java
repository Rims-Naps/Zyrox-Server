...
public enum StashUnit {
    ...
    EDGEVILLE_GENERAL_STORE(MEDIUM, 29005, EmoteClue.EMOTE_30),
    ...
    private StashUnitType type;
	private final int objectId;
	private final EmoteClue clue;

	private static final StashUnit[] values = values();
	@Getter
    private static final Int2ObjectMap<StashUnit> map = Int2ObjectMaps.unmodifiable((Int2ObjectMap<StashUnit>) Utils.populateMap(values, new Int2ObjectOpenHashMap<>(), StashUnit::getObjectId));
