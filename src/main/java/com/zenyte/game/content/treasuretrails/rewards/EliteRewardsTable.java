...
public class EliteRewardsTable extends ClueRewardTable {
    ...
    protected final List<ImmutableItem> recolorCrystal = tableOf(
            // 1 in 125
            item(CRYSTAL_OF_CRWYS)
    );
    ...
    protected void defineTables() {
        ...
        appendTable(233750, thirdAgeTable); //osrs update on 11 May (rate reduced to 233750)
        ...
        appendTable(125, recolorCrystal);
    }
