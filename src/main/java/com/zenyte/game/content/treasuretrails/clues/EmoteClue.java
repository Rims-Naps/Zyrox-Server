...
public enum EmoteClue implements Clue {
    ...
    EMOTE_3(ClueLevel.ELITE, emotes(Emote.BOW), false,
            ...
            get(new int[][]{
                    ...
                    { 3050, 3482 },
                    { 3044, 3482 }
            }, 1), any("Any god book", item(HOLY_BOOK), item(BOOK_OF_BALANCE), item(UNHOLY_BOOK), item(BOOK_OF_LAW), item(BOOK_OF_WAR), item(BOOK_OF_DARKNESS))),
    ...
    EMOTE_9(ClueLevel.ELITE, emotes(Emote.HEADBANG), false,
            ...
            get(new int[][]{
                    ...
                    { 2568, 3151 },
                    { 2568, 3155 }
            }), any("Any pirate bandana", item(PIRATE_BANDANA), item(PIRATE_BANDANA_7124), item(PIRATE_BANDANA_7130), item(PIRATE_BANDANA_7136)), item(DRAGON_NECKLACE), item(MAGIC_LONGBOW)),
    ...
    EMOTE_10(ClueLevel.MASTER, emotes(Emote.JIG), true,
            ...
            get(new int[][]{
                    ...
                    { 3557, 9690 },
                    { 3557, 9700 }
            }, 0), any("Any full barrows set", all(range(AHRIMS_HOOD_100, AHRIMS_HOOD_0), range(AHRIMS_STAFF_100, AHRIMS_STAFF_0), range(AHRIMS_ROBETOP_100, AHRIMS_ROBETOP_0), range(AHRIMS_ROBESKIRT_100, AHRIMS_ROBESKIRT_0)),
            all(item(AHRIMS_HOOD), item(AHRIMS_STAFF), item(AHRIMS_ROBETOP), item(AHRIMS_ROBESKIRT)),
            all(range(DHAROKS_HELM_100, DHAROKS_HELM_0), range(DHAROKS_GREATAXE_100, DHAROKS_GREATAXE_0), range(DHAROKS_PLATEBODY_100, DHAROKS_PLATEBODY_0), range(DHAROKS_PLATELEGS_100, DHAROKS_PLATELEGS_0)),
            all(item(DHAROKS_HELM), item(DHAROKS_GREATAXE), item(DHAROKS_PLATEBODY), item(DHAROKS_PLATELEGS)),
            all(range(GUTHANS_HELM_100, GUTHANS_HELM_0), range(GUTHANS_WARSPEAR_100, GUTHANS_WARSPEAR_0), range(GUTHANS_PLATEBODY_100, GUTHANS_PLATEBODY_0), range(GUTHANS_CHAINSKIRT_100, GUTHANS_CHAINSKIRT_0)),
            all(item(GUTHANS_HELM), item(GUTHANS_WARSPEAR), item(GUTHANS_PLATEBODY), item(GUTHANS_CHAINSKIRT)),
            all(range(KARILS_COIF_100, KARILS_COIF_0), range(KARILS_CROSSBOW_100, KARILS_CROSSBOW_0), range(KARILS_LEATHERTOP_100, KARILS_LEATHERTOP_0), range(KARILS_LEATHERSKIRT_100, KARILS_LEATHERSKIRT_0)),
            all(item(KARILS_COIF), item(KARILS_CROSSBOW), item(KARILS_LEATHERTOP), item(KARILS_LEATHERSKIRT)),
            all(range(TORAGS_HELM_100, TORAGS_HELM_0), range(TORAGS_HAMMERS_100, TORAGS_HAMMERS_0), range(TORAGS_PLATEBODY_100, TORAGS_PLATEBODY_0), range(TORAGS_PLATELEGS_100, TORAGS_PLATELEGS_0)),
            all(item(TORAGS_HELM), item(TORAGS_HAMMERS), item(TORAGS_PLATEBODY), item(TORAGS_PLATELEGS)),
            all(range(VERACS_HELM_100, VERACS_HELM_0), range(VERACS_FLAIL_100, VERACS_FLAIL_0), range(VERACS_BRASSARD_100, VERACS_BRASSARD_0), range(VERACS_PLATESKIRT_100, VERACS_PLATESKIRT_0)),
            all(item(VERACS_HELM), item(VERACS_FLAIL), item(VERACS_BRASSARD), item(VERACS_PLATESKIRT)))),
    ...
    EMOTE_21(ClueLevel.MASTER, emotes(Emote.BOW), true,
            "Bow near Lord Iorwerth. Beware of double agents! Equip a new imbued crystal bow.",
            get(new int[][]{
                    { 2198, 3261 },
                    { 2189, 3252 },
                    { 2189, 3248 },
