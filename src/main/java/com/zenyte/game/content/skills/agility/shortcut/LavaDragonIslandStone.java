...
public class LavaDragonIslandStone implements Shortcut {
    ...
    @Override
    public int getLevel(WorldObject object) { return 74; }

    @Override
    public int getDuration(boolean success, WorldObject object) { return 3; }

    @Override
    public double getSuccessXp(WorldObject object) { return 0; }
