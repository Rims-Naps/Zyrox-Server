...
public class KalphiteDungeonCrevice implements Shortcut {
    private static Animation CRAWL_IN = new Animation(2594);
    private static Animation CRAWL_OUT = new Animation(2595);
    ...
    private static Animation INVISIBLE = new Animation(2590);

    private static Location WEST_CREVICE = new Location(3501, 9510, 2);
    private static Location EAST_CREVICE = new Location(3506, 9506, 2);

    private static Location WEST_EXIT = new Location(3500, 9510, 2);
    private static Location EAST_EXIT = new Location(3506, 9505, 2);
