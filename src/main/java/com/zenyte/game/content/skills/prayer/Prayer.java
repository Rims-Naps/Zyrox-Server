...
public enum Prayer {
	...
	THICK_SKIN(4104, 1, -1, 3, 2690, 4107, 4113, 4128, 4129, 5464, 5465),
	BURST_OF_STRENGTH(4105, 4, -1, 3, 2688, 4108, 4114, 4122, 4123, 4124, 4125, 4126, 4127, 4128, 4129, 5464, 5465),
	CLARITY_OF_THOUGHT(4106, 7, -1, 3, 2664, 4109, 4115, 4122, 4123, 4124, 4125, 4126, 4127, 4128, 4129, 5464, 5465),
	...
	SHARP_EYE(4122, 8, -1, 3, 2685, 4125, 4127, 4123, 4124, 4126, 4105, 4106, 4108, 4109, 4114, 4115, 4128, 4129,
            5464, 5465),
	MYSTIC_WILL(4123, 9, -1, 3, 2670, 4125, 4127, 4122, 4124, 4126, 4105, 4106, 4108, 4109, 4114, 4115, 4128, 4129,
            5464, 5465),
	HAWK_EYE(4124, 26, -1, 6, 2666, 4125, 4127, 4122, 4123, 4126, 4105, 4106, 4108, 4109, 4114, 4115, 4128, 4129,
            5464, 5465),
	MYSTIC_LORE(4125, 27, -1, 6, 2668, 4124, 4127, 4122, 4123, 4126, 4105, 4106, 4108, 4109, 4114, 4115, 4128, 4129,
            5464, 5465),
	EAGLE_EYE(4126, 44, -1, 12, 2665, 4125, 4127, 4122, 4123, 4124, 4105, 4106, 4108, 4109, 4114, 4115, 4128, 4129,
            5464, 5465),
	MYSTIC_MIGHT(4127, 45, -1, 12, 2669, 4125, 4124, 4122, 4123, 4126, 4105, 4106, 4108, 4109, 4114, 4115, 4128, 4129,
            5464, 5465),
	RIGOUR(5464, 74, -1, 24, 2685, 4125, 4124, 4122, 4123, 4126, 4105, 4106, 4108, 4109, 4114, 4115, 4127, 4128, 4129,
            4104, 4107, 4113, 5465),
	CHIVALRY(4128, 60, -1, 24, 3826, 4129, 4105, 4106, 4108, 4109, 4114, 4115, 4122, 4123, 4124, 4125, 4126, 4127,
            4104, 4107, 4113, 5464, 5465),
	PIETY(4129, 70, -1, 24, 3825, 4128, 4105, 4106, 4108, 4109, 4114, 4115, 4122, 4123, 4124, 4125, 4126, 4127, 4104,
            4107, 4113, 5464, 5465),
	AUGURY(5465, 77, -1, 24, 2670, 4125, 4124, 4122, 4123, 4126, 4105, 4106, 4108, 4109, 4114, 4115, 4127, 4128, 4129,
            4104, 4107, 4113, 5464),
	PRESERVE(5466, 55, -1, 3, 2679);

	@Getter private final int varbit, level, headIcon;
	@Getter private final SoundEffect soundEffect;
	@Getter private final float drainRate;
	@Getter private final int[] collisions;
	@Getter @Setter private int[] quickPrayerCollisions;
	...
	private int[] getQPCollisions() {
		...
		for (Prayer prayers : Prayer.VALUES) {
			for (int i = 0; i < collisions.length; i++) {
				if (prayers.getVarbit() == collisions[i])
					values[i] = prayers.ordinal();
			}
		}
		return values;
	}
