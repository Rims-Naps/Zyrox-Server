 ...
 * @author Cresinkel
 */
public class GhommalHiltArmaStructure implements TeleportStructure {
    ...
    public void start(Player player, Teleport teleport) {
        val rangedLevel = player.getSkills().getLevel(Skills.RANGED);
        if (rangedLevel < 70) {
            player.sendMessage("You lack the 70 ranged requirement for Kree'arra.");
            return;
        }
