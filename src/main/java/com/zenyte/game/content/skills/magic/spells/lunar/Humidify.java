...
public final class Humidify implements DefaultSpell, NPCSpell {
	...
	private static final ImmutableMap<Integer, Integer> VESSELS = ImmutableMap.<Integer, Integer>builder()
			.put(1925, 1929).put(6667, 6668).put(1935, 1937).put(229, 227).put(20800, 20801)
			.put(5331, 5340).put(5333, 5340).put(5334, 5340).put(5335, 5340).put(5336, 5340).put(5337, 5340)
			.put(5338, 5340).put(5339, 5340).put(1831, 1823).put(1829, 1823).put(1827, 1823).put(1825, 1823)
			.put(1923, 1921).put(434, 1761)
			
			.put(5358, 5370).put(5359, 5371).put(5360, 5372).put(5361, 5373)
			.put(5362, 5374).put(5363, 5375).put(5480, 5496).put(5481, 5497).put(5482, 5498).put(5483, 5499)
			.put(5484, 5500).put(5485, 5501).put(5486, 5502).put(5487, 5503).put(21469, 21477).put(21471, 21480)
			.put(22848, 22856).put(22850, 22859).put(22862, 22866)
	...
	private final boolean spellEffect(final Player player) {
        ...
        for (int i = 0; i < 28; i++) {
            ...
            val response = VESSELS.get(item.getId());
            if (response == null) {
                continue;
            }
            val it = new Item(response);
            item.setId(it.getId());
    ...
    public boolean spellEffect(final Player player, final NPC npc) {
        ...
        val projectile = new Projectile(1669, 0, 0, 0, 0, 60, 0, 0);
