...
public enum FurnitureSpace {
	...
	private FurnitureSpace(final int spotId, final Furniture... furnitures) {
		spotIds = new int[] { spotId };
		this.furnitures = furnitures;
	}
	
	private FurnitureSpace(final int[] spotIds, final Furniture... furnitures) {
