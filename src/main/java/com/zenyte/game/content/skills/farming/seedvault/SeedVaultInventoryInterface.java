...
public class SeedVaultInventoryInterface extends Interface implements SwitchPlugin {
    ...
    public void open(Player player) {
        ...
        dispatcher.sendComponentSettings(getInterface(), getComponent("Container"), 0, inventorySize, CLICK_OP1,
                CLICK_OP2, CLICK_OP3, CLICK_OP4, CLICK_OP5, CLICK_OP6, CLICK_OP7, CLICK_OP8, CLICK_OP9, CLICK_OP10,
                DRAG_DEPTH1, DRAG_TARGETABLE);
    }
