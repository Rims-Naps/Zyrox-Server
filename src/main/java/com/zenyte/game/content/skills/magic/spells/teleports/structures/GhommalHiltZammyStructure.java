 ...
 * @author Cresinkel
 */
public class GhommalHiltZammyStructure implements TeleportStructure {
    ...
    public void start(Player player, Teleport teleport) {
        val hitpointsLevel = player.getSkills().getLevel(Skills.HITPOINTS);
        if (hitpointsLevel < 70) {
            player.sendMessage("You lack the 70 hitpoints requirement for K'il Tsutsaroth.");
            return;
        }
