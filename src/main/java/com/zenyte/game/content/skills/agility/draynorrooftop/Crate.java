		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				case 3:
					...
					player.addAttribute("Draynor_lap_count", player.getNumericAttribute("Draynor_lap_count").intValue() + 1);
					val laps = player.getNumericAttribute("Draynor_lap_count").intValue();
					player.sendMessage("You have ran "+ Colour.RED.wrap(laps) + (laps == 1 ? " lap " : " laps ") + "on the Draynor Rooftop Course.");
					stop();
					break;
				}
			}
