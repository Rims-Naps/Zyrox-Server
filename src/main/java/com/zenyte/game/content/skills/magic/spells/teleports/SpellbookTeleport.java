...
public enum SpellbookTeleport implements TeleportSpell, Teleport {
	...
	ZENYTE_HOME_TELEPORT_INSTANT(NORMAL, HOME_TELEPORT, 0, new Location(3087, 3490, 0), false) {
		@Override
	...
	TROLLHEIM_TELEPORT(NORMAL, REGULAR_TELEPORT, 68, new Location(2890, 3680, 0)),
