...
public class CombineStaminaPotion extends Action {
    ...
    public static final Int2IntOpenHashMap POTS = new Int2IntOpenHashMap(new int[]{3022, 3020, 3018, 3016},
            new int[]{12631, 12629, 12627, 12625});
    ...
    public int processWithDelay() {
        ...
        if (BoosterPerks.isActive(player, BoosterPerks.HERBLORE)) {
            if (Utils.random(99) < 5) {
                player.sendFilteredMessage("Your Booster Perk saves you your amylase crystals!");
            } else {
