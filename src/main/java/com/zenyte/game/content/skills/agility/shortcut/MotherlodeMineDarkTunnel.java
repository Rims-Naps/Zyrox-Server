...
public class MotherlodeMineDarkTunnel implements Shortcut {
    ...
    private static Location WEST_CREVICE = new Location(3760, 5670, 0);

    private static Location WEST_EXIT = new Location(3759, 5670, 0);
    private static Location EAST_EXIT = new Location(3765, 5671, 0);
