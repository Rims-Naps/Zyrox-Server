...
public class VolcanicForge extends Action {
	...
	public static final Map<Integer, Integer[]> WARDS = ImmutableMap.<Integer, Integer[]>builder()
			.put(11924, new Integer[] { 11931, 11932, 11933 })
			.put(11926, new Integer[] { 11928, 11929, 11930 }).build();
	...
	public int processWithDelay() {
		val location = new Location(player.getX(), player.getY() - 1, player.getPlane());
		switch (ticks++) {
		case 0:
