...
public enum Furniture {
	...
	@Getter
	private double xp;
	@Getter private ConstructionAction action;
	@Getter private int refreshType;
	@Getter private int nails, ticks;
	@Getter private boolean wateringCan;
	...
	private Furniture(final int objectId) {
		this(0, 0, new int[] { objectId }, 0);
	}
	
	private Furniture(final int objectId, final int capeId, final int hoodId) {
		this(0, 0, new int[] { objectId }, 0, capeId == -1 ? null : new Item(capeId),
                hoodId == -1 ? null : new Item(hoodId));
	}

	private Furniture(final int level, final double xp, final int objectId, final int itemId, final Item... materials) {
		this(level, xp, new int[] { objectId }, itemId, materials);
	}
	
	private Furniture(final int level, final double xp, final int objectId, final int itemId, final int refreshType, final Item... materials) {
		this(level, xp, new int[] { objectId }, itemId, null, refreshType, materials);
	}
	
	private Furniture(final int level, final int xp, final int objectId, final int itemId, final ConstructionAction action, final Item... materials) {
		this(level, xp, new int[] { objectId }, itemId, action, 0, materials);
	}
	
	private Furniture(final int level, final double xp, final int[] objectIds, final int itemId, final Item... materials) {
		this(level, xp, objectIds, itemId, null, 0, materials);
	}
	
	private Furniture(final int level, final double xp, final int[] objectIds, final int itemId, final ConstructionAction action, final Item... materials) {
		this(level, xp, objectIds, itemId, action, 0, materials);
	}
	
	private Furniture(final int level, final int xp, final int objectId, final int itemId, final ConstructionAction action, final int refreshType, final Item... materials) {
		this(level, xp, new int[] { objectId }, itemId, action, refreshType, materials);
	}
	
	private Furniture(final int level, final double xp, final int[] objectIds, final int itemId, final int refreshType, final Item... materials) {
		this(level, xp, objectIds, itemId, null, refreshType, materials);
	}
	
	private Furniture(final int level, final double xp, final int[] objectIds, final int itemId, final ConstructionAction action, final int refreshType, final Item... materials) {
		this.level = level;
		this.xp = xp;
	...
	public static interface ConstructionAction {
		
		public int REFRESH_ROOM = 1, REFRESH_HOUSE = 2;
		
		public static int getWindowIconOffset(final RoomReference room) {
		...
		public static int getStatueOffset(final RoomReference room) {
			for (final FurnitureData data : room.getFurnitureData()) {
				if (data == null)
					continue;
				final Furniture furniture = data.getFurniture();
		...
		public void onRefresh(final Construction construction, final RoomReference ref, final FurnitureData data, final WorldObject object, final boolean onEnter);
