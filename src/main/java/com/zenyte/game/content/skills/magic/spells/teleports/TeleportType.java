...
public enum TeleportType {
	...
	HOME_TELEPORT(new HomeStructure()),
	...
	ZENYTE_PORTAL_TELEPORT(new ZenytePortalStructure()),
	...
	ZENYTE_TABLET_TELEPORT(new ZenyteTabletStructure()),
	...
	GHOMMAL_HILT_ARMA(new GhommalHiltArmaStructure()),
	GHOMMAL_HILT_ZAMMY(new GhommalHiltZammyStructure()),
	GHOMMAL_HILT_BANDOS(new GhommalHiltBandosStructure()),
	GHOMMAL_HILT_SARA(new GhommalHiltSaraStructure()),
	GHOMMAL_HILT_MOR_UL_REK(new GhommalHiltMorUlRekStructure());
