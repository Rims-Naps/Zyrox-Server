...
public final class BoostPotionShare implements ItemSpell {
	...
	private static final Potion[] VALID_POTIONS = new Potion[] {
			Potion.ATTACK_POTION, Potion.SUPER_ATTACK_POTION, Potion.STRENGTH_POTION, Potion.SUPER_STRENGTH_POTION,
			Potion.DEFENCE_POTION, Potion.SUPER_DEFENCE_POTION, Potion.MAGIC_ESSENCE, Potion.MAGIC_POTION,
			Potion.SUPER_MAGIC_POTION, Potion.RANGING_POTION, Potion.SUPER_RANGING, Potion.SUPER_COMBAT_POTION
	};
