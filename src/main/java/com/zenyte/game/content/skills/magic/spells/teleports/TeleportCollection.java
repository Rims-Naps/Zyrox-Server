...
public enum TeleportCollection implements Teleport {
	...
	FREAKY_FORESTER_RANDOM(TeleportType.REGULAR_TELEPORT, new Location(2608, 4775, 0), 0, 0, 0, WILDERNESS_LEVEL, UNRESTRICTED),
    ...
    GHOMMAL_HILT_GWD_ARMA(TeleportType.GHOMMAL_HILT_ARMA, new Location(2830,5287, 2), 0, 0, 1, WILDERNESS_LEVEL, UNRESTRICTED),
	GHOMMAL_HILT_GWD_ZAMMY(TeleportType.GHOMMAL_HILT_ZAMMY, new Location(2934,5350, 2), 0, 0, 1, WILDERNESS_LEVEL, UNRESTRICTED),
	GHOMMAL_HILT_GWD_BANDOS(TeleportType.GHOMMAL_HILT_BANDOS, new Location(2857,5362, 2), 0, 0, 1, WILDERNESS_LEVEL, UNRESTRICTED),
	GHOMMAL_HILT_GWD_SARA(TeleportType.GHOMMAL_HILT_SARA, new Location(2926,5260, 0), 0, 0, 1, WILDERNESS_LEVEL, UNRESTRICTED),
	GHOMALT_HILT_MOR_UL_REK(TeleportType.GHOMMAL_HILT_MOR_UL_REK, new Location(2495, 5100, 0), 0, 0, 1, WILDERNESS_LEVEL, UNRESTRICTED)
	;
	...
	@Getter private final int randomizationDistance;
	@Getter private final int wildernessLevel;
	@Getter private final boolean combatRestricted;
	@Getter private final Item[] runes;
