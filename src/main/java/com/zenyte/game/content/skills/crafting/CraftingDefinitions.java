...
public class CraftingDefinitions {
	...
	public static final Item[][] MATERIALS = new Item[][] {
		{ new Item(1741), new Item(1741), new Item(1741), new Item(1741), new Item(1741), new Item(1741), new Item(1741) },
		{ new Item(1743) }, { new Item(1129), new Item(1095) },
		{ new Item(1063), new Item(1065), new Item(2487), new Item(2489), new Item(2491) },
		{ new Item(1745), new Item(1745, 2), new Item(1745, 3) },
		{ new Item(2505), new Item(2505, 2), new Item(2505, 3) },
		{ new Item(2507), new Item(2507, 2), new Item(2507, 3) },
		{ new Item(2509), new Item(2509, 2), new Item(2509, 3) },
		{ new Item(6289, 6), new Item(6289, 8), new Item(6289, 5), new Item(6289, 12), new Item(6289, 15) },
		{ new Item(10820), new Item(10820, 2) },
		{ new Item(7538), new Item(7536) },
		{ new Item(13383, 3), new Item(13383, 4), new Item(13383, 5) } };
	...
	public enum BattlestaffAttachingData {
		...
		public static BattlestaffAttachingData getDataByMaterial(final Item from, final Item to) {
			for (final BattlestaffAttachingData data : BattlestaffAttachingData.VALUES_ARR) {
				loop: for (final Item i : data.getMaterials()) {
	...
	public enum GemCuttingData {
		...
		AMETHYST(83, 60, new Animation(6295), new Item(21347), new Item(21338, 15), new Item(21350, 15), new Item(21352, 5), new Item(31034, 8)),
	...
	public enum GlassBlowingData {
		...
		@Getter
		private final Item product, material;
		@Getter
		private final int level;
		@Getter
		private final double xp;
	...
	public enum JewelleryData {
		...
		private final Item[] materials;
		@Getter
		private final int level, componentId, slotId;
		@Getter
		private final double xp;
	...
	public enum WeavingData {
		...
		static {
			for (WeavingData data : VALUES_ARR)
				VALUES.put(data.ordinal(), data);
		}
