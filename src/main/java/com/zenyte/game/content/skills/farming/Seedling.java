...
public enum Seedling {
    ...
    private final int seed, seedling, wateredSeedling, sapling;
    public static final Seedling[] values = values();
    @Getter private static final Int2ObjectOpenHashMap<Seedling> ingredientMap =
            new Int2ObjectOpenHashMap<>(values.length * 2);
