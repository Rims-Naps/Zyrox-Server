 ...
 */
public class KonarCrystalKeyProcesser extends DropProcessor {

	@Override
	public void attach() {
		appendDrop(new DisplayedDrop(ItemId.CRYSTAL_KEY, 3, 3) {
		...
		put(ItemId.CRYSTAL_KEY, new PredicatedDrop("This drop is can only be obtained when killing the monster during a slayer assignment, assigned by Konar Quo Maten."));
	}
