...
public enum Chest {
    ...
    COINS_10_CHEST(13, 12, 7.8, true, 11735, 11743, new ImmutableItem(995, 10)),
    NATURE_RUNE_CHEST(28, 25, 25, true, 11736, 11743, new ImmutableItem(995, 3), new ImmutableItem(561, 1, 2)),
    COINS_50_CHEST(43, 83, 125, true, 11737, 11743, new ImmutableItem(995, 50)),
    ARROW_TIP_CHEST(47, 350, 150, true, 11742, 11743, new ImmutableItem(41, 5), new ImmutableItem(995, 20)),
    ...
    STONE_CHEST(64, 1, 280, 34429, 34430, () -> {
        ...
        if (Utils.random(74) == 0) {
            return new Item[]{new Item(ClueItem.MEDIUM.getScrollBox())};
        }
        
        final Item[] common = new Item[]{
                new ImmutableItem(ItemId.COINS_995, 30, 359).generateResult(),
                new Item(ItemId.XERICIAN_FABRIC, 1),
                new ImmutableItem(ItemId.LIZARDMAN_FANG, 1, 3).generateResult(),
                new Item(ItemId.UNCUT_SAPPHIRE, 1)
        };
        final Item[] uncommon = new Item[]{
                new Item(ItemId.UNCUT_RUBY, 1)
        };
        final Item[] boltTips = new Item[]{
                new ImmutableItem(ItemId.OPAL_BOLT_TIPS, 4, 12).generateResult(),
                new ImmutableItem(ItemId.JADE_BOLT_TIPS, 4, 12).generateResult(),
                new ImmutableItem(ItemId.PEARL_BOLT_TIPS, 4, 12).generateResult(),
                new ImmutableItem(ItemId.TOPAZ_BOLT_TIPS, 4, 12).generateResult(),
                new ImmutableItem(ItemId.SAPPHIRE_BOLT_TIPS, 4, 12).generateResult(),
                new ImmutableItem(ItemId.EMERALD_BOLT_TIPS, 4, 12).generateResult(),
                new ImmutableItem(ItemId.RUBY_BOLT_TIPS, 4, 12).generateResult(),
                new ImmutableItem(ItemId.DIAMOND_BOLT_TIPS, 4, 12).generateResult(),
                new ImmutableItem(ItemId.DRAGONSTONE_BOLT_TIPS, 4, 12).generateResult(),
                new ImmutableItem(ItemId.ONYX_BOLT_TIPS, 4, 12).generateResult(),
        };
...
//    DORGESH_KAAN_RICH_CHEST(78, 500, 650, -1, -1, new ImmutableItem(995, 500, 2500), new ImmutableItem(1623), new ImmutableItem(1621), new ImmutableItem(1619), new ImmutableItem(1617), new ImmutableItem(1615), new ImmutableItem(1625), new ImmutableItem(1627), new ImmutableItem(1629), new ImmutableItem(4548), new ImmutableItem(5013), new ImmutableItem(10954), new ImmutableItem(10956), new ImmutableItem(10958), new ImmutableItem(2351), new ImmutableItem(10973), new ImmutableItem(10980)),
    ...
    public void onTriggerTrap(final Player player) {
        val hitAmount = Utils.random(player.getMaxHitpoints() / 14, player.getMaxHitpoints() / 8);
