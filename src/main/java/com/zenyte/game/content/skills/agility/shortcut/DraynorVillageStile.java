...
public class DraynorVillageStile implements Shortcut {
    ...
    public void startSuccess(final Player player, final WorldObject object) {
        ...
        val destination = object.getX() == 3043 ? object.transform(player.getX() > object.getX() ? -1 : 2, 0, 0) : object.transform(0, player.getY() > object.getY() ? -1 : 2, 0);
        val forceMovement = new ForceMovement(destination, 60, Utils.getFaceDirection(destination.getX() - player.getX(), destination.getY() - player.getY()));
