...
public class NetTrapHunterNPC extends HunterNPC implements Spawnable {
    ...
    public boolean validate(int id, String name) {
        return TrapPrey.contains(id, TrapType.NET_TRAP_SWAMP_LIZARD) || TrapPrey.contains(id, TrapType.NET_TRAP_ORANGE_SALAMANDER)
                || TrapPrey.contains(id, TrapType.NET_TRAP_RED_SALAMANDER) || TrapPrey.contains(id, TrapType.NET_TRAP_BLACK_SALAMANDER);
    }
}