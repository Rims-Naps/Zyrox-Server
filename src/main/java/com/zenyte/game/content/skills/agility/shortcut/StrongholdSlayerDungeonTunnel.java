...
public class StrongholdSlayerDungeonTunnel implements Shortcut {
    ...
    public void startSuccess(final Player player, final WorldObject object) {
        ...
        val west = new Location(WEST.getX(), player.getY(), player.getPlane());
        val middle = new Location(MIDDLE.getX(), player.getY(), player.getPlane());
        val east = new Location(EAST.getX(), player.getY(), player.getPlane());

        val isWest = player.getX() <= WEST.getX();
