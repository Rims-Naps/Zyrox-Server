...
public enum FarmingContractTier {
    ONE(1, 6, new FarmingContractRoll(3, 5), new FarmingContractRoll(1, 3), FarmingContractRoll.NONE),
    TWO(2, 7, new FarmingContractRoll(3, 5), new FarmingContractRoll(2, 3),
            new FarmingContractRoll(1, 1, player -> Utils.random(10) == 0)),
    THREE(3, 8, new FarmingContractRoll(3, 6), new FarmingContractRoll(2, 4), new FarmingContractRoll(0, 1)),
    FOUR(4, 9, new FarmingContractRoll(2, 5), new FarmingContractRoll(3, 5), new FarmingContractRoll(1, 2)),
    FIVE(5, 10, new FarmingContractRoll(1, 5), new FarmingContractRoll(4, 6), new FarmingContractRoll(1, 3));
    ...
    private FarmingContractTier increase(@Positive int amount) {
        val newIndex = Math.min(tiers.size() - 1, tiers.indexOf(this) + amount);
