...
public enum TeleportPortal {
	...
	@Getter private final SpellbookTeleport teleport;
	@Getter private final int[] portalIds;
	...
	private TeleportPortal(final SpellbookTeleport teleport, final int... portalIds) {
