 ...
 * @author Cresinkel
 */
public class GhommalHiltBandosStructure implements TeleportStructure {
    ...
    public void start(Player player, Teleport teleport) {
        val strengthLevel = player.getSkills().getLevel(Skills.STRENGTH);
        if (strengthLevel < 70) {
            player.sendMessage("You lack the 70 strength requirement for General Graardor.");
            return;
        }
