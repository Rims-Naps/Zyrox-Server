...
public final class StringJewellery implements DefaultSpell {
	...
	private static final ImmutableMap<Integer, Integer> STRINGABLES = ImmutableMap.<Integer, Integer>builder()
			.put(1673, 1692).put(1675, 1694).put(1677, 1696).put(1679, 1698).put(1681, 1700).put(1683, 1702)
			.put(6579, 6581).put(19501, 19541).put(21099, 21108).put(21102, 21111).put(21105, 21114)
			.put(4082, 4081).put(1714, 1716).put(1720, 1722).build();
