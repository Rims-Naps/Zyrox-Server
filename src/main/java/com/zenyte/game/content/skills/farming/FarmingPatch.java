...
public enum FarmingPatch {
    ...
    KOUREND_ALLOTMENT_NE(PatchType.ALLOTMENT, 27113, new Location(1817, 3489, 0), new PatchGardener(6921, 3), "North" +
            "-Eastern allotment", 51),
    KOUREND_ALLOTMENT_SW(PatchType.ALLOTMENT, 27114, new Location(1812, 3484, 0), new PatchGardener(6921, 4), "South" +
    ...
    FARMING_GUILD_REDWOOD(PatchType.REDWOOD_PATCH, new int[] { 34051, 34052, 34053, 34054, 34055, 34056, 34057, 34058, 34059, 34633, 34635, 34639, 34637 },
            new Location(1228, 3755, 0), new PatchGardener(8536, 3), "redwood tree", -1),
    ...
    @Getter private final PatchType type;
    @Getter private final int[] ids;
    @Getter private final int index;
    @Getter private PatchGardener gardener;
    ...
    @Getter private static final Int2ObjectOpenHashMap<Set<FarmingPatch>> patchSetByGardeners =
    ...
    static {
        for (final FarmingPatch p : values) {
            ...
            if (p.gardener != null) {
                ...
                var set = patchSetByGardeners.get(p.gardener.getNpcId());
                if (set == null) {
    ...
    public static final Optional<FarmingPatch> getPatchByGardener(final int id, final int option) {
        val patch = gardeners.get(id | option << 16);
    ...
    public static final Optional<Set<FarmingPatch>> getPatchSetByGardeners(final int id) {
        val set = patchSetByGardeners.get(id);
    ...
    public static final class PatchGardener {
        ...
        @Getter private final int npcId, option;
    }
