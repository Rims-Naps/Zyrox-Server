 ...
 * @since 3/23/2020
 */
public class MacMute implements PlayerRottenPotatoActionHandler {
    @Override
    public void execute(Player user, Player target) {
        PunishmentManager.requestPunishment(user, target.getName(), PunishmentType.MAC_MUTE);
    }
    ...
    public Privilege getPrivilege() {
        return Privilege.JUNIOR_MODERATOR;
    }
}
