...
public class StringUtilities {
	...
	private static final char[] CHAR_ARRAY = new char[] { 8364, 0, 8218, 131, 8222, 8230, 8224, 8225, 136, 8240, 138, 8249, 140, 0, 711, 0,
			0, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 152, 8482, 154, 8250, 156, 0, 731, 159
	};
	...
	public static final String readString(final RSBuffer stream, final int maximumLength) {
		try {
		    val length = Math.min(stream.getSmart(), maximumLength);
			val decompressedChars = new byte[length];
	...
	private static String decodeString(final byte[] buffer, final int offset, final int length) {
		...
		for (int i = 0; i < length; i++) {
			int characterCode = buffer[i + offset] & 0xFF;
			if (characterCode != 0) {
