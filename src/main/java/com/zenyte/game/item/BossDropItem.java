...
public enum BossDropItem {
    ...
    TRIDENT_OF_THE_SWAMP_E(new Item(ItemId.UNCHARGED_TOXIC_TRIDENT_E), new Item(ItemId.MAGIC_FANG),
            new Item(ItemId.UNCHARGED_TRIDENT_E), new Item(ItemId.TRIDENT_OF_THE_SEAS_E)),
    ...
    public static BossDropItem getItemByMaterials(final Item from, final Item to){
        for (BossDropItem boots : VALUES) {
            loop: for (Item i : boots.getMaterials()) {
