...
public enum ItemChain {
    ...
    PHARAOH_SCEPTRE(ItemId.PHARAOHS_SCEPTRE, ItemId.PHARAOHS_SCEPTRE_1, ItemId.PHARAOHS_SCEPTRE_2,
            ItemId.PHARAOHS_SCEPTRE_3, ItemId.PHARAOHS_SCEPTRE_4, ItemId.PHARAOHS_SCEPTRE_5, ItemId.PHARAOHS_SCEPTRE_6,
            ItemId.PHARAOHS_SCEPTRE_7, ItemId.PHARAOHS_SCEPTRE_8),
    DEFENDERS(ItemId.BRONZE_DEFENDER, ItemId.IRON_DEFENDER, ItemId.STEEL_DEFENDER, ItemId.BLACK_DEFENDER,
            ItemId.MITHRIL_DEFENDER, ItemId.ADAMANT_DEFENDER, ItemId.RUNE_DEFENDER, ItemId.RUNE_DEFENDER_T, ItemId.DRAGON_DEFENDER, ItemId.DRAGON_DEFENDER_T);
    ...
    public final int get(@NonNegative final int index) {
        Preconditions.checkArgument(index >= 0 && index < items.size(),
                "Out of bounds index [" + index + "] for " + name());
