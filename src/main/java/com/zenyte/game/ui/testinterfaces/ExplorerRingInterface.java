...
import static com.zenyte.game.constants.GameInterface.EXPLORER_RING_ALCH;
...
public class ExplorerRingInterface extends Interface {
    ...
    private static final ItemSpell LOW_ALCHEMY_SPELL = Magic.getSpell(Spellbook.NORMAL, "low level alchemy",
            LowLevelAlchemy.class);
    private static final ItemSpell HIGH_ALCHEMY_SPELL = Magic.getSpell(Spellbook.NORMAL, "high level alchemy",
            HighLevelAlchemy.class);
    ...
    public void open(Player player) {
        ...
        player.getPacketDispatcher().sendComponentSettings(getInterface(),
                getComponent("Inventory"), 0, 27, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
    ...
    protected void build() {
        ...
        bind("Inventory", ((player, slotId, itemId, option) -> {
            ...
            val spell = player.getVarManager().getBitValue(HIGH_ALCHEMY_VARBIT) == 1 ? HIGH_ALCHEMY_SPELL :
                    LOW_ALCHEMY_SPELL;
            if (spell == null) {
                return;
            }
