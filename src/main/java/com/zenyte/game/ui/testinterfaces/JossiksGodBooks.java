...
public class JossiksGodBooks extends Interface {
    ...
    public void open(final Player player) {
        ...
        for (val book : GodBooks.GodBook.values) {
    ...
    private final void manageBook(@NotNull final Player player, @NotNull final GodBooks.GodBook book) {
        ...
        val containsBook = player.containsItem(book.getDamagedBookId()) || player.containsItem(book.getCompletedBookId());
        if (containsBook) {
