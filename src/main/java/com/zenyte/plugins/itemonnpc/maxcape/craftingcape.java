 ...
 */
public class craftingcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9781);
	private static final Item NEWCAPE = new Item(32047);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.CRAFTING) < 200000000) {
