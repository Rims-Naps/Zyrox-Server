 ...
 */
public class attackcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9748);
	private static final Item NEWCAPE = new Item(31050);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.ATTACK) < 200000000) {
