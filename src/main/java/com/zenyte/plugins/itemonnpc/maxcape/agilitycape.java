 ...
 */
public class agilitycape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9772);
	private static final Item NEWCAPE = new Item(32041);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.AGILITY) < 200000000) {
