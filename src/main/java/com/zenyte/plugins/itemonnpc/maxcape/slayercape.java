 ...
 */
public class slayercape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9787);
	private static final Item NEWCAPE = new Item(32074);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.SLAYER) < 200000000) {
