 ...
 */
public class prayercape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9760);
	private static final Item NEWCAPE = new Item(32068);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.PRAYER) < 200000000) {
