 ...
 */
public class woodcutcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9808);
	private static final Item NEWCAPE = new Item(32080);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.WOODCUTTING) < 200000000) {
