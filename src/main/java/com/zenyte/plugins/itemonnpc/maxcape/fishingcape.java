 ...
 */
public class fishingcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9799);
	private static final Item NEWCAPE = new Item(32051);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.FISHING) < 200000000) {
