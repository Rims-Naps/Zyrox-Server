 ...
 */
public class cookingcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9802);
	private static final Item NEWCAPE = new Item(32045);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.COOKING) < 200000000) {
