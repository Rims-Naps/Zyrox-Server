 ...
 */
public class magiccape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9763);
	private static final Item NEWCAPE = new Item(32064);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.MAGIC) < 200000000) {
