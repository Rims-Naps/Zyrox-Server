 ...
 */
public class strengthcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9751);
	private static final Item NEWCAPE = new Item(32039);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.STRENGTH) < 200000000) {
