 ...
 */
public class miningcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9793);
	private static final Item NEWCAPE = new Item(32066);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.MINING) < 200000000) {
