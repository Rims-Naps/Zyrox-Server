 ...
 */
public class rangedcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9757);
	private static final Item NEWCAPE = new Item(32070);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.RANGED) < 200000000) {
