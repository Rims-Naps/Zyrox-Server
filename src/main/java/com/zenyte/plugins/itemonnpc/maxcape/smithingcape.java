 ...
 */
public class smithingcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9796);
	private static final Item NEWCAPE = new Item(32076);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.SMITHING) < 200000000) {
