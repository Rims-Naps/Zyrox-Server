 ...
 */
public class herblorecape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9775);
	private static final Item NEWCAPE = new Item(32058);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.HERBLORE) < 200000000) {
