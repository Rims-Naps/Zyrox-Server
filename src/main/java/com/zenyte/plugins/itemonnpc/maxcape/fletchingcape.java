 ...
 */
public class fletchingcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9784);
	private static final Item NEWCAPE = new Item(32053);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.FLETCHING) < 200000000) {
