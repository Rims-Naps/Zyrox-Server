 ...
 */
public class runecraftingcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9766);
	private static final Item NEWCAPE = new Item(32072);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.RUNECRAFTING) < 200000000) {
			player.sendMessage("You will need at least 200m in this skill in order to make a 200m skillcape.");
			return;
		}
