 ...
 */
public class firemakecape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9805);
	private static final Item NEWCAPE = new Item(32055);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.FIREMAKING) < 200000000) {
