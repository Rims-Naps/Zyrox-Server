 ...
 */
public class thievingcape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9778);
	private static final Item NEWCAPE = new Item(32078);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.THIEVING) < 200000000) {
