 ...
 */
public class huntercapecape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9949);
	private static final Item NEWCAPE = new Item(32062);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.HUNTER) < 200000000) {
