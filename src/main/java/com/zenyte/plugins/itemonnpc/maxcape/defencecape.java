 ...
 */
public class defencecape implements ItemOnObjectAction {

	private static final Item CAPE = new Item(9754);
	private static final Item NEWCAPE = new Item(32037);
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		...
		if (player.getSkills().getExperience(Skills.DEFENCE) < 200000000) {
