    ...
    public void handle() {
        bind("Commune", (player, item, slotId) -> player.getDialogueManager().start(new Dialogue(player) {
            ...
            public void buildDialogue() {
                ...
                if (isGatheringJunk) {
                    plain("The undead chicken can protect some of your ammunition while you're ranging, and will" +
                            " also" +
                    ...
                    plain("The undead chicken understands that you currently don't want it to accumulate random " +
                            "metal" +
