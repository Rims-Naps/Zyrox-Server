...
public class RingOfReturningItem extends ItemPlugin {
    ...
    private enum RingOfReturning {
        ONE(new Item(21138), null, 1),
        TWO(new Item(21136), new Item(21138), 2),
        THREE(new Item(21134), new Item(21136), 3),
        FOUR(new Item(21132), new Item(21134), 4),
        FIVE(new Item(21129), new Item(21132), 5);
    ...
    private static final class RingTeleport implements Teleport {
        ...
        public void onArrival(final Player player) {
            val ring = RingOfReturning.get(item);
            val charges = ring.getCharges();
            val message = charges == 1 ?
                          "<col=7F00FF>Your ring of returning crumbles to dust.</col>" :
                          charges == 2 ?
                          "<col=7F00FF>Your ring of returning has one use left.</col>" :
                          "<col=7F00FF>Your ring of returning has " + Utils.format(charges - 1) + " uses left.</col>";
