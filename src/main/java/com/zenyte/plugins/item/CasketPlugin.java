...
public class CasketPlugin extends ItemPlugin {
    ...
    private enum CasketReward {
        COINS_20(new Item(995, 20), 10),
        COINS_40(new Item(995, 40), 10),
        COINS_80(new Item(995, 80), 10),
        COINS_160(new Item(995, 160), 10),
        COINS_320(new Item(995, 320), 10),
        COINS_640(new Item(995, 640), 10),
        UNCUT_SAPPHIRE(new Item(1623, 1), 32),
        UNCUT_EMERALD(new Item(1621, 1), 16),
        UNCUT_RUBY(new Item(1619, 1), 8),
        UNCUT_DIAMOND(new Item(1617, 1), 2),
        COSMIC_TALISMAN(new Item(1454, 1), 8),
        LOOP_HALF_OF_KEY(new Item(987, 1), 1),
        TOOTH_HALF_OF_KEY(new Item(985, 1), 1);
