...
public class TomeOfFire extends ItemPlugin implements PairedItemOnItemPlugin {
    ...
    public static final void handleAction(final Player player, final Item item, final int slotId, final String option, final Container container) {
    ...
    private static final void addPages(final Player player, final Item item, final int slotId,
    ...
    public void handleItemOnItemAction(Player player, Item from, Item to, int fromSlot, int toSlot) {
        val burntPages = from.getId() == BURNT_PAGE ? from : to;
        val book = burntPages == from ? to : from;
    ...
    public ItemPair[] getMatchingPairs() {
        return new ItemPair[] {
                ItemPair.of(BURNT_PAGE, TOME_OF_FIRE_EMPTY), ItemPair.of(BURNT_PAGE, TOME_OF_FIRE)
        };
    }
