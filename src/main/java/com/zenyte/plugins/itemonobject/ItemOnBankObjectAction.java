...
public final class ItemOnBankObjectAction implements ItemOnObjectAction {
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		if(object.getId() == 171 || object.getId() == 378) {
	...
	public Object[] getObjects() {
		return new Object[] { "Bank", "Bank booth", "Bank chest", "Open chest", "Grand Exchange booth", "Bank counter", "Deposit box", "Bank deposit box" };
	}
