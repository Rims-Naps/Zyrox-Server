...
public class RopeOnKalphiteTunnelEntranceObjectAction implements ItemOnObjectAction {
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		val setting = object.getId() == 3827 ? Setting.KALPHITE_LAIR_TUNNEL_ENTRANCE : Setting.KALPHITE_QUEEN_TUNNEL_ENTRANCE;
		val location = setting.equals(Setting.KALPHITE_LAIR_TUNNEL_ENTRANCE) ? INSIDE_LAIR_LOCATION : INSIDE_BOSS_LOCATION;
