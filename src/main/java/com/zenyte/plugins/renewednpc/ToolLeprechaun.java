        ...
        bind("Talk-to", (player, npc) -> {
            ...
            player.getDialogueManager().start(new Dialogue(player, npc) {
                ...
                public void buildDialogue() {
                    ...
                    npc("We'll hold onto yer rake, yer seed dibber, yer spade, yer secateurs, yer waterin' can and yer " +
                            "trowel - but mind it's not one of them fancy trowels only archaeologists use!");
                    npc("We'll take a few buckets off yer hands too, and even yer compost, supercompost an' ultracompost!" +
                            " Also plant sure vials.");
                    ...
                    npc("We leprechauns have a shed where we keep 'em. It's a magic shed, so ye can get yer items back " +
                            "from any of us leprechauns whenever ye want. Saves ye havin' to carry loads of stuff around " +
                            "the country!");
                    npc("So... do ye want to be using the store?");
