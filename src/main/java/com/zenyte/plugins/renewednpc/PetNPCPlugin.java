...
public class PetNPCPlugin extends NPCPlugin {
    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> {
            val pet = PetWrapper.getByPet(npc.getId());
            val dialogue = pet.dialogue();
            ...
            player.getDialogueManager().start(new Dialogue(player, npc) {
                ...
                public void buildDialogue() {
                    if (player.getBooleanAttribute("rift_guardian_colour_lock")) {
                        ...
                        options(TITLE, "I'd like you to adopt the altar's colour next time.", "Okay, please stay locked to this colour.")
                                .onOptionOne(() -> {
                        ...
                        npc("Very well, I will adopt the altar's colour next time you<br><br>bind essence at a Runecrafting Altar.");
                        ...
                        npc("If you take me to a Runecrafting Altar, I will adopt the<br><br>altar's colour as you bind essence there.");
                        options(TITLE, "I want you to stay this colour instead.", "Okay, carry on adopting the colour of altars.")
                                .onOptionOne(() -> {
                        ...
                        npc("Very well, I will adopt the altar's colour next time you bind essence at a Runecrafting Altar.");
                    }
                }
            });
        });
