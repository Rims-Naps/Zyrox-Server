...
public class CustomsOfficer extends NPCPlugin {
    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> {
            val musapoint = npc.getLocation().withinDistance(MUSA_POINT_NPC_LOCATION, 15);
            val departure = musapoint ? "Karamja" : "Brimhaven";
            val destination = musapoint ? "Port Sarim" : "Ardougne";
