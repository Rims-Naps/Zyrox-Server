...
public class ArdougneSilkMerchant extends NPCPlugin {
    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                options(TITLE,
                        new DialogueOption("100 coins.", key(20)),
                        new DialogueOption("400 coins.", key(80)),
                        new DialogueOption("600 coins.", key(120)),
                        new DialogueOption("1000 coins.", key(200)));
                ...
                options(TITLE, new DialogueOption("Ok, I guess 150 will do.", key(85)),
                        new DialogueOption("I'll give it to you for 200.", key(90)),
                        new DialogueOption("No, that is not enough.", key(95)));
                ...
                options(TITLE, new DialogueOption("Ok, I guess 250 will do.", key(125)),
                        new DialogueOption("I'll give it to you for 300.", key(130)),
                        new DialogueOption("No, that is not enough.", key(135)));
    ...
    private void sell(@NotNull final Player player, final int cost) {
        ...
        val count = player.getInventory().deleteItem(950, 28).getSucceededAmount();
        if (count > 0) {
