...
public class SpiritOfScorpius extends NPCPlugin {
    ...
    public void handle() {
        bind("Talk-to", ((player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                options(TITLE,
                        new DialogueOption("I have come to seek a blessing.", key(5)),
                        new DialogueOption("I need another unholy mould.", key(10)),
                        new DialogueOption("I have come to kill you ", key(15)));
                ...
                npc("To lose an object is easy to replace. To lose the affections of our Lord is impossible to forgive.")
                        .executeAction(() -> {
    ...
    private void bless(Player player, NPC npc) {
        WorldTasksManager.schedule(() -> {
            ...
            val slot = player.getInventory().getContainer().getSlotOf(ItemId.UNPOWERED_SYMBOL);
