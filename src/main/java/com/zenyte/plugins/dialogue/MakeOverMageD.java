...
public class MakeOverMageD extends Dialogue {
    ...
    public void buildDialogue() {
        val enoughCoins = player.getInventory().containsItem(PRICE);
        //if (dialogue) {
            //if (npc.getId() == 1307) {
                npc("Hello there! I am known as the make-over mage! I have<br>spent many years researching magics that can change<br>your physical appearance!").executeAction(() -> player.getInterfaceHandler().sendInterface(InterfacePosition.CENTRAL, 269));
            /*} else {
