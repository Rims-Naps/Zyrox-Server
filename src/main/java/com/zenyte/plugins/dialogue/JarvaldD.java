...
public class JarvaldD extends Dialogue {
	...
	public void buildDialogue() {
		val atWaterbirthIsland = player.inArea("Waterbirth Island");
		if (!atWaterbirthIsland) {
			npc("Greetings, " + player.getPlayerInformation().getDisplayname()
					+ "! So what brings you to fair Rellekka? It has been too long since you have drunk in the long hall with us and sang of your battles!");
