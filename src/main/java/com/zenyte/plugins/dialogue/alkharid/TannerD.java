...
public final class TannerD extends Dialogue {
	...
	public void buildDialogue() {
		...
		if (hasHides()) {
			...
			options("What would you like to say?", "Yes please.", "No thanks.")
			...
			options("What would you like to say?", "Can I buy some leather then?", "Leather is rather weak stuff.")
	...
	private boolean hasHides() {
		for (val leather : Leather.VALUES) {
