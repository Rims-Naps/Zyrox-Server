...
public class DraconicVisageProcessor extends DropProcessor {
    ...
    private static final int getRate(final int id) {
        val name = NPCDefinitions.getOrThrow(id).getName().toLowerCase();
        switch (name) {
    ...
    public int[] ids() {
        return new int[] {
                239, 256, 7255, 8031, 8088, 8089, 8030, 7273, 139,
                8087, 273, 274, 2919, 272, 8080, 468, 8086, 8091,
                8090, 7254, 7863, 7275, 7274, 465, 6593, 467,
                2642, 8084, 466, 8027, 8092, 8093, 8026, 7862, 7861,
                275, 8085, 258, 253, 259, 252, 257, 8058, 8059, 8061,
                255, 254, 8060
        };
    }
}
