...
public class MotherlodeWheelStrut implements ObjectAction {
    ...
    private static final List<WorldObject> WATER_OBJECTS = Arrays.asList(new WorldObject(10459, 22, 0, new Location(3748, 5672, 0)),
            new WorldObject(10459, 22, 0, new Location(3748, 5671, 0)),
            new WorldObject(10459, 22, 0, new Location(3748, 5670, 0)),
            new WorldObject(10459, 22, 0, new Location(3748, 5669, 0)),
            new WorldObject(10459, 22, 0, new Location(3748, 5668, 0)),
            new WorldObject(10459, 22, 0, new Location(3748, 5667, 0)),
            new WorldObject(10459, 22, 0, new Location(3748, 5666, 0)),
            new WorldObject(10459, 22, 0, new Location(3748, 5665, 0)),
            new WorldObject(10459, 22, 0, new Location(3748, 5664, 0)),
            new WorldObject(10459, 22, 0, new Location(3748, 5663, 0)),
            new WorldObject(10459, 22, 0, new Location(3748, 5662, 0)),
            new WorldObject(10459, 22, 0, new Location(3748, 5661, 0)),

            new WorldObject(10459, 22, 1, new Location(3748, 5660, 0)),
            new WorldObject(10459, 22, 1, new Location(3747, 5660, 0)),
            new WorldObject(10459, 22, 1, new Location(3746, 5660, 0)),
            new WorldObject(10459, 22, 1, new Location(3745, 5660, 0)),
            new WorldObject(10459, 22, 1, new Location(3744, 5660, 0)),

            new WorldObject(10459, 22, 2, new Location(3743, 5660, 0)),
            new WorldObject(10459, 22, 2, new Location(3743, 5661, 0)),
            new WorldObject(10459, 22, 2, new Location(3743, 5662, 0)),
            new WorldObject(10459, 22, 2, new Location(3743, 5663, 0)),
            new WorldObject(10459, 22, 2, new Location(3743, 5664, 0)),
            new WorldObject(10459, 22, 2, new Location(3743, 5665, 0)),
            new WorldObject(10459, 22, 2, new Location(3743, 5666, 0)),
            new WorldObject(10459, 22, 2, new Location(3743, 5667, 0)),
            new WorldObject(10459, 22, 2, new Location(3743, 5668, 0)),
            new WorldObject(10459, 22, 2, new Location(3743, 5669, 0)),
            new WorldObject(10459, 22, 2, new Location(3743, 5670, 0)),
            new WorldObject(10459, 22, 2, new Location(3743, 5671, 0)),

            new WorldObject(10459, 22, 3, new Location(3743, 5672, 0)),
            new WorldObject(10459, 22, 3, new Location(3744, 5672, 0)),
            new WorldObject(10459, 22, 3, new Location(3745, 5672, 0)),
            new WorldObject(10459, 22, 3, new Location(3746, 5672, 0)),
            new WorldObject(10459, 22, 3, new Location(3747, 5672, 0)));
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        if(!player.getInventory().containsItem(Smithing.HAMMER) && player.getEquipment().getItem(EquipmentSlot.WEAPON).getId() != 30907) {
            player.getDialogueManager().start(new ItemChat(player, Smithing.HAMMER, "You need a hammer to re-align the strut."));
            return;
        }

        val top = object.getY() == 5669;
        ...
        if(!WHEELS.get(top)) {
            ...
            WorldTasksManager.schedule(() -> {
                ...
                if(!MotherlodeArea.WATER_WHEELS.get(true) && !MotherlodeArea.WATER_WHEELS.get(false)) {
                    for(final WorldObject water : WATER_OBJECTS)
                        World.spawnObject(water);
                }
