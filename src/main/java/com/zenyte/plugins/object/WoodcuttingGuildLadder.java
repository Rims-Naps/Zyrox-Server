...
public class WoodcuttingGuildLadder implements ObjectAction {
    ...
    private static final Animation climbUp = new Animation(828), climbDown = new Animation(827);
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        if (option.equals("Climb-down")) {
            ...
            dest = new Location(object.getX(), object.getY(),
                    object.getPlane() - 1);
    ...
    public void handle(final Player player, final WorldObject object, final String name, final int optionId,
        ...
        RouteEvent event = object.getId() == 28858 ? new ObjectEvent(player, new ObjectStrategy(object), runnable,
                getDelay()) : new TileEvent(player, new TileStrategy(object), runnable, getDelay());
