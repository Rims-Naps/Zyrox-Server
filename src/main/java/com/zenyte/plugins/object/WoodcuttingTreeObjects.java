...
public final class WoodcuttingTreeObjects implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        if (option.equalsIgnoreCase("inject") && name.equalsIgnoreCase("sulliuscep")) {
            ...
            if (player.carryingItem(ItemId.PROBOSCIS) && spray != null) {
                ...
                val currentIndex = player.getVarManager().getBitValue(Woodcutting.SULLIUSCEP_INDEX_VARBIT);
        ...
        switch (name.toLowerCase()) {
            ...
            case "wilderness yew tree":
                player.getActionManager().setAction(new Woodcutting(object, TreeDefinitions.RESOURCE_YEW_TREE));
                return;
            case "wilderness magic tree":
                player.getActionManager().setAction(new Woodcutting(object, TreeDefinitions.RESOURCE_MAGIC_TREE));
                return;
    ...
    public Object[] getObjects() {
        return new Object[]{"tree", "evergreen", "dead tree", "dying tree", "achey tree", "jungle tree", "teak", "teak tree", "oak",
                "hollow " + "tree", "mahogany tree", "mahogany", "arctic pine", "willow", "maple tree", "yew",
                "magic tree", "redwood", "sulliuscep", "crystal tree","wilderness magic tree","wilderness yew tree"};
    }
