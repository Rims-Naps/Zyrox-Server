...
public class OminousFishingSpot implements ObjectAction, ItemOnObjectAction {
     ...
     * which is which.
     */
    private static final Location[] spawnTiles = new Location[] {
            new Location(2982, 3110, 0),
            new Location(2993, 3107, 0),
            new Location(3005, 3119, 0)
    };
    ...
    private static final class OminousFishingSpotObjectFollowAction extends Action {
        ...
        public int processWithDelay() {
            val distance = player.getLocation().getDistance(object);
            ...
            val delay = World.sendProjectile(player.getLocation(), object, throwingProjectile);
            WorldTasksManager.schedule(() -> {
                World.sendSoundEffect(object, explosionSound);
                val mogre = new Mogre(2592, OminousFishingSpot.spawnTiles[object.getId() - 10087], Direction.NORTH, 5);
                mogre.spawn();
