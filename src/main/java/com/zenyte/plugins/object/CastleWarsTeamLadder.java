...
public class CastleWarsTeamLadder implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        val trapdoor = object.getId() == ZAMORAK_TRAPDOOR || object.getId() == SARADOMIN_TRAPDOOR;
        if(!trapdoor && ((team.equals(CastleWarsTeam.SARADOMIN) && object.getId() != SARADOMIN_LADDER)
                || (team.equals(CastleWarsTeam.ZAMORAK) && object.getId() != ZAMORAK_LADDER))) {
            return;
        }
        ...
        if(!trapdoor) {
            ...
            if(team.equals(CastleWarsTeam.SARADOMIN) && object.getId() != SARADOMIN_TRAPDOOR)

            player.setLocation(object.getId() == SARADOMIN_TRAPDOOR ? SARADOMIN_BOTTOM : ZAMORAK_BOTTOM);
        }
    }
