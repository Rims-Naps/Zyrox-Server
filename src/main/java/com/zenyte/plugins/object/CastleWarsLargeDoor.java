...
public class CastleWarsLargeDoor implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        val saradominObject = CastleWarsTeam.SARADOMIN.getLargeCastleDoors().contains(object.getId());
        ...
        if (option.toLowerCase().equals("attack")) {
            ...
            val oppositeTeam = team.equals(CastleWarsTeam.SARADOMIN) ? CastleWarsTeam.ZAMORAK : CastleWarsTeam.SARADOMIN;
