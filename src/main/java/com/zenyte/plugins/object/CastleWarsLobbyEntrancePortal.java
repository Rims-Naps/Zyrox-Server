...
public class CastleWarsLobbyEntrancePortal implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        val mutableBool = new MutableBoolean(player.getFollower() != null);
        ...
        if ( ( object.getId() == SARADOMIN_PORTAL && SARADOMIN_LOBBY.size() > ZAMORAK_LOBBY.size() ) ||
                ( object.getId() == ZAMORAK_PORTAL && ZAMORAK_LOBBY.size() > SARADOMIN_LOBBY.size() ) ) {
