...
public final class UnderlayDefinitions implements Definitions {
	...
	@Getter
	private int rgb, hue, saturation, lightness, hueMultiplier;
	 ...
	 */
	private void setHSL() {
		final double var2 = (rgb >> 16 & 255) / 256.0D;
		final double var4 = (rgb >> 8 & 255) / 256.0D;
		final double var6 = (rgb & 255) / 256.0D;
		double var8 = var2;
		if (var4 < var2) {
			var8 = var4;
		}
		...
		if (var16 > 0.5D) {
			hueMultiplier = (int) ((1.0D - var16) * var14 * 512.0D);
		} else {
			hueMultiplier = (int) (var14 * var16 * 512.0D);
		}
    ...
    static {
        ...
        for (int i_8_ = 0; i_8_ < 512; i_8_++) {
            ...
            float f_9_ = (float) (i_8_ & 0x7) / 8.0F + 0.0625F;
            for (int i_10_ = 0; i_10_ < 128; i_10_++) {
                ...
                int i_25_ = i_24_ + ((i_22_ << 16) /*+ -16777216*/ + (i_23_ << 8));
