...
public final class IntEnum extends AbstractEnum<Integer> {
    ...
    private transient final Int2IntMap intMap;
    private transient final Int2IntMap reverseIntMap;
    ...
    @Override
    boolean populate(final Map<Integer, ?> map, final Map<Integer, Integer> populatedMap,
                  final Map<Integer, Integer> reversePopulatedMap) {
    ...
    public ByteBuffer encode() {
        ...
        if (intMap != null) {
            ...
            for (val entry : intMap.int2IntEntrySet()) {
    ...
    public void forEach(final Consumer<Int2IntMap.Entry> consumer) {
        for (val entry : getValues().int2IntEntrySet()) {
