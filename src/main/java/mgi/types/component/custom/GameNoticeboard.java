...
public class GameNoticeboard extends ComponentDefinitions {
	...
	public ArrayList<ComponentDefinitions> assemble(final int interfaceId) {
		...
		for (int i = 0; i < playerNodes; i++) {
			...
			} else if (i == 10 || i == 11 || i == 12) { //game settings
				val text = i == 10 ? "Game Settings" : i == 11 ? "Drop Viewer" : "Daily Challenges";
		...
		for (int i = 0; i < linksNodes; i++) {
			val text = i == 0 ? "Website" : i == 1 ? "Forums" : i == 2 ? "Discord" : "Store";
