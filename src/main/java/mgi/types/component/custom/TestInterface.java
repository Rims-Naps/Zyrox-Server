 ...
 */
@Slf4j
public class TestInterface extends ComponentDefinitions {
	...
	public void buildInterface(final int interfaceId) {
		...
		component.setOnMouseRepeatListener(new Object[] { 38, -2147483645, interfaceId << 16 | 6, "Level 1<br>Thick Skin<br>Increases your defence by 5%.", 25, 186 });
		add(componentId++, component);
