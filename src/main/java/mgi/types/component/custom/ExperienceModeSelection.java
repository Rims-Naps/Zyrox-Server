 ...
 */
public class ExperienceModeSelection extends ComponentDefinitions {
    ...
    public ArrayList<ComponentDefinitions> assemble() {
        ...
        var component = new ComponentDefinitions(); //1
        ...
        val xpModes = new String[] { "50x Combat<br>25x Skilling", "10x Combat<br>10x Skilling", "5x Combat<br>5x Skilling" };

        val ops = new String[] { "50x Combat & 25x Skilling", "10x Combat & 10x Skilling", "5x Combat & 5x Skilling" };
        ...
        component = new TextComponent("If you choose choose the 5x or 10x combat & skilling mode, you can always talk to the Zenyte guide in Edgeville to change it to the easier 50x combat & 25x skilling one.", "ffffff", 494, CENTER, CENTER);
        ...
        val list = new ArrayList<ComponentDefinitions>();
        list.add(this);
        for (val c : getChildren()) {
            if (c == null) {
                continue;
            }
            list.add(c);
