 ...
 */
public class ModeSelectionBackup extends ComponentDefinitions {
    ...
    public ArrayList<ComponentDefinitions> assemble() {
        ...
        val gameModes = new String[] { "Regular", "Standard Iron Man", "Hardcore Iron Man", "Ultimate Iron Man" };
        ...
        val xpModes = new String[] { "1x rate", "2x rate" };
