 ...
 */
public class DropViewer extends ComponentDefinitions {
    ...
    public ArrayList<ComponentDefinitions> assemble(final int interfaceId) {
        ...
        component.setOnLoadListener(new Object[] { 10102, interfaceId << 16 | 30, interfaceId << 16 | 15, interfaceId << 16 | 32 });
