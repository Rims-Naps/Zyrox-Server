...
public class CustomNPCs {
    ...
    public static void pack() throws IOException {
        ...
        var def = NPCDefinitions.get(379); //challenge headmaster
        ...
        val options = new ObjectArrayList<String>(Arrays.asList(def.getOptions()));
